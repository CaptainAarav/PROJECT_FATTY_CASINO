 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})($||($={}));const Sp={debug:$.DEBUG,verbose:$.VERBOSE,info:$.INFO,warn:$.WARN,error:$.ERROR,silent:$.SILENT},Rp=$.INFO,Pp={[$.DEBUG]:"log",[$.VERBOSE]:"log",[$.INFO]:"info",[$.WARN]:"warn",[$.ERROR]:"error"},Cp=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Pp[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class To{constructor(e){this.name=e,this._logLevel=Rp,this._logHandler=Cp,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in $))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Sp[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,$.DEBUG,...e),this._logHandler(this,$.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,$.VERBOSE,...e),this._logHandler(this,$.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,$.INFO,...e),this._logHandler(this,$.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,$.WARN,...e),this._logHandler(this,$.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,$.ERROR,...e),this._logHandler(this,$.ERROR,...e)}}const kp=(n,e)=>e.some(t=>n instanceof t);let Tc,Ac;function xp(){return Tc||(Tc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Dp(){return Ac||(Ac=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const cu=new WeakMap,Gi=new WeakMap,lu=new WeakMap,Li=new WeakMap,Ao=new WeakMap;function Vp(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",a)},i=()=>{t(vt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&cu.set(t,n)}).catch(()=>{}),Ao.set(e,n),e}function Np(n){if(Gi.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",a),n.removeEventListener("abort",a)},i=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",a),n.addEventListener("abort",a)});Gi.set(n,e)}let Qi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Gi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||lu.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return vt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Lp(n){Qi=n(Qi)}function Mp(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Mi(this),e,...t);return lu.set(r,e.sort?e.sort():[e]),vt(r)}:Dp().includes(n)?function(...e){return n.apply(Mi(this),e),vt(cu.get(this))}:function(...e){return vt(n.apply(Mi(this),e))}}function Op(n){return typeof n=="function"?Mp(n):(n instanceof IDBTransaction&&Np(n),kp(n,xp())?new Proxy(n,Qi):n)}function vt(n){if(n instanceof IDBRequest)return Vp(n);if(Li.has(n))return Li.get(n);const e=Op(n);return e!==n&&(Li.set(n,e),Ao.set(e,n)),e}const Mi=n=>Ao.get(n);function Fp(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(n,e),l=vt(a);return r&&a.addEventListener("upgradeneeded",u=>{r(vt(a.result),u.oldVersion,u.newVersion,vt(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),l.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const Up=["get","getKey","getAll","getAllKeys","count"],Bp=["put","add","delete","clear"],Oi=new Map;function Sc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Oi.get(e))return Oi.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=Bp.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Up.includes(t)))return;const i=async function(a,...l){const u=this.transaction(a,s?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),s&&u.done]))[0]};return Oi.set(e,i),i}Lp(n=>({...n,get:(e,t,r)=>Sc(e,t)||n.get(e,t,r),has:(e,t)=>!!Sc(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot=new To("@firebase/app"),qp="@firebase/app-compat",zp="@firebase/analytics-compat",Hp="@firebase/analytics",Wp="@firebase/app-check-compat",Kp="@firebase/app-check",Gp="@firebase/auth",Qp="@firebase/auth-compat",Yp="@firebase/database",Xp="@firebase/data-connect",Jp="@firebase/database-compat",Zp="@firebase/functions",em="@firebase/functions-compat",tm="@firebase/installations",nm="@firebase/installations-compat",rm="@firebase/messaging",sm="@firebase/messaging-compat",im="@firebase/performance",om="@firebase/performance-compat",am="@firebase/remote-config",cm="@firebase/remote-config-compat",lm="@firebase/storage",um="@firebase/storage-compat",hm="@firebase/firestore",dm="@firebase/ai",fm="@firebase/firestore-compat",pm="firebase",mm="12.6.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xi="[DEFAULT]",gm={[Yi]:"fire-core",[qp]:"fire-core-compat",[Hp]:"fire-analytics",[zp]:"fire-analytics-compat",[Kp]:"fire-app-check",[Wp]:"fire-app-check-compat",[Gp]:"fire-auth",[Qp]:"fire-auth-compat",[Yp]:"fire-rtdb",[Xp]:"fire-data-connect",[Jp]:"fire-rtdb-compat",[Zp]:"fire-fn",[em]:"fire-fn-compat",[tm]:"fire-iid",[nm]:"fire-iid-compat",[rm]:"fire-fcm",[sm]:"fire-fcm-compat",[im]:"fire-perf",[om]:"fire-perf-compat",[am]:"fire-rc",[cm]:"fire-rc-compat",[lm]:"fire-gcs",[um]:"fire-gcs-compat",[hm]:"fire-fst",[fm]:"fire-fst-compat",[dm]:"fire-vertex","fire-js":"fire-js",[pm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bm=1024,Tm=30;class Am{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Rm(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=kc();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(s=>s.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:t}),this._heartbeatsCache.heartbeats.length>Tm){const s=Pm(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ot.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=kc(),{heartbeatsToSend:t,unsentEntries:r}=Sm(this._heartbeatsCache.heartbeats),s=hs(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return ot.warn(e),""}}}function kc(){return new Date().toISOString().substring(0,10)}function Sm(n,e=bm){const t=[];let r=n.slice();for(const s of n){const i=t.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),xc(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),xc(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class Rm{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fp()?pp().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Im(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Cc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Cc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function xc(n){return hs(JSON.stringify({version:2,heartbeats:n})).length}function Pm(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cm(n){yn(new Gt("platform-logger",e=>new $p(e),"PRIVATE")),yn(new Gt("heartbeat",e=>new Am(e),"PRIVATE")),Et(Yi,Rc,n),Et(Yi,Rc,"esm2020"),Et("fire-js","")}Cm("");var km="firebase",xm="12.6.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs=new To("@firebase/auth");function Dm(n,...e){fs.logLevel<=$.WARN&&fs.warn(`Auth (${Pn}): ${n}`,...e)}function ts(n,...e){fs.logLevel<=$.ERROR&&fs.error(`Auth (${Pn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(n,...e){throw Po(n,...e)}function Fe(n,...e){return Po(n,...e)}function Ro(n,e,t){const r={...mu(),[e]:t};return new _r("auth","Firebase",r).create(e,{appName:n.name})}function rt(n){return Ro(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Vm(n,e,t){const r=t;if(!(e instanceof r))throw r.name!==e.constructor.name&&Me(n,"argument-error"),Ro(n,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Po(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return gu.create(n,...e)}function M(n,e,...t){if(!n)throw Po(e,...t)}function tt(n){const e="INTERNAL ASSERTION FAILED: "+n;throw ts(e),new Error(e)}function at(n,e){n||tt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lm(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Nm()||lp()||"connection"in navigator)?navigator.onLine:!0}function Mm(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,t){this.shortDelay=e,this.longDelay=t,at(t>e,"Short delay should be less than long delay!"),this.isMobile=op()||up()}get(){return Lm()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ms(n){const e=n.auth,t=await n.getIdToken(),r=await hr(n,ps(e,{idToken:t}));M(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=s.providerUserInfo?.length?Iu(s.providerUserInfo):[],a=Km(n.providerData,i),l=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!a?.length,d=l?u:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new eo(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function Eu(n){const e=ce(n);await ms(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Km(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Iu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lc=new Map;function nt(n){at(n instanceof Function,"Expected a class definition");let e=Lc.get(n);return e?(at(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Lc.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ru(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Tu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Cu(e))return"Blackberry";if(ku(e))return"Webos";if(Au(e))return"Safari";if((e.includes("chrome/")||Su(e))&&!e.includes("edge/"))return"Chrome";if(Pu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if(r?.length===2)return r[1]}return"Other"}function Tu(n=Ie()){return/firefox\//i.test(n)}function Au(n=Ie()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Su(n=Ie()){return/crios\//i.test(n)}function Ru(n=Ie()){return/iemobile/i.test(n)}function Pu(n=Ie()){return/android/i.test(n)}function Cu(n=Ie()){return/blackberry/i.test(n)}function ku(n=Ie()){return/webos/i.test(n)}function xo(n=Ie()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ym(n=Ie()){return xo(n)&&!!window.navigator?.standalone}function Xm(){return hp()&&document.documentMode===10}function xu(n=Ie()){return xo(n)||Pu(n)||ku(n)||Cu(n)||/windows phone/i.test(n)||Ru(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Du(n,e=[]){let t;switch(n){case"Browser":t=Mc(Ie());break;case"Worker":t=`${Mc(Ie())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Pn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lu(n,e){const t=So(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(At(i,e??{}))return s;Me(s,"already-initialized")}return t.initialize({options:e})}function hg(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(nt);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Mu(n,e,t){const r=Lt(n);M(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Ou(e),{host:a,port:l}=dg(e),u=l===null?"":`:${l}`,d={url:`${i}//${a}${u}/`},p=Object.freeze({host:a,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){M(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),M(At(d,r.config.emulator)&&At(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,Rn(a)?(ou(`${i}//${a}${u}`),au("Auth",!0)):fg()}function Ou(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function dg(n){const e=Ou(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Uc(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Uc(a)}}}function Uc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function fg(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en{constructor(){this.providerId=en.PROVIDER_ID}static credential(e,t){return _n._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Ns.parseLink(t);return M(r,"argument-error"),_n._fromEmailAndCode(e,r.code,r.tenantId)}}en.PROVIDER_ID="password";en.EMAIL_PASSWORD_SIGN_IN_METHOD="password";en.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir extends Do{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He extends Ir{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return St._fromParams({providerId:He.PROVIDER_ID,signInMethod:He.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return He.credentialFromTaggedObject(e)}static credentialFromError(e){return He.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return He.credential(t,r)}catch{return null}}}He.GOOGLE_SIGN_IN_METHOD="google.com";He.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bg(n,e,t=!1){const{auth:r}=n;if(De(r.app))return Promise.reject(rt(r));const s="reauthenticate";try{const i=await hr(n,Fu(r,s,e,n),t);M(i.idToken,r,"internal-error");const a=ko(i.idToken);M(a,r,"internal-error");const{sub:l}=a;return M(n.uid===l,r,"user-mismatch"),Qt._forOperation(n,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&Me(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uu(n,e,t=!1){if(De(n.app))return Promise.reject(rt(n));const r="signIn",s=await Fu(n,r,e),i=await Qt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Bu(n,e){return Uu(Lt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gu{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(ys,"1"),this.storage.removeItem(ys),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xu extends Gu{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Xu.type="SESSION";const Vo=Xu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rh(n,e){return e?nt(e):(M(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lo extends Vs{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return mn(e,this._buildIdpRequest())}_linkToIdToken(e,t){return mn(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return mn(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Fg(n){return Uu(n.auth,new Lo(n),n.bypassAuthState)}function Ug(n){const{auth:e,user:t}=n;return M(t,e,"internal-error"),bg(t,new Lo(n),n.bypassAuthState)}async function Bg(n){const{auth:e,user:t}=n;return M(t,e,"internal-error"),Ig(t,new Lo(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sh{constructor(e,t,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:i,error:a,type:l}=e;if(a){this.reject(a);return}const u={auth:this.auth,requestUri:t,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Fg;case"linkViaPopup":case"linkViaRedirect":return Bg;case"reauthViaPopup":case"reauthViaRedirect":return Ug;default:Me(this.auth,"internal-error")}}resolve(e){at(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){at(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wy="__/auth/handler",Ey="emulator/auth/handler",Iy=encodeURIComponent("fac");async function Wc(n,e,t,r,s,i){M(n.config.authDomain,n,"auth-domain-config-required"),M(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Pn,eventId:s};if(e instanceof Do){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",_p(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,y]of Object.entries({}))a[p]=y}if(e instanceof Ir){const p=e.getScopes().filter(y=>y!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const l=a;for(const p of Object.keys(l))l[p]===void 0&&delete l[p];const u=await n._getAppCheckToken(),d=u?`#${Iy}=${encodeURIComponent(u)}`:"";return`${by(n)}?${vr(l).slice(1)}${d}`}function by({config:n}){return n.emulator?Co(n,Ey):`https://${n.authDomain}/${wy}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bi="webStorageSupport";class Ty{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Vo,this._completeRedirectFn=Gg,this._overrideRedirectResult=Hg}async _openPopup(e,t,r,s){at(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const i=await Wc(e,t,r,Zi(),s);return _y(e,i,No())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await Wc(e,t,r,Zi(),s);return Cg(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(at(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await dy(e),r=new Yg(e);return t.register("authEvent",s=>(M(s?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Bi,{type:Bi},s=>{const i=s?.[0]?.[Bi];i!==void 0&&t(!!i),Me(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ty(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return xu()||Au()||xo()}}const ah=Ty;var Kc="@firebase/auth",Gc="1.11.1";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sy(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ry(n){yn(new Gt("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;M(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Du(n)},d=new ng(r,s,i,u);return hg(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),yn(new Gt("auth-internal",e=>{const t=Lt(e.getProvider("auth").getImmediate());return(r=>new Ay(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Et(Kc,Gc,Sy(n)),Et(Kc,Gc,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Py=300,Cy=iu("authIdTokenMaxAge")||Py;let Qc=null;const ky=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Cy)return;const s=t?.token;Qc!==s&&(Qc=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function ch(n=hu()){const e=So(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Lu(n,{popupRedirectResolver:ah,persistence:[nh,Yu,Vo]}),r=iu("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=ky(i.toString());Hu(t,a,()=>a(t.currentUser)),zu(t,l=>a(l))}}const s=ru("auth");return s&&Mu(t,`http://${s}`),t}function xy(){return document.getElementsByTagName("head")?.[0]??document}rg({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=Fe("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",xy().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ry("Browser");const Dy=Object.freeze(Object.defineProperty({__proto__:null,ActionCodeURL:Ns,AuthCredential:Vs,EmailAuthCredential:_n,EmailAuthProvider:en,FacebookAuthProvider:Je,GithubAuthProvider:Ze,GoogleAuthProvider:He,OAuthCredential:St,TwitterAuthProvider:et,beforeAuthStateChanged:Hu,browserLocalPersistence:Yu,browserPopupRedirectResolver:ah,browserSessionPersistence:Vo,connectAuthEmulator:Mu,createUserWithEmailAndPassword:ju,deleteUser:Tg,getAuth:ch,getIdTokenResult:wu,inMemoryPersistence:to,indexedDBLocalPersistence:nh,initializeAuth:Lu,onAuthStateChanged:Wu,onIdTokenChanged:zu,prodErrorMap:mu,reload:Eu,signInWithCredential:Bu,signInWithEmailAndPassword:qu,signInWithPopup:ih,signOut:Ku},Symbol.toStringTag,{value:"Module"}));var Yc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var It,lh;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,m){function _(){}_.prototype=m.prototype,E.F=m.prototype,E.prototype=new _,E.prototype.constructor=E,E.D=function(I,w,T){for(var g=Array(arguments.length-2),Pe=2;Pe<arguments.length;Pe++)g[Pe-2]=arguments[Pe];return m.prototype[w].apply(I,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(E,m,_){_||(_=0);const I=Array(16);if(typeof m=="string")for(var w=0;w<16;++w)I[w]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(w=0;w<16;++w)I[w]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=E.g[0],_=E.g[1],w=E.g[2];let T=E.g[3],g;g=m+(T^_&(w^T))+I[0]+3614090360&4294967295,m=_+(g<<7&4294967295|g>>>25),g=T+(w^m&(_^w))+I[1]+3905402710&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(_^T&(m^_))+I[2]+606105819&4294967295,w=T+(g<<17&4294967295|g>>>15),g=_+(m^w&(T^m))+I[3]+3250441966&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(T^_&(w^T))+I[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=T+(w^m&(_^w))+I[5]+1200080426&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(_^T&(m^_))+I[6]+2821735955&4294967295,w=T+(g<<17&4294967295|g>>>15),g=_+(m^w&(T^m))+I[7]+4249261313&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(T^_&(w^T))+I[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=T+(w^m&(_^w))+I[9]+2336552879&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(_^T&(m^_))+I[10]+4294925233&4294967295,w=T+(g<<17&4294967295|g>>>15),g=_+(m^w&(T^m))+I[11]+2304563134&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(T^_&(w^T))+I[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=T+(w^m&(_^w))+I[13]+4254626195&4294967295,T=m+(g<<12&4294967295|g>>>20),g=w+(_^T&(m^_))+I[14]+2792965006&4294967295,w=T+(g<<17&4294967295|g>>>15),g=_+(m^w&(T^m))+I[15]+1236535329&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(w^T&(_^w))+I[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=T+(_^w&(m^_))+I[6]+3225465664&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(T^m))+I[11]+643717713&4294967295,w=T+(g<<14&4294967295|g>>>18),g=_+(T^m&(w^T))+I[0]+3921069994&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(_^w))+I[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=T+(_^w&(m^_))+I[10]+38016083&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(T^m))+I[15]+3634488961&4294967295,w=T+(g<<14&4294967295|g>>>18),g=_+(T^m&(w^T))+I[4]+3889429448&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(_^w))+I[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=T+(_^w&(m^_))+I[14]+3275163606&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(T^m))+I[3]+4107603335&4294967295,w=T+(g<<14&4294967295|g>>>18),g=_+(T^m&(w^T))+I[8]+1163531501&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^T&(_^w))+I[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=T+(_^w&(m^_))+I[2]+4243563512&4294967295,T=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(T^m))+I[7]+1735328473&4294967295,w=T+(g<<14&4294967295|g>>>18),g=_+(T^m&(w^T))+I[12]+2368359562&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(_^w^T)+I[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=T+(m^_^w)+I[8]+2272392833&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^_)+I[11]+1839030562&4294967295,w=T+(g<<16&4294967295|g>>>16),g=_+(w^T^m)+I[14]+4259657740&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^T)+I[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=T+(m^_^w)+I[4]+1272893353&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^_)+I[7]+4139469664&4294967295,w=T+(g<<16&4294967295|g>>>16),g=_+(w^T^m)+I[10]+3200236656&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^T)+I[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=T+(m^_^w)+I[0]+3936430074&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^_)+I[3]+3572445317&4294967295,w=T+(g<<16&4294967295|g>>>16),g=_+(w^T^m)+I[6]+76029189&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^T)+I[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=T+(m^_^w)+I[12]+3873151461&4294967295,T=m+(g<<11&4294967295|g>>>21),g=w+(T^m^_)+I[15]+530742520&4294967295,w=T+(g<<16&4294967295|g>>>16),g=_+(w^T^m)+I[2]+3299628645&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(w^(_|~T))+I[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=T+(_^(m|~w))+I[7]+1126891415&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~_))+I[14]+2878612391&4294967295,w=T+(g<<15&4294967295|g>>>17),g=_+(T^(w|~m))+I[5]+4237533241&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~T))+I[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=T+(_^(m|~w))+I[3]+2399980690&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~_))+I[10]+4293915773&4294967295,w=T+(g<<15&4294967295|g>>>17),g=_+(T^(w|~m))+I[1]+2240044497&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~T))+I[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=T+(_^(m|~w))+I[15]+4264355552&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~_))+I[6]+2734768916&4294967295,w=T+(g<<15&4294967295|g>>>17),g=_+(T^(w|~m))+I[13]+1309151649&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~T))+I[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=T+(_^(m|~w))+I[11]+3174756917&4294967295,T=m+(g<<10&4294967295|g>>>22),g=w+(m^(T|~_))+I[2]+718787259&4294967295,w=T+(g<<15&4294967295|g>>>17),g=_+(T^(w|~m))+I[9]+3951481745&4294967295,E.g[0]=E.g[0]+m&4294967295,E.g[1]=E.g[1]+(w+(g<<21&4294967295|g>>>11))&4294967295,E.g[2]=E.g[2]+w&4294967295,E.g[3]=E.g[3]+T&4294967295}r.prototype.v=function(E,m){m===void 0&&(m=E.length);const _=m-this.blockSize,I=this.C;let w=this.h,T=0;for(;T<m;){if(w==0)for(;T<=_;)s(this,E,T),T+=this.blockSize;if(typeof E=="string"){for(;T<m;)if(I[w++]=E.charCodeAt(T++),w==this.blockSize){s(this,I),w=0;break}}else for(;T<m;)if(I[w++]=E[T++],w==this.blockSize){s(this,I),w=0;break}}this.h=w,this.o+=m},r.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var m=1;m<E.length-8;++m)E[m]=0;m=this.o*8;for(var _=E.length-8;_<E.length;++_)E[_]=m&255,m/=256;for(this.v(E),E=Array(16),m=0,_=0;_<4;++_)for(let I=0;I<32;I+=8)E[m++]=this.g[_]>>>I&255;return E};function i(E,m){var _=l;return Object.prototype.hasOwnProperty.call(_,E)?_[E]:_[E]=m(E)}function a(E,m){this.h=m;const _=[];let I=!0;for(let w=E.length-1;w>=0;w--){const T=E[w]|0;I&&T==m||(_[w]=T,I=!1)}this.g=_}var l={};function u(E){return-128<=E&&E<128?i(E,function(m){return new a([m|0],m<0?-1:0)}):new a([E|0],E<0?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return y;if(E<0)return x(d(-E));const m=[];let _=1;for(let I=0;E>=_;I++)m[I]=E/_|0,_*=4294967296;return new a(m,0)}function p(E,m){if(E.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(E.charAt(0)=="-")return x(p(E.substring(1),m));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(m,8));let I=y;for(let T=0;T<E.length;T+=8){var w=Math.min(8,E.length-T);const g=parseInt(E.substring(T,T+w),m);w<8?(w=d(Math.pow(m,w)),I=I.j(w).add(d(g))):(I=I.j(_),I=I.add(d(g)))}return I}var y=u(0),v=u(1),S=u(16777216);n=a.prototype,n.m=function(){if(N(this))return-x(this).m();let E=0,m=1;for(let _=0;_<this.g.length;_++){const I=this.i(_);E+=(I>=0?I:4294967296+I)*m,m*=4294967296}return E},n.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(k(this))return"0";if(N(this))return"-"+x(this).toString(E);const m=d(Math.pow(E,6));var _=this;let I="";for(;;){const w=be(_,m).g;_=z(_,w.j(m));let T=((_.g.length>0?_.g[0]:_.h)>>>0).toString(E);if(_=w,k(_))return T+I;for(;T.length<6;)T="0"+T;I=T+I}},n.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function k(E){if(E.h!=0)return!1;for(let m=0;m<E.g.length;m++)if(E.g[m]!=0)return!1;return!0}function N(E){return E.h==-1}n.l=function(E){return E=z(this,E),N(E)?-1:k(E)?0:1};function x(E){const m=E.g.length,_=[];for(let I=0;I<m;I++)_[I]=~E.g[I];return new a(_,~E.h).add(v)}n.abs=function(){return N(this)?x(this):this},n.add=function(E){const m=Math.max(this.g.length,E.g.length),_=[];let I=0;for(let w=0;w<=m;w++){let T=I+(this.i(w)&65535)+(E.i(w)&65535),g=(T>>>16)+(this.i(w)>>>16)+(E.i(w)>>>16);I=g>>>16,T&=65535,g&=65535,_[w]=g<<16|T}return new a(_,_[_.length-1]&-2147483648?-1:0)};function z(E,m){return E.add(x(m))}n.j=function(E){if(k(this)||k(E))return y;if(N(this))return N(E)?x(this).j(x(E)):x(x(this).j(E));if(N(E))return x(this.j(x(E)));if(this.l(S)<0&&E.l(S)<0)return d(this.m()*E.m());const m=this.g.length+E.g.length,_=[];for(var I=0;I<2*m;I++)_[I]=0;for(I=0;I<this.g.length;I++)for(let w=0;w<E.g.length;w++){const T=this.i(I)>>>16,g=this.i(I)&65535,Pe=E.i(w)>>>16,Ut=E.i(w)&65535;_[2*I+2*w]+=g*Ut,W(_,2*I+2*w),_[2*I+2*w+1]+=T*Ut,W(_,2*I+2*w+1),_[2*I+2*w+1]+=g*Pe,W(_,2*I+2*w+1),_[2*I+2*w+2]+=T*Pe,W(_,2*I+2*w+2)}for(E=0;E<m;E++)_[E]=_[2*E+1]<<16|_[2*E];for(E=m;E<2*m;E++)_[E]=0;return new a(_,0)};function W(E,m){for(;(E[m]&65535)!=E[m];)E[m+1]+=E[m]>>>16,E[m]&=65535,m++}function K(E,m){this.g=E,this.h=m}function be(E,m){if(k(m))throw Error("division by zero");if(k(E))return new K(y,y);if(N(E))return m=be(x(E),m),new K(x(m.g),x(m.h));if(N(m))return m=be(E,x(m)),new K(x(m.g),m.h);if(E.g.length>30){if(N(E)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var _=v,I=m;I.l(E)<=0;)_=Re(_),I=Re(I);var w=he(_,1),T=he(I,1);for(I=he(I,2),_=he(_,2);!k(I);){var g=T.add(I);g.l(E)<=0&&(w=w.add(_),T=g),I=he(I,1),_=he(_,1)}return m=z(E,w.j(m)),new K(w,m)}for(w=y;E.l(m)>=0;){for(_=Math.max(1,Math.floor(E.m()/m.m())),I=Math.ceil(Math.log(_)/Math.LN2),I=I<=48?1:Math.pow(2,I-48),T=d(_),g=T.j(m);N(g)||g.l(E)>0;)_-=I,T=d(_),g=T.j(m);k(T)&&(T=v),w=w.add(T),E=z(E,g)}return new K(w,E)}n.B=function(E){return be(this,E).h},n.and=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)&E.i(I);return new a(_,this.h&E.h)},n.or=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)|E.i(I);return new a(_,this.h|E.h)},n.xor=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)^E.i(I);return new a(_,this.h^E.h)};function Re(E){const m=E.g.length+1,_=[];for(let I=0;I<m;I++)_[I]=E.i(I)<<1|E.i(I-1)>>>31;return new a(_,E.h)}function he(E,m){const _=m>>5;m%=32;const I=E.g.length-_,w=[];for(let T=0;T<I;T++)w[T]=m>0?E.i(T+_)>>>m|E.i(T+_+1)<<32-m:E.i(T+_);return new a(w,E.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,lh=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,It=a}).apply(typeof Yc<"u"?Yc:typeof self<"u"?self:typeof window<"u"?window:{});var Yr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yt=new To("@firebase/firestore");function cn(){return Yt.logLevel}function V(n,...e){if(Yt.logLevel<=$.DEBUG){const t=e.map(Mo);Yt.debug(`Firestore (${Cn}): ${n}`,...t)}}function ct(n,...e){if(Yt.logLevel<=$.ERROR){const t=e.map(Mo);Yt.error(`Firestore (${Cn}): ${n}`,...t)}}function Xt(n,...e){if(Yt.logLevel<=$.WARN){const t=e.map(Mo);Yt.warn(`Firestore (${Cn}): ${n}`,...t)}}function Mo(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function O(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,mh(n,r,t)}function mh(n,e,t){let r=`FIRESTORE (${Cn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw ct(r),new Error(r)}function G(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||mh(e,s,r)}function U(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class yh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(ve.UNAUTHENTICATED)))}shutdown(){}}class Vy{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}}class Ny{constructor(e){this.t=e,this.currentUser=ve.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){G(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new st;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new st,e.enqueueRetryable((()=>s(this.currentUser)))};const a=()=>{const u=i;e.enqueueRetryable((async()=>{await u.promise,await s(this.currentUser)}))},l=u=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((u=>l(u))),setTimeout((()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new st)}}),0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((r=>this.i!==e?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(G(typeof r.accessToken=="string",31837,{l:r}),new gh(r.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return G(e===null||typeof e=="string",2055,{h:e}),new ve(e)}}class Ly{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=ve.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class My{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new Ly(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable((()=>t(ve.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Zc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Oy{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,De(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){G(this.o===void 0,3512);const r=i=>{i.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,V("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable((()=>r(i)))};const s=i=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((i=>s(i))),setTimeout((()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Zc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((t=>t?(G(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Zc(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ol(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Mt(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Ih(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new bh("Invalid base64 string: "+i):i}})(e);return new me(t)}static fromUint8Array(e){const t=(function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i})(e);return new me(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return j(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}me.EMPTY_BYTE_STRING=new me("");const Jy=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Pt(n){if(G(!!n,39018),typeof n=="string"){let e=0;const t=Jy.exec(n);if(G(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:se(n.seconds),nanos:se(n.nanos)}}function se(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Ct(n){return typeof n=="string"?me.fromBase64String(n):me.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Th="server_timestamp",Ah="__type__",Sh="__previous_value__",Rh="__local_write_time__";function Fo(n){return(n?.mapValue?.fields||{})[Ah]?.stringValue===Th}function $s(n){const e=n.mapValue.fields[Sh];return Fo(e)?$s(e):e}function fr(n){const e=Pt(n.mapValue.fields[Rh].timestampValue);return new J(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tn{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r!==void 0){for(const[s,i]of r)if(this.equalsFn(s,e))return i}}has(e){return this.get(e)!==void 0}set(e,t){const r=this.mapKeyFn(e),s=this.inner[r];if(s===void 0)return this.inner[r]=[[e,t]],void this.innerSize++;for(let i=0;i<s.length;i++)if(this.equalsFn(s[i][0],e))return void(s[i]=[e,t]);s.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r===void 0)return!1;for(let s=0;s<r.length;s++)if(this.equalsFn(r[s][0],e))return r.length===1?delete this.inner[t]:r.splice(s,1),this.innerSize--,!0;return!1}forEach(e){Mt(this.inner,((t,r)=>{for(const[s,i]of r)e(s,i)}))}isEmpty(){return Ih(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y_=new ne(L.comparator);function lt(){return y_}const Bh=new ne(L.comparator);function tr(...n){let e=Bh;for(const t of n)e=e.insert(t.key,t);return e}function $h(n){let e=Bh;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Kt(){return ar()}function jh(){return ar()}function ar(){return new tn((n=>n.toString()),((n,e)=>n.isEqual(e)))}const __=new ne(L.comparator),v_=new ue(L.comparator);function q(...n){let e=v_;for(const t of n)e=e.add(t);return e}const w_=new ue(j);function E_(){return w_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vs(e)?"-0":e}}function qh(n){return{integerValue:""+n}}function I_(n,e){return Qy(e)?qh(e):jo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hs{constructor(){this._=void 0}}function b_(n,e,t){return n instanceof gr?(function(s,i){const a={fields:{[Ah]:{stringValue:Th},[Rh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Fo(i)&&(i=$s(i)),i&&(a.fields[Sh]=i),{mapValue:a}})(t,e):n instanceof bn?Hh(n,e):n instanceof yr?Wh(n,e):(function(s,i){const a=zh(s,i),l=yl(a)+yl(s.Ae);return ao(a)&&ao(s.Ae)?qh(l):jo(s.serializer,l)})(n,e)}function T_(n,e,t){return n instanceof bn?Hh(n,e):n instanceof yr?Wh(n,e):t}function zh(n,e){return n instanceof Ts?(function(r){return ao(r)||(function(i){return!!i&&"doubleValue"in i})(r)})(e)?e:{integerValue:0}:null}class gr extends Hs{}class bn extends Hs{constructor(e){super(),this.elements=e}}function Hh(n,e){const t=Kh(e);for(const r of n.elements)t.some((s=>Qe(s,r)))||t.push(r);return{arrayValue:{values:t}}}class yr extends Hs{constructor(e){super(),this.elements=e}}function Wh(n,e){let t=Kh(e);for(const r of n.elements)t=t.filter((s=>!Qe(s,r)));return{arrayValue:{values:t}}}class Ts extends Hs{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function yl(n){return se(n.integerValue||n.doubleValue)}function Kh(n){return Uo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L_=new It([4294967295,4294967295],0);function El(n){const e=N_().encode(n),t=new lh;return t.update(e),new Uint8Array(t.digest())}function Il(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new It([t,r],0),new It([s,i],0)]}class Ho{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new nr(`Invalid padding: ${t}`);if(r<0)throw new nr(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new nr(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new nr(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=It.fromNumber(this.ge)}ye(e,t,r){let s=e.add(t.multiply(It.fromNumber(r)));return s.compare(L_)===1&&(s=new It([s.getBits(0),s.getBits(1)],0)),s.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=El(e),[r,s]=Il(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(r,s,i);if(!this.we(a))return!1}return!0}static create(e,t,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),a=new Ho(i,s,t);return r.forEach((l=>a.insert(l))),a}insert(e){if(this.ge===0)return;const t=El(e),[r,s]=Il(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(r,s,i);this.Se(a)}}Se(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class nr extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ks{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Sr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Ks(F.min(),s,new ne(j),lt(),q())}}class Sr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Sr(r,t,q(),q(),q())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ev{constructor(e){this.yt=e}}function tv(n){const e=G_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?bs(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fv{constructor(){this.overlays=new ne(L.comparator),this.qr=new Map}getOverlay(e,t){return P.resolve(this.overlays.get(t))}getOverlays(e,t){const r=Kt();return P.forEach(t,(s=>this.getOverlay(e,s).next((i=>{i!==null&&r.set(s,i)})))).next((()=>r))}saveOverlays(e,t,r){return r.forEach(((s,i)=>{this.St(e,t,i)})),P.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.qr.get(r);return s!==void 0&&(s.forEach((i=>this.overlays=this.overlays.remove(i))),this.qr.delete(r)),P.resolve()}getOverlaysForCollection(e,t,r){const s=Kt(),i=t.length+1,a=new L(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const u=l.getNext().value,d=u.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return P.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new ne(((d,p)=>d-p));const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let p=i.get(d.largestBatchId);p===null&&(p=Kt(),i=i.insert(d.largestBatchId,p)),p.set(d.getKey(),d)}}const l=Kt(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach(((d,p)=>l.set(d,p))),!(l.size()>=s)););return P.resolve(l)}St(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.qr.get(s.largestBatchId).delete(r.key);this.qr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new x_(t,r));let i=this.qr.get(t);i===void 0&&(i=q(),this.qr.set(t,i)),this.qr.set(t,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ko{constructor(){this.Qr=new ue(fe.$r),this.Ur=new ue(fe.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(e,t){const r=new fe(e,t);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(e,t){e.forEach((r=>this.addReference(r,t)))}removeReference(e,t){this.Gr(new fe(e,t))}zr(e,t){e.forEach((r=>this.removeReference(r,t)))}jr(e){const t=new L(new X([])),r=new fe(t,e),s=new fe(t,e+1),i=[];return this.Ur.forEachInRange([r,s],(a=>{this.Gr(a),i.push(a.key)})),i}Jr(){this.Qr.forEach((e=>this.Gr(e)))}Gr(e){this.Qr=this.Qr.delete(e),this.Ur=this.Ur.delete(e)}Hr(e){const t=new L(new X([])),r=new fe(t,e),s=new fe(t,e+1);let i=q();return this.Ur.forEachInRange([r,s],(a=>{i=i.add(a.key)})),i}containsKey(e){const t=new fe(e,0),r=this.Qr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class fe{constructor(e,t){this.key=e,this.Yr=t}static $r(e,t){return L.comparator(e.key,t.key)||j(e.Yr,t.Yr)}static Kr(e,t){return j(e.Yr,t.Yr)||L.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection";class Mv extends Nv{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,s,i){const a=yo();return new Promise(((l,u)=>{const d=new uh;d.setWithCredentials(!0),d.listenOnce(hh.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case is.NO_ERROR:const y=d.getResponseJson();V(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),l(y);break;case is.TIMEOUT:V(_e,`RPC '${e}' ${a} timed out`),u(new D(R.DEADLINE_EXCEEDED,"Request time out"));break;case is.HTTP_ERROR:const v=d.getStatus();if(V(_e,`RPC '${e}' ${a} failed with status:`,v,"response text:",d.getResponseText()),v>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const k=S?.error;if(k&&k.status&&k.message){const N=(function(z){const W=z.toLowerCase().replace(/_/g,"-");return Object.values(R).indexOf(W)>=0?W:R.UNKNOWN})(k.status);u(new D(N,k.message))}else u(new D(R.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new D(R.UNAVAILABLE,"Connection failed."));break;default:O(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{V(_e,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);V(_e,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=yo(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ph(),l=fh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=i.join("");V(_e,`Creating RPC '${e}' stream ${s}: ${p}`,u);const y=a.createWebChannel(p,u);this.I_(y);let v=!1,S=!1;const k=new Lv({Yo:x=>{S?V(_e,`Not sending because RPC '${e}' stream ${s} is closed:`,x):(v||(V(_e,`Opening RPC '${e}' stream ${s} transport.`),y.open(),v=!0),V(_e,`RPC '${e}' stream ${s} sending:`,x),y.send(x))},Zo:()=>y.close()}),N=(x,z,W)=>{x.listen(z,(K=>{try{W(K)}catch(be){setTimeout((()=>{throw be}),0)}}))};return N(y,er.EventType.OPEN,(()=>{S||(V(_e,`RPC '${e}' stream ${s} transport opened.`),k.o_())})),N(y,er.EventType.CLOSE,(()=>{S||(S=!0,V(_e,`RPC '${e}' stream ${s} transport closed`),k.a_(),this.E_(y))})),N(y,er.EventType.ERROR,(x=>{S||(S=!0,Xt(_e,`RPC '${e}' stream ${s} transport errored. Name:`,x.name,"Message:",x.message),k.a_(new D(R.UNAVAILABLE,"The operation could not be completed")))})),N(y,er.EventType.MESSAGE,(x=>{if(!S){const z=x.data[0];G(!!z,16349);const W=z,K=W?.error||W[0]?.error;if(K){V(_e,`RPC '${e}' stream ${s} received error:`,K);const be=K.status;let Re=(function(m){const _=ie[m];if(_!==void 0)return Xh(_)})(be),he=K.message;Re===void 0&&(Re=R.INTERNAL,he="Unknown error status: "+be+" with message "+K.message),S=!0,k.a_(new D(Re,he)),y.close()}else V(_e,`RPC '${e}' stream ${s} received:`,z),k.u_(z)}})),N(l,dh.STAT_EVENT,(x=>{x.stat===so.PROXY?V(_e,`RPC '${e}' stream ${s} detected buffering proxy`):x.stat===so.NOPROXY&&V(_e,`RPC '${e}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{k.__()}),0),k}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function zi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(n){return new B_(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let i=0;i<r.length;++i)if(r[i]!==s[i])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Be._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Tr(e,Be._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new Be(e.vectorValues);throw new D(R.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Be._jsonSchemaVersion="firestore/vectorValue/1.0",Be._jsonSchema={type:ae("string",Be._jsonSchemaVersion),vectorValues:ae("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Zt(n){n=Se(n,te);const e=Se(n.firestore,Ye);return Aw(Cr(e),n._key).then((t=>Hd(e,n,t)))}Tt._jsonSchemaVersion="firestore/querySnapshot/1.0",Tt._jsonSchema={type:ae("string",Tt._jsonSchemaVersion),bundleSource:ae("string","QuerySnapshot"),bundleName:ae("string"),bundle:ae("string")};class ya extends $d{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ve(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new te(this.firestore,null,t)}}function oi(n){n=Se(n,Xe);const e=Se(n.firestore,Ye),t=Cr(e),r=new ya(e);return Ud(n._query),Sw(t,n._query).then((s=>new Tt(e,r,n,s)))}function qd(n,e,t){n=Se(n,te);const r=Se(n.firestore,Ye),s=jd(n.converter,e);return Vr(r,[Nd(Zs(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,Le.none())])}function Sn(n,e,t,...r){n=Se(n,te);const s=Se(n.firestore,Ye),i=Zs(s);let a;return a=typeof(e=ce(e))=="string"||e instanceof kr?Vw(i,"updateDoc",n._key,e,t,r):Dw(i,"updateDoc",n._key,e),Vr(s,[a.toMutation(n._key,Le.exists(!0))])}function _a(n){return Vr(Se(n.firestore,Ye),[new qo(n._key,Le.none())])}function ai(n,e){const t=Se(n.firestore,Ye),r=Ee(n),s=jd(n.converter,e);return Vr(t,[Nd(Zs(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Le.exists(!1))]).then((()=>r))}function zd(n,...e){n=ce(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Kl(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(Kl(e[r])){const u=e[r];e[r]=u.next?.bind(u),e[r+1]=u.error?.bind(u),e[r+2]=u.complete?.bind(u)}let i,a,l;if(n instanceof te)a=Se(n.firestore,Ye),l=js(n._key.path),i={next:u=>{e[r]&&e[r](Hd(a,n,u))},error:e[r+1],complete:e[r+2]};else{const u=Se(n,Xe);a=Se(u.firestore,Ye),l=u._query;const d=new ya(a);i={next:p=>{e[r]&&e[r](new Tt(a,d,u,p))},error:e[r+1],complete:e[r+2]},Ud(n._query)}return(function(d,p,y,v){const S=new la(v),k=new oa(p,S,y);return d.asyncQueue.enqueueAndForget((async()=>ra(await Cs(d),k))),()=>{S.Nu(),d.asyncQueue.enqueueAndForget((async()=>sa(await Cs(d),k)))}})(Cr(a),l,s,i)}function Vr(n,e){return(function(r,s){const i=new st;return r.asyncQueue.enqueueAndForget((async()=>fw(await Tw(r),s,i))),i.promise})(Cr(n),e)}function Hd(n,e,t){const r=t.docs.get(e._key),s=new ya(n);return new bt(n,s,e._key,r,new dn(t.hasPendingWrites,t.fromCache),e.converter)}function ci(){return new ua("serverTimestamp")}function bo(...n){return new ha("arrayUnion",n)}(function(e,t=!0){(function(s){Cn=s})(Pn),yn(new Gt("firestore",((r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new Ye(new Ny(r.getProvider("auth-internal")),new Oy(a,r.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new D(R.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wn(d.options.projectId,p)})(a,s),a);return i={useFetchStreams:t,...i},l._setSettings(i),l}),"PUBLIC").setMultipleInstances(!0)),Et(Xc,Jc,e),Et(Xc,Jc,"esm2020")})();const Fw=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:$d,Bytes:Ve,CollectionReference:it,DocumentReference:te,DocumentSnapshot:bt,FieldPath:kr,FieldValue:Nn,Firestore:Ye,FirestoreError:D,GeoPoint:Ue,Query:Xe,QueryCompositeFilterConstraint:ri,QueryConstraint:ni,QueryDocumentSnapshot:lr,QueryFieldFilterConstraint:Dr,QueryLimitConstraint:ii,QueryOrderByConstraint:si,QuerySnapshot:Tt,SnapshotMetadata:dn,Timestamp:J,VectorValue:Be,_AutoId:Os,_ByteString:me,_DatabaseId:wn,_DocumentKey:L,_EmptyAuthCredentialsProvider:yh,_FieldPath:pe,_cast:Se,_logWarn:Xt,_validateIsNotUsedTogether:vh,addDoc:ai,arrayUnion:bo,collection:Ft,connectFirestoreEmulator:kd,deleteDoc:_a,doc:Ee,ensureFirestoreConfigured:Cr,executeWrite:Vr,getDoc:Zt,getDocs:oi,getFirestore:xd,limit:ga,onSnapshot:zd,orderBy:ma,query:xr,serverTimestamp:ci,setDoc:qd,updateDoc:Sn,where:Io},Symbol.toStringTag,{value:"Module"})),Wd={apiKey:"AIzaSyCVRU4DJfKrR7yG9D8lGNLkhf9jFF7PL9Y",authDomain:"fatty-casino-e99ed.firebaseapp.com",projectId:"fatty-casino-e99ed",storageBucket:"fatty-casino-e99ed.firebasestorage.app",messagingSenderId:"225232886894",appId:"1:225232886894:web:08bb8008a6e6bf89391a7f"},Q=Object.values(Wd).every(n=>n&&n!=="");let Wi,rn,ee,Kd;Q?(Wi=uu(Wd),rn=ch(Wi),ee=xd(Wi),Kd=new He):console.warn("Firebase not configured. Please add your Firebase config to .env file.");const Gd=async()=>{if(!Q)throw new Error("Firebase not configured");try{return(await ih(rn,Kd)).user}catch(n){throw console.error("Error signing in:",n),n}},Qd=async(n,e)=>{if(!Q)throw new Error("Firebase not configured");try{return(await ju(rn,n,e)).user}catch(t){throw console.error("Error signing up:",t),t}},Yd=async(n,e)=>{if(!Q)throw new Error("Firebase not configured");try{return(await qu(rn,n,e)).user}catch(t){throw console.error("Error signing in:",t),t}},Xd=async()=>{if(Q)try{await Ku(rn)}catch(n){throw console.error("Error signing out:",n),n}},Jd=n=>Q?Wu(rn,n):(n(null),()=>{}),Zd=async n=>{if(!Q)return null;try{const e=await Zt(Ee(ee,"users",n));return e.exists()?e.data():null}catch(e){throw console.error("Error getting user data:",e),e}},ef=async(n,e)=>{if(Q)try{await qd(Ee(ee,"users",n),{...e,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()})}catch(t){throw console.error("Error creating user profile:",t),t}},tf=async(n,e)=>{if(Q)try{await Sn(Ee(ee,"users",n),{...e,updatedAt:new Date().toISOString()})}catch(t){throw console.error("Error updating user data:",t),t}},nf=async(n=10)=>{if(!Q)return[];try{const e=xr(Ft(ee,"users"),ma("balance","desc"),ga(n));return(await oi(e)).docs.map(r=>({id:r.id,...r.data()}))}catch(e){return console.error("Error getting leaderboard:",e),[]}},rf=async(n,e,t,r,s)=>{if(Q)try{await ai(Ft(ee,"chat"),{userId:n,username:e,avatar:t,profileImage:r,message:s,timestamp:ci(),createdAt:new Date().toISOString()})}catch(i){throw console.error("Error sending message:",i),i}},sf=(n,e=50)=>{if(!Q)return n([]),()=>{};try{const t=xr(Ft(ee,"chat"),ma("timestamp","desc"),ga(e));return zd(t,r=>{const s=r.docs.map(i=>({id:i.id,...i.data()})).reverse();n(s)})}catch(t){return console.error("Error subscribing to chat:",t),n([]),()=>{}}},of=async(n,e)=>{if(Q)try{await ai(Ft(ee,"friendRequests"),{from:n,to:e,status:"pending",timestamp:ci(),createdAt:new Date().toISOString()})}catch(t){throw console.error("Error sending friend request:",t),t}},af=async(n,e,t)=>{if(Q)try{await Sn(Ee(ee,"users",e),{friends:bo(t)}),await Sn(Ee(ee,"users",t),{friends:bo(e)}),await _a(Ee(ee,"friendRequests",n))}catch(r){throw console.error("Error accepting friend request:",r),r}},cf=async n=>{if(Q)try{await _a(Ee(ee,"friendRequests",n))}catch(e){throw console.error("Error declining friend request:",e),e}},lf=async n=>{if(!Q)return[];try{const e=xr(Ft(ee,"friendRequests"),Io("to","==",n),Io("status","==","pending")),t=await oi(e),r=[];for(const s of t.docs){const i=s.data(),a=await Zt(Ee(ee,"users",i.from));a.exists()&&r.push({id:s.id,...i,fromUser:a.data()})}return r}catch(e){return console.error("Error getting friend requests:",e),[]}},uf=async n=>{if(!Q)return[];try{const e=await Zt(Ee(ee,"users",n));if(!e.exists())return[];const t=e.data().friends||[],r=[];for(const s of t){const i=await Zt(Ee(ee,"users",s));i.exists()&&r.push({id:s,...i.data()})}return r}catch(e){return console.error("Error getting friends:",e),[]}},hf=async(n,e,t)=>{if(Q)try{const r=await Zt(Ee(ee,"users",n)),s=await Zt(Ee(ee,"users",e));if(!r.exists()||!s.exists())throw new Error("User not found");const i=r.data().balance||0;if(i<t)throw new Error("Insufficient balance");await Sn(Ee(ee,"users",n),{balance:i-t});const a=s.data().balance||0;await Sn(Ee(ee,"users",e),{balance:a+t}),await ai(Ft(ee,"transactions"),{type:"gift",from:n,to:e,amount:t,timestamp:ci(),createdAt:new Date().toISOString()})}catch(r){throw console.error("Error sending gift:",r),r}},df=async n=>{if(!Q)return[];try{const e=xr(Ft(ee,"users"));return(await oi(e)).docs.map(s=>({id:s.id,...s.data()})).filter(s=>s.username&&s.username.toLowerCase().includes(n.toLowerCase())).slice(0,10)}catch(e){return console.error("Error searching users:",e),[]}},Uw=Object.freeze(Object.defineProperty({__proto__:null,acceptFriendRequest:af,get auth(){return rn},createUserProfile:ef,get db(){return ee},declineFriendRequest:cf,getFriendRequests:lf,getFriends:uf,getLeaderboard:nf,getUserData:Zd,isConfigured:Q,onAuthChange:Jd,searchUsers:df,sendChatMessage:rf,sendFriendRequest:of,sendGift:hf,signInWithEmail:Yd,signInWithGoogle:Gd,signOutUser:Xd,signUpWithEmail:Qd,subscribeToChatMessages:sf,updateUserData:tf},Symbol.toStringTag,{value:"Module"})),Ki=[{id:"first_win",name:"First Winner",description:"Win your first game",icon:"🏆",reward:500,condition:n=>n.totalWon>0},{id:"high_roller",name:"High Roller",description:"Wager 50,000 FATTY BUCKS",icon:"💎",reward:2e3,condition:n=>n.totalWagered>=5e4},{id:"millionaire",name:"Millionaire",description:"Reach 1,000,000 FATTY BUCKS",icon:"💰",reward:1e4,condition:(n,e)=>e>=1e6},{id:"lucky_streak",name:"Lucky Streak",description:"Win 5 games in a row",icon:"🍀",reward:1e3,condition:n=>n.winStreak>=5},{id:"big_winner",name:"Big Winner",description:"Win 100,000 in a single game",icon:"🎰",reward:5e3,condition:n=>n.biggestWin>=1e5},{id:"grinder",name:"The Grinder",description:"Play 100 games",icon:"⚡",reward:3e3,condition:n=>n.gamesPlayed>=100},{id:"social_butterfly",name:"Social Butterfly",description:"Add 5 friends",icon:"👥",reward:1500,condition:(n,e,t)=>t.length>=5},{id:"generous",name:"Generous Soul",description:"Gift 10,000 FATTY BUCKS to friends",icon:"🎁",reward:2e3,condition:n=>n.totalGifted>=1e4}],Bw=[{id:"daily_games",name:"Play 10 games",description:"Play any 10 games",reward:1e3,target:10,type:"games"},{id:"daily_wager",name:"Wager 5,000",description:"Wager 5,000 FATTY BUCKS",reward:800,target:5e3,type:"wager"},{id:"daily_wins",name:"Win 5 games",description:"Win any 5 games",reward:1500,target:5,type:"wins"}],us=[{name:"Bronze",minXP:0,color:"#CD7F32",perks:["Basic rewards","Daily bonus"]},{name:"Silver",minXP:5e3,color:"#C0C0C0",perks:["5% bonus XP","10% better odds","Silver badge"]},{name:"Gold",minXP:15e3,color:"#FFD700",perks:["10% bonus XP","15% better odds","Gold badge","Exclusive games"]},{name:"Platinum",minXP:35e3,color:"#E5E4E2",perks:["15% bonus XP","20% better odds","Platinum badge","Priority support"]},{name:"Diamond",minXP:75e3,color:"#B9F2FF",perks:["25% bonus XP","25% better odds","Diamond badge","VIP lounge access"]}],Yl=[{id:"lucky_charm",name:"Lucky Charm",description:"+5% win chance for 24h",price:5e3,icon:"🍀",type:"boost",duration:864e5},{id:"double_xp",name:"Double XP",description:"2x XP for 1 hour",price:3e3,icon:"⚡",type:"boost",duration:36e5},{id:"coin_doubler",name:"Coin Doubler",description:"2x winnings for 30min",price:1e4,icon:"💰",type:"boost",duration:18e5},{id:"vip_pass",name:"VIP Day Pass",description:"Access VIP features for 24h",price:8e3,icon:"👑",type:"pass",duration:864e5},{id:"gold_frame",name:"Gold Profile Frame",description:"Permanent gold profile frame",price:15e3,icon:"🖼️",type:"cosmetic",duration:null},{id:"rainbow_frame",name:"Rainbow Profile Frame",description:"Permanent rainbow profile frame",price:25e3,icon:"🌈",type:"cosmetic",duration:null}];function Xl(n){return Math.floor(Math.sqrt(n/100))+1}function Jl(n){return Math.pow(n-1,2)*100}function $w(n){return Math.pow(n,2)*100}function Zl(n){for(let e=us.length-1;e>=0;e--)if(n>=us[e].minXP)return us[e].name;return"Bronze"}class jw{constructor(){this.currentView="home",this.user=null,this.balance=1e4,this.profile={username:"Player",avatar:"🎰",profileImage:null,theme:"gold"},this.stats={totalWagered:0,totalWon:0,totalLost:0,gamesPlayed:0,biggestWin:0,winStreak:0,currentStreak:0},this.lastDailyBonus=null,this.leaderboard=[],this.leaderboardInterval=null,this.leaderboardTimerInterval=null,this.leaderboardSecondsUntilRefresh=60,this.gamesDropdownOpen=!1,this.cropImageData=null,this.cropZoom=1,this.cropPosition={x:0,y:0},this.chatMessages=[],this.chatUnsubscribe=null,this.friends=[],this.friendRequests=[],this.xp=0,this.level=1,this.achievements=[],this.dailyQuests=[],this.vipTier="Bronze",this.inventory=[],this.blackjackHand={player:[],dealer:[],bet:0,gameActive:!1},this.crashMultiplier=1,this.crashActive=!1,this.plinkoDropping=!1,this.init()}async init(){this.showLoading(),Jd(async e=>{this.user=e,e?(await this.loadUserData(e.uid),this.startLeaderboardPolling(),this.startChatSubscription(),await this.loadFriends(),await this.loadFriendRequests()):(this.leaderboard=[],this.stopLeaderboardPolling(),this.stopChatSubscription(),this.friends=[],this.friendRequests=[]),this.render(),this.updateWallet()})}startChatSubscription(){this.chatUnsubscribe&&this.chatUnsubscribe(),this.chatUnsubscribe=sf(e=>{this.chatMessages=e,this.currentView==="chat"&&this.render()})}stopChatSubscription(){this.chatUnsubscribe&&(this.chatUnsubscribe(),this.chatUnsubscribe=null)}async loadFriends(){if(this.user)try{this.friends=await uf(this.user.uid)}catch(e){console.error("Error loading friends:",e)}}async loadFriendRequests(){if(this.user)try{this.friendRequests=await lf(this.user.uid)}catch(e){console.error("Error loading friend requests:",e)}}showLoading(){document.querySelector("#app").innerHTML=`
    ...
    `}renderAchievements(){const e=this.xp,t=this.level,r=$w(t),s=e-Jl(t),i=r-Jl(t),a=s/i*100,l=us.find(u=>u.name===this.vipTier);return`
      <div class="game-container">
        ...
        <!-- Achievements Grid -->
        <h3 style="color: var(--accent-gold); margin-bottom: 1rem;">Achievements (${this.achievements.length}/${Ki.length})</h3>
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1rem;">
          ${Ki.map(u=>{const d=this.achievements.includes(u.id);return`
