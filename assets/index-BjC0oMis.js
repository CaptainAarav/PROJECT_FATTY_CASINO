(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();const Wf="modulepreload",Hf=function(n){return"/"+n},wc={},xi=function(e,t,r){let s=Promise.resolve();if(t&&t.length>0){let d=function(p){return Promise.all(p.map(y=>Promise.resolve(y).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};var a=d;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=l?.nonce||l?.getAttribute("nonce");s=d(t.map(p=>{if(p=Hf(p),p in wc)return;wc[p]=!0;const y=p.endsWith(".css"),v=y?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${v}`))return;const S=document.createElement("link");if(S.rel=y?"stylesheet":Wf,y||(S.as="script"),S.crossOrigin="",S.href=p,u&&S.setAttribute("nonce",u),document.head.appendChild(S),y)return new Promise((k,N)=>{S.addEventListener("load",k),S.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(l){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=l,window.dispatchEvent(u),!u.defaultPrevented)throw l}return s.then(l=>{for(const u of l||[])u.status==="rejected"&&i(u.reason);return e().catch(i)})},Gf=()=>{};var Ec={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jf=()=>Xf().__FIREBASE_DEFAULTS__,Zf=()=>{if(typeof process>"u"||typeof Ec>"u")return;const n=Ec.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},ep=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&nu(n[1]);return e&&JSON.parse(e)},Ds=()=>{try{return Gf()||Jf()||Zf()||ep()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},ru=n=>Ds()?.emulatorHosts?.[n],tp=n=>{const e=ru(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),r]:[e.substring(0,t),r]},su=()=>Ds()?.config,iu=n=>Ds()?.[`_${n}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})($||($={}));const Sp={debug:$.DEBUG,verbose:$.VERBOSE,info:$.INFO,warn:$.WARN,error:$.ERROR,silent:$.SILENT},Rp=$.INFO,Pp={[$.DEBUG]:"log",[$.VERBOSE]:"log",[$.INFO]:"info",[$.WARN]:"warn",[$.ERROR]:"error"},Cp=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Pp[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class bo{constructor(e){this.name=e,this._logLevel=Rp,this._logHandler=Cp,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in $))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Sp[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,$.DEBUG,...e),this._logHandler(this,$.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,$.VERBOSE,...e),this._logHandler(this,$.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,$.INFO,...e),this._logHandler(this,$.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,$.WARN,...e),this._logHandler(this,$.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,$.ERROR,...e),this._logHandler(this,$.ERROR,...e)}}const kp=(n,e)=>e.some(t=>n instanceof t);let bc,Ac;function Dp(){return bc||(bc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Vp(){return Ac||(Ac=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const cu=new WeakMap,Ki=new WeakMap,lu=new WeakMap,Oi=new WeakMap,Ao=new WeakMap;function xp(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",a)},i=()=>{t(vt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&cu.set(t,n)}).catch(()=>{}),Ao.set(e,n),e}function Np(n){if(Ki.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",a),n.removeEventListener("abort",a)},i=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",a),n.addEventListener("abort",a)});Ki.set(n,e)}let Qi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Ki.get(n);if(e==="objectStoreNames")return n.objectStoreNames||lu.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return vt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Op(n){Qi=n(Qi)}function Lp(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Li(this),e,...t);return lu.set(r,e.sort?e.sort():[e]),vt(r)}:Vp().includes(n)?function(...e){return n.apply(Li(this),e),vt(cu.get(this))}:function(...e){return vt(n.apply(Li(this),e))}}function Mp(n){return typeof n=="function"?Lp(n):(n instanceof IDBTransaction&&Np(n),kp(n,Dp())?new Proxy(n,Qi):n)}function vt(n){if(n instanceof IDBRequest)return xp(n);if(Oi.has(n))return Oi.get(n);const e=Mp(n);return e!==n&&(Oi.set(n,e),Ao.set(e,n)),e}const Li=n=>Ao.get(n);function Fp(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(n,e),l=vt(a);return r&&a.addEventListener("upgradeneeded",u=>{r(vt(a.result),u.oldVersion,u.newVersion,vt(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),l.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const Up=["get","getKey","getAll","getAllKeys","count"],Bp=["put","add","delete","clear"],Mi=new Map;function Sc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Mi.get(e))return Mi.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=Bp.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Up.includes(t)))return;const i=async function(a,...l){const u=this.transaction(a,s?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),s&&u.done]))[0]};return Mi.set(e,i),i}Op(n=>({...n,get:(e,t,r)=>Sc(e,t)||n.get(e,t,r),has:(e,t)=>!!Sc(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $p{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(qp(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function qp(n){return n.getComponent()?.type==="VERSION"}const Yi="@firebase/app",Rc="0.14.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot=new bo("@firebase/app"),jp="@firebase/app-compat",zp="@firebase/analytics-compat",Wp="@firebase/analytics",Hp="@firebase/app-check-compat",Gp="@firebase/app-check",Kp="@firebase/auth",Qp="@firebase/auth-compat",Yp="@firebase/database",Xp="@firebase/data-connect",Jp="@firebase/database-compat",Zp="@firebase/functions",em="@firebase/functions-compat",tm="@firebase/installations",nm="@firebase/installations-compat",rm="@firebase/messaging",sm="@firebase/messaging-compat",im="@firebase/performance",om="@firebase/performance-compat",am="@firebase/remote-config",cm="@firebase/remote-config-compat",lm="@firebase/storage",um="@firebase/storage-compat",hm="@firebase/firestore",dm="@firebase/ai",fm="@firebase/firestore-compat",pm="firebase",mm="12.6.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xi="[DEFAULT]",gm={[Yi]:"fire-core",[jp]:"fire-core-compat",[Wp]:"fire-analytics",[zp]:"fire-analytics-compat",[Gp]:"fire-app-check",[Hp]:"fire-app-check-compat",[Kp]:"fire-auth",[Qp]:"fire-auth-compat",[Yp]:"fire-rtdb",[Xp]:"fire-data-connect",[Jp]:"fire-rtdb-compat",[Zp]:"fire-fn",[em]:"fire-fn-compat",[tm]:"fire-iid",[nm]:"fire-iid-compat",[rm]:"fire-fcm",[sm]:"fire-fcm-compat",[im]:"fire-perf",[om]:"fire-perf-compat",[am]:"fire-rc",[cm]:"fire-rc-compat",[lm]:"fire-gcs",[um]:"fire-gcs-compat",[hm]:"fire-fst",[fm]:"fire-fst-compat",[dm]:"fire-vertex","fire-js":"fire-js",[pm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tm=1024,bm=30;class Am{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new Rm(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=kc();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(s=>s.date===r))return;if(this._heartbeatsCache.heartbeats.push({date:r,agent:t}),this._heartbeatsCache.heartbeats.length>bm){const s=Pm(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ot.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=kc(),{heartbeatsToSend:t,unsentEntries:r}=Sm(this._heartbeatsCache.heartbeats),s=hs(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return ot.warn(e),""}}}function kc(){return new Date().toISOString().substring(0,10)}function Sm(n,e=Tm){const t=[];let r=n.slice();for(const s of n){const i=t.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),Dc(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),Dc(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class Rm{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return fp()?pp().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Im(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Cc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return Cc(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Dc(n){return hs(JSON.stringify({version:2,heartbeats:n})).length}function Pm(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cm(n){yn(new Kt("platform-logger",e=>new $p(e),"PRIVATE")),yn(new Kt("heartbeat",e=>new Am(e),"PRIVATE")),Et(Yi,Rc,n),Et(Yi,Rc,"esm2020"),Et("fire-js","")}Cm("");var km="firebase",Dm="12.6.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Et(km,Dm,"app");function pu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const mu=pu,gu=new _r("auth","Firebase",pu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs=new bo("@firebase/auth");function Vm(n,...e){fs.logLevel<=$.WARN&&fs.warn(`Auth (${Pn}): ${n}`,...e)}function ts(n,...e){fs.logLevel<=$.ERROR&&fs.error(`Auth (${Pn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zi(){return typeof self<"u"&&self.location?.href||""}function Nm(){return Vc()==="http:"||Vc()==="https:"}function Vc(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Om(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Nm()||lp()||"connection"in navigator)?navigator.onLine:!0}function Lm(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(e,t){this.shortDelay=e,this.longDelay=t,at(t>e,"Short delay should be less than long delay!"),this.isMobile=op()||up()}get(){return Om()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof ut&&Wm(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Wm({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ms(n){const e=n.auth,t=await n.getIdToken(),r=await hr(n,ps(e,{idToken:t}));L(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=s.providerUserInfo?.length?Iu(s.providerUserInfo):[],a=Gm(n.providerData,i),l=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!a?.length,d=l?u:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new eo(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function Eu(n){const e=ce(n);await ms(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Gm(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Iu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oc=new Map;function nt(n){at(n instanceof Function,"Expected a class definition");let e=Oc.get(n);return e?(at(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Oc.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tu{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Tu.type="NONE";const to=Tu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ru(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(bu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Cu(e))return"Blackberry";if(ku(e))return"Webos";if(Au(e))return"Safari";if((e.includes("chrome/")||Su(e))&&!e.includes("edge/"))return"Chrome";if(Pu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if(r?.length===2)return r[1]}return"Other"}function bu(n=Ie()){return/firefox\//i.test(n)}function Au(n=Ie()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Su(n=Ie()){return/crios\//i.test(n)}function Ru(n=Ie()){return/iemobile/i.test(n)}function Pu(n=Ie()){return/android/i.test(n)}function Cu(n=Ie()){return/blackberry/i.test(n)}function ku(n=Ie()){return/webos/i.test(n)}function Do(n=Ie()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ym(n=Ie()){return Do(n)&&!!window.navigator?.standalone}function Xm(){return hp()&&document.documentMode===10}function Du(n=Ie()){return Do(n)||Pu(n)||ku(n)||Cu(n)||/windows phone/i.test(n)||Ru(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vu(n,e=[]){let t;switch(n){case"Browser":t=Lc(Ie());break;case"Worker":t=`${Lc(Ie())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Pn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zm(n,e={}){return Nt(n,"GET","/v2/passwordPolicy",xt(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ou(n,e){const t=So(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(At(i,e??{}))return s;Le(s,"already-initialized")}return t.initialize({options:e})}function hg(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(nt);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Lu(n,e,t){const r=Ot(n);L(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Mu(e),{host:a,port:l}=dg(e),u=l===null?"":`:${l}`,d={url:`${i}//${a}${u}/`},p=Object.freeze({host:a,port:l,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){L(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),L(At(d,r.config.emulator)&&At(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,Rn(a)?(ou(`${i}//${a}${u}`),au("Auth",!0)):fg()}function Mu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function dg(n){const e=Mu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Uc(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Uc(a)}}}function Uc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function fg(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mg(n,e){return Er(n,"POST","/v1/accounts:signInWithPassword",xt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gg(n,e){return Er(n,"POST","/v1/accounts:signInWithEmailLink",xt(n,e))}async function yg(n,e){return Er(n,"POST","/v1/accounts:signInWithEmailLink",xt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mn(n,e){return Er(n,"POST","/v1/accounts:signInWithIdp",xt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir extends Vo{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eg(n,e){return Er(n,"POST","/v1/accounts:signUp",xt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uu(n,e,t=!1){if(Ve(n.app))return Promise.reject(rt(n));const r="signIn",s=await Fu(n,r,e),i=await Qt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function Bu(n,e){return Uu(Ot(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $u(n){const e=Ot(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function qu(n,e,t){if(Ve(n.app))return Promise.reject(rt(n));const r=Ot(n),a=await no(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Eg).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&$u(n),u}),l=await Qt._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function ju(n,e,t){return Ve(n.app)?Promise.reject(rt(n)):Bu(ce(n),en.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&$u(n),r})}function zu(n,e,t,r){return ce(n).onIdTokenChanged(e,t,r)}function Wu(n,e,t){return ce(n).beforeAuthStateChanged(e,t)}function Hu(n,e,t,r){return ce(n).onAuthStateChanged(e,t,r)}function Gu(n){return ce(n).signOut()}async function bg(n){return ce(n).delete()}const ys="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xu extends Ku{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Xu.type="SESSION";const xo=Xu;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function He(){return window}function Cg(n){He().location.href=n}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ju(){return typeof He().WorkerGlobalScope<"u"&&typeof He().importScripts=="function"}async function kg(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Dg(){return navigator?.serviceWorker?.controller||null}function Vg(){return Ju()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ry=new wr(3e4,6e4);function zc(){const n=He().___jsl;if(n?.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function sy(n){return new Promise((e,t)=>{function r(){zc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{zc(),t(Fe(n,"network-request-failed"))},timeout:ry.get()})}if(He().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(He().gapi?.load)r();else{const s=og("iframefcb");return He()[s]=()=>{gapi.load?r():t(Fe(n,"network-request-failed"))},xu(`${ig()}?onload=${s}`).catch(i=>t(i))}}).catch(e=>{throw ss=null,e})}let ss=null;function iy(n){return ss=ss||sy(n),ss}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fy={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},py=500,my=600,gy="_blank",yy="http://localhost";class Wc{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function _y(n,e,t,r=py,s=my){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const u={...fy,width:r.toString(),height:s.toString(),top:i,left:a},d=Ie().toLowerCase();t&&(l=Su(d)?gy:t),bu(d)&&(e=e||yy,u.scrollbars="yes");const p=Object.entries(u).reduce((v,[S,k])=>`${v}${S}=${k},`,"");if(Ym(d)&&l!=="_self")return vy(e||"",l),new Wc(null);const y=window.open(e||"",l,p);L(y,n,"popup-blocked");try{y.focus()}catch{}return new Wc(y)}function vy(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wy="__/auth/handler",Ey="emulator/auth/handler",Iy=encodeURIComponent("fac");async function Hc(n,e,t,r,s,i){L(n.config.authDomain,n,"auth-domain-config-required"),L(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Pn,eventId:s};if(e instanceof Vo){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",_p(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,y]of Object.entries({}))a[p]=y}if(e instanceof Ir){const p=e.getScopes().filter(y=>y!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const l=a;for(const p of Object.keys(l))l[p]===void 0&&delete l[p];const u=await n._getAppCheckToken(),d=u?`#${Iy}=${encodeURIComponent(u)}`:"";return`${Ty(n)}?${vr(l).slice(1)}${d}`}function Ty({config:n}){return n.emulator?Co(n,Ey):`https://${n.authDomain}/${wy}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sy(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ry(n){yn(new Kt("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:l}=r.options;L(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:l,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vu(n)},d=new ng(r,s,i,u);return hg(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),yn(new Kt("auth-internal",e=>{const t=Ot(e.getProvider("auth").getImmediate());return(r=>new Ay(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),Et(Gc,Kc,Sy(n)),Et(Gc,Kc,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Py=300,Cy=iu("authIdTokenMaxAge")||Py;let Qc=null;const ky=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Cy)return;const s=t?.token;Qc!==s&&(Qc=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function ch(n=hu()){const e=So(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Ou(n,{popupRedirectResolver:ah,persistence:[nh,Yu,xo]}),r=iu("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const a=ky(i.toString());Wu(t,a,()=>a(t.currentUser)),zu(t,l=>a(l))}}const s=ru("auth");return s&&Lu(t,`http://${s}`),t}function Dy(){return document.getElementsByTagName("head")?.[0]??document}rg({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const i=Fe("internal-error");i.customData=s,t(i)},r.type="text/javascript",r.charset="UTF-8",Dy().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ry("Browser");const Vy=Object.freeze(Object.defineProperty({__proto__:null,ActionCodeURL:Ns,AuthCredential:xs,EmailAuthCredential:_n,EmailAuthProvider:en,FacebookAuthProvider:Je,GithubAuthProvider:Ze,GoogleAuthProvider:We,OAuthCredential:St,TwitterAuthProvider:et,beforeAuthStateChanged:Wu,browserLocalPersistence:Yu,browserPopupRedirectResolver:ah,browserSessionPersistence:xo,connectAuthEmulator:Lu,createUserWithEmailAndPassword:qu,deleteUser:bg,getAuth:ch,getIdTokenResult:wu,inMemoryPersistence:to,indexedDBLocalPersistence:nh,initializeAuth:Ou,onAuthStateChanged:Hu,onIdTokenChanged:zu,prodErrorMap:mu,reload:Eu,signInWithCredential:Bu,signInWithEmailAndPassword:ju,signInWithPopup:ih,signOut:Gu},Symbol.toStringTag,{value:"Module"}));var Yc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var It,lh;(function(){var n;/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,m){function _(){}_.prototype=m.prototype,E.F=m.prototype,E.prototype=new _,E.prototype.constructor=E,E.D=function(I,w,b){for(var g=Array(arguments.length-2),Pe=2;Pe<arguments.length;Pe++)g[Pe-2]=arguments[Pe];return m.prototype[w].apply(I,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(E,m,_){_||(_=0);const I=Array(16);if(typeof m=="string")for(var w=0;w<16;++w)I[w]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(w=0;w<16;++w)I[w]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=E.g[0],_=E.g[1],w=E.g[2];let b=E.g[3],g;g=m+(b^_&(w^b))+I[0]+3614090360&4294967295,m=_+(g<<7&4294967295|g>>>25),g=b+(w^m&(_^w))+I[1]+3905402710&4294967295,b=m+(g<<12&4294967295|g>>>20),g=w+(_^b&(m^_))+I[2]+606105819&4294967295,w=b+(g<<17&4294967295|g>>>15),g=_+(m^w&(b^m))+I[3]+3250441966&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(b^_&(w^b))+I[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=b+(w^m&(_^w))+I[5]+1200080426&4294967295,b=m+(g<<12&4294967295|g>>>20),g=w+(_^b&(m^_))+I[6]+2821735955&4294967295,w=b+(g<<17&4294967295|g>>>15),g=_+(m^w&(b^m))+I[7]+4249261313&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(b^_&(w^b))+I[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=b+(w^m&(_^w))+I[9]+2336552879&4294967295,b=m+(g<<12&4294967295|g>>>20),g=w+(_^b&(m^_))+I[10]+4294925233&4294967295,w=b+(g<<17&4294967295|g>>>15),g=_+(m^w&(b^m))+I[11]+2304563134&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(b^_&(w^b))+I[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=b+(w^m&(_^w))+I[13]+4254626195&4294967295,b=m+(g<<12&4294967295|g>>>20),g=w+(_^b&(m^_))+I[14]+2792965006&4294967295,w=b+(g<<17&4294967295|g>>>15),g=_+(m^w&(b^m))+I[15]+1236535329&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(w^b&(_^w))+I[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=b+(_^w&(m^_))+I[6]+3225465664&4294967295,b=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(b^m))+I[11]+643717713&4294967295,w=b+(g<<14&4294967295|g>>>18),g=_+(b^m&(w^b))+I[0]+3921069994&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^b&(_^w))+I[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=b+(_^w&(m^_))+I[10]+38016083&4294967295,b=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(b^m))+I[15]+3634488961&4294967295,w=b+(g<<14&4294967295|g>>>18),g=_+(b^m&(w^b))+I[4]+3889429448&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^b&(_^w))+I[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=b+(_^w&(m^_))+I[14]+3275163606&4294967295,b=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(b^m))+I[3]+4107603335&4294967295,w=b+(g<<14&4294967295|g>>>18),g=_+(b^m&(w^b))+I[8]+1163531501&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^b&(_^w))+I[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=b+(_^w&(m^_))+I[2]+4243563512&4294967295,b=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(b^m))+I[7]+1735328473&4294967295,w=b+(g<<14&4294967295|g>>>18),g=_+(b^m&(w^b))+I[12]+2368359562&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(_^w^b)+I[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=b+(m^_^w)+I[8]+2272392833&4294967295,b=m+(g<<11&4294967295|g>>>21),g=w+(b^m^_)+I[11]+1839030562&4294967295,w=b+(g<<16&4294967295|g>>>16),g=_+(w^b^m)+I[14]+4259657740&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^b)+I[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=b+(m^_^w)+I[4]+1272893353&4294967295,b=m+(g<<11&4294967295|g>>>21),g=w+(b^m^_)+I[7]+4139469664&4294967295,w=b+(g<<16&4294967295|g>>>16),g=_+(w^b^m)+I[10]+3200236656&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^b)+I[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=b+(m^_^w)+I[0]+3936430074&4294967295,b=m+(g<<11&4294967295|g>>>21),g=w+(b^m^_)+I[3]+3572445317&4294967295,w=b+(g<<16&4294967295|g>>>16),g=_+(w^b^m)+I[6]+76029189&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^b)+I[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=b+(m^_^w)+I[12]+3873151461&4294967295,b=m+(g<<11&4294967295|g>>>21),g=w+(b^m^_)+I[15]+530742520&4294967295,w=b+(g<<16&4294967295|g>>>16),g=_+(w^b^m)+I[2]+3299628645&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(w^(_|~b))+I[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=b+(_^(m|~w))+I[7]+1126891415&4294967295,b=m+(g<<10&4294967295|g>>>22),g=w+(m^(b|~_))+I[14]+2878612391&4294967295,w=b+(g<<15&4294967295|g>>>17),g=_+(b^(w|~m))+I[5]+4237533241&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~b))+I[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=b+(_^(m|~w))+I[3]+2399980690&4294967295,b=m+(g<<10&4294967295|g>>>22),g=w+(m^(b|~_))+I[10]+4293915773&4294967295,w=b+(g<<15&4294967295|g>>>17),g=_+(b^(w|~m))+I[1]+2240044497&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~b))+I[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=b+(_^(m|~w))+I[15]+4264355552&4294967295,b=m+(g<<10&4294967295|g>>>22),g=w+(m^(b|~_))+I[6]+2734768916&4294967295,w=b+(g<<15&4294967295|g>>>17),g=_+(b^(w|~m))+I[13]+1309151649&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~b))+I[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=b+(_^(m|~w))+I[11]+3174756917&4294967295,b=m+(g<<10&4294967295|g>>>22),g=w+(m^(b|~_))+I[2]+718787259&4294967295,w=b+(g<<15&4294967295|g>>>17),g=_+(b^(w|~m))+I[9]+3951481745&4294967295,E.g[0]=E.g[0]+m&4294967295,E.g[1]=E.g[1]+(w+(g<<21&4294967295|g>>>11))&4294967295,E.g[2]=E.g[2]+w&4294967295,E.g[3]=E.g[3]+b&4294967295}r.prototype.v=function(E,m){m===void 0&&(m=E.length);const _=m-this.blockSize,I=this.C;let w=this.h,b=0;for(;b<m;){if(w==0)for(;b<=_;)s(this,E,b),b+=this.blockSize;if(typeof E=="string"){for(;b<m;)if(I[w++]=E.charCodeAt(b++),w==this.blockSize){s(this,I),w=0;break}}else for(;b<m;)if(I[w++]=E[b++],w==this.blockSize){s(this,I),w=0;break}}this.h=w,this.o+=m},r.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var m=1;m<E.length-8;++m)E[m]=0;m=this.o*8;for(var _=E.length-8;_<E.length;++_)E[_]=m&255,m/=256;for(this.v(E),E=Array(16),m=0,_=0;_<4;++_)for(let I=0;I<32;I+=8)E[m++]=this.g[_]>>>I&255;return E};function i(E,m){var _=l;return Object.prototype.hasOwnProperty.call(_,E)?_[E]:_[E]=m(E)}function a(E,m){this.h=m;const _=[];let I=!0;for(let w=E.length-1;w>=0;w--){const b=E[w]|0;I&&b==m||(_[w]=b,I=!1)}this.g=_}var l={};function u(E){return-128<=E&&E<128?i(E,function(m){return new a([m|0],m<0?-1:0)}):new a([E|0],E<0?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return y;if(E<0)return D(d(-E));const m=[];let _=1;for(let I=0;E>=_;I++)m[I]=E/_|0,_*=4294967296;return new a(m,0)}function p(E,m){if(E.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(E.charAt(0)=="-")return D(p(E.substring(1),m));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(m,8));let I=y;for(let b=0;b<E.length;b+=8){var w=Math.min(8,E.length-b);const g=parseInt(E.substring(b,b+w),m);w<8?(w=d(Math.pow(m,w)),I=I.j(w).add(d(g))):(I=I.j(_),I=I.add(d(g)))}return I}var y=u(0),v=u(1),S=u(16777216);n=a.prototype,n.m=function(){if(N(this))return-D(this).m();let E=0,m=1;for(let _=0;_<this.g.length;_++){const I=this.i(_);E+=(I>=0?I:4294967296+I)*m,m*=4294967296}return E},n.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(k(this))return"0";if(N(this))return"-"+D(this).toString(E);const m=d(Math.pow(E,6));var _=this;let I="";for(;;){const w=Te(_,m).g;_=z(_,w.j(m));let b=((_.g.length>0?_.g[0]:_.h)>>>0).toString(E);if(_=w,k(_))return b+I;for(;b.length<6;)b="0"+b;I=b+I}},n.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function k(E){if(E.h!=0)return!1;for(let m=0;m<E.g.length;m++)if(E.g[m]!=0)return!1;return!0}function N(E){return E.h==-1}n.l=function(E){return E=z(this,E),N(E)?-1:k(E)?0:1};function D(E){const m=E.g.length,_=[];for(let I=0;I<m;I++)_[I]=~E.g[I];return new a(_,~E.h).add(v)}n.abs=function(){return N(this)?D(this):this},n.add=function(E){const m=Math.max(this.g.length,E.g.length),_=[];let I=0;for(let w=0;w<=m;w++){let b=I+(this.i(w)&65535)+(E.i(w)&65535),g=(b>>>16)+(this.i(w)>>>16)+(E.i(w)>>>16);I=g>>>16,b&=65535,g&=65535,_[w]=g<<16|b}return new a(_,_[_.length-1]&-2147483648?-1:0)};function z(E,m){return E.add(D(m))}n.j=function(E){if(k(this)||k(E))return y;if(N(this))return N(E)?D(this).j(D(E)):D(D(this).j(E));if(N(E))return D(this.j(D(E)));if(this.l(S)<0&&E.l(S)<0)return d(this.m()*E.m());const m=this.g.length+E.g.length,_=[];for(var I=0;I<2*m;I++)_[I]=0;for(I=0;I<this.g.length;I++)for(let w=0;w<E.g.length;w++){const b=this.i(I)>>>16,g=this.i(I)&65535,Pe=E.i(w)>>>16,Ut=E.i(w)&65535;_[2*I+2*w]+=g*Ut,H(_,2*I+2*w),_[2*I+2*w+1]+=b*Ut,H(_,2*I+2*w+1),_[2*I+2*w+1]+=g*Pe,H(_,2*I+2*w+1),_[2*I+2*w+2]+=b*Pe,H(_,2*I+2*w+2)}for(E=0;E<m;E++)_[E]=_[2*E+1]<<16|_[2*E];for(E=m;E<2*m;E++)_[E]=0;return new a(_,0)};function H(E,m){for(;(E[m]&65535)!=E[m];)E[m+1]+=E[m]>>>16,E[m]&=65535,m++}function G(E,m){this.g=E,this.h=m}function Te(E,m){if(k(m))throw Error("division by zero");if(k(E))return new G(y,y);if(N(E))return m=Te(D(E),m),new G(D(m.g),D(m.h));if(N(m))return m=Te(E,D(m)),new G(D(m.g),m.h);if(E.g.length>30){if(N(E)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var _=v,I=m;I.l(E)<=0;)_=Re(_),I=Re(I);var w=he(_,1),b=he(I,1);for(I=he(I,2),_=he(_,2);!k(I);){var g=b.add(I);g.l(E)<=0&&(w=w.add(_),b=g),I=he(I,1),_=he(_,1)}return m=z(E,w.j(m)),new G(w,m)}for(w=y;E.l(m)>=0;){for(_=Math.max(1,Math.floor(E.m()/m.m())),I=Math.ceil(Math.log(_)/Math.LN2),I=I<=48?1:Math.pow(2,I-48),b=d(_),g=b.j(m);N(g)||g.l(E)>0;)_-=I,b=d(_),g=b.j(m);k(b)&&(b=v),w=w.add(b),E=z(E,g)}return new G(w,E)}n.B=function(E){return Te(this,E).h},n.and=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)&E.i(I);return new a(_,this.h&E.h)},n.or=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)|E.i(I);return new a(_,this.h|E.h)},n.xor=function(E){const m=Math.max(this.g.length,E.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)^E.i(I);return new a(_,this.h^E.h)};function Re(E){const m=E.g.length+1,_=[];for(let I=0;I<m;I++)_[I]=E.i(I)<<1|E.i(I-1)>>>31;return new a(_,E.h)}function he(E,m){const _=m>>5;m%=32;const I=E.g.length-_,w=[];for(let b=0;b<I;b++)w[b]=m>0?E.i(b+_)>>>m|E.i(b+_+1)<<32-m:E.i(b+_);return new a(w,E.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,lh=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,It=a}).apply(typeof Yc<"u"?Yc:typeof self<"u"?self:typeof window<"u"?window:{});var Yr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var uh,er,hh,is,so,dh,fh,ph;(function(){var n,e=Object.defineProperty;function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Yr=="object"&&Yr];for(var c=0;c<o.length;++c){var h=o[c];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function s(o,c){if(c)e:{var h=r;o=o.split(".");for(var f=0;f<o.length-1;f++){var T=o[f];if(!(T in h))break e;h=h[T]}o=o[o.length-1],f=h[o],c=c(f),c!=f&&c!=null&&e(h,o,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(o){return o||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(o){return o||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(o){return o||function(c){var h=[],f;for(f in c)Object.prototype.hasOwnProperty.call(c,f)&&h.push([f,c[f]]);return h}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},a=this||self;function l(o){var c=typeof o;return c=="object"&&o!=null||c=="function"}function u(o,c,h){return o.call.apply(o.bind,arguments)}function d(o,c,h){return d=u,d.apply(null,arguments)}function p(o,c){var h=Array.prototype.slice.call(arguments,1);return function(){var f=h.slice();return f.push.apply(f,arguments),o.apply(this,f)}}function y(o,c){function h(){}h.prototype=c.prototype,o.Z=c.prototype,o.prototype=new h,o.prototype.constructor=o,o.Ob=function(f,T,A){for(var C=Array(arguments.length-2),B=2;B<arguments.length;B++)C[B-2]=arguments[B];return c.prototype[T].apply(f,C)}}var v=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?o=>o&&AsyncContext.Snapshot.wrap(o):o=>o;function S(o){const c=o.length;if(c>0){const h=Array(c);for(let f=0;f<c;f++)h[f]=o[f];return h}return[]}function k(o,c){for(let f=1;f<arguments.length;f++){const T=arguments[f];var h=typeof T;if(h=h!="object"?h:T?Array.isArray(T)?"array":h:"null",h=="array"||h=="object"&&typeof T.length=="number"){h=o.length||0;const A=T.length||0;o.length=h+A;for(let C=0;C<A;C++)o[h+C]=T[C]}else o.push(T)}}class N{constructor(c,h){this.i=c,this.j=h,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function D(o){a.setTimeout(()=>{throw o},0)}function z(){var o=E;let c=null;return o.g&&(c=o.g,o.g=o.g.next,o.g||(o.h=null),c.next=null),c}class H{constructor(){this.h=this.g=null}add(c,h){const f=G.get();f.set(c,h),this.h?this.h.next=f:this.g=f,this.h=f}}var G=new N(()=>new Te,o=>o.reset());class Te{constructor(){this.next=this.g=this.h=null}set(c,h){this.h=c,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Re,he=!1,E=new H,m=()=>{const o=Promise.resolve(void 0);Re=()=>{o.then(_)}};function _(){for(var o;o=z();){try{o.h.call(o.g)}catch(h){D(h)}var c=G;c.j(o),c.h<100&&(c.h++,o.next=c.g,c.g=o)}he=!1}function I(){this.u=this.u,this.C=this.C}I.prototype.u=!1,I.prototype.dispose=function(){this.u||(this.u=!0,this.N())},I.prototype[Symbol.dispose]=function(){this.dispose()},I.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function w(o,c){this.type=o,this.g=this.target=c,this.defaultPrevented=!1}w.prototype.h=function(){this.defaultPrevented=!0};var b=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var o=!1,c=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const h=()=>{};a.addEventListener("test",h,c),a.removeEventListener("test",h,c)}catch{}return o})();function g(o){return/^[\s\xa0]*$/.test(o)}function Pe(o,c){w.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o&&this.init(o,c)}y(Pe,w),Pe.prototype.init=function(o,c){const h=this.type=o.type,f=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;this.target=o.target||o.srcElement,this.g=c,c=o.relatedTarget,c||(h=="mouseover"?c=o.fromElement:h=="mouseout"&&(c=o.toElement)),this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=o.pointerType,this.state=o.state,this.i=o,o.defaultPrevented&&Pe.Z.h.call(this)},Pe.prototype.h=function(){Pe.Z.h.call(this);const o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Ut="closure_listenable_"+(Math.random()*1e6|0),ff=0;function pf(o,c,h,f,T){this.listener=o,this.proxy=null,this.src=c,this.type=h,this.capture=!!f,this.ha=T,this.key=++ff,this.da=this.fa=!1}function Nr(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function Or(o,c,h){for(const f in o)c.call(h,o[f],f,o)}function mf(o,c){for(const h in o)c.call(void 0,o[h],h,o)}function va(o){const c={};for(const h in o)c[h]=o[h];return c}const wa="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ea(o,c){let h,f;for(let T=1;T<arguments.length;T++){f=arguments[T];for(h in f)o[h]=f[h];for(let A=0;A<wa.length;A++)h=wa[A],Object.prototype.hasOwnProperty.call(f,h)&&(o[h]=f[h])}}function Lr(o){this.src=o,this.g={},this.h=0}Lr.prototype.add=function(o,c,h,f,T){const A=o.toString();o=this.g[A],o||(o=this.g[A]=[],this.h++);const C=ui(o,c,f,T);return C>-1?(c=o[C],h||(c.fa=!1)):(c=new pf(c,this.src,A,!!f,T),c.fa=h,o.push(c)),c};function li(o,c){const h=c.type;if(h in o.g){var f=o.g[h],T=Array.prototype.indexOf.call(f,c,void 0),A;(A=T>=0)&&Array.prototype.splice.call(f,T,1),A&&(Nr(c),o.g[h].length==0&&(delete o.g[h],o.h--))}}function ui(o,c,h,f){for(let T=0;T<o.length;++T){const A=o[T];if(!A.da&&A.listener==c&&A.capture==!!h&&A.ha==f)return T}return-1}var hi="closure_lm_"+(Math.random()*1e6|0),di={};function Ia(o,c,h,f,T){if(Array.isArray(c)){for(let A=0;A<c.length;A++)Ia(o,c[A],h,f,T);return null}return h=Aa(h),o&&o[Ut]?o.J(c,h,l(f)?!!f.capture:!1,T):gf(o,c,h,!1,f,T)}function gf(o,c,h,f,T,A){if(!c)throw Error("Invalid event type");const C=l(T)?!!T.capture:!!T;let B=pi(o);if(B||(o[hi]=B=new Lr(o)),h=B.add(c,h,f,C,A),h.proxy)return h;if(f=yf(),h.proxy=f,f.src=o,f.listener=h,o.addEventListener)b||(T=C),T===void 0&&(T=!1),o.addEventListener(c.toString(),f,T);else if(o.attachEvent)o.attachEvent(ba(c.toString()),f);else if(o.addListener&&o.removeListener)o.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return h}function yf(){function o(h){return c.call(o.src,o.listener,h)}const c=_f;return o}function Ta(o,c,h,f,T){if(Array.isArray(c))for(var A=0;A<c.length;A++)Ta(o,c[A],h,f,T);else f=l(f)?!!f.capture:!!f,h=Aa(h),o&&o[Ut]?(o=o.i,A=String(c).toString(),A in o.g&&(c=o.g[A],h=ui(c,h,f,T),h>-1&&(Nr(c[h]),Array.prototype.splice.call(c,h,1),c.length==0&&(delete o.g[A],o.h--)))):o&&(o=pi(o))&&(c=o.g[c.toString()],o=-1,c&&(o=ui(c,h,f,T)),(h=o>-1?c[o]:null)&&fi(h))}function fi(o){if(typeof o!="number"&&o&&!o.da){var c=o.src;if(c&&c[Ut])li(c.i,o);else{var h=o.type,f=o.proxy;c.removeEventListener?c.removeEventListener(h,f,o.capture):c.detachEvent?c.detachEvent(ba(h),f):c.addListener&&c.removeListener&&c.removeListener(f),(h=pi(c))?(li(h,o),h.h==0&&(h.src=null,c[hi]=null)):Nr(o)}}}function ba(o){return o in di?di[o]:di[o]="on"+o}function _f(o,c){if(o.da)o=!0;else{c=new Pe(c,this);const h=o.listener,f=o.ha||o.src;o.fa&&fi(o),o=h.call(f,c)}return o}function pi(o){return o=o[hi],o instanceof Lr?o:null}var mi="__closure_events_fn_"+(Math.random()*1e9>>>0);function Aa(o){return typeof o=="function"?o:(o[mi]||(o[mi]=function(c){return o.handleEvent(c)}),o[mi])}function ye(){I.call(this),this.i=new Lr(this),this.M=this,this.G=null}y(ye,I),ye.prototype[Ut]=!0,ye.prototype.removeEventListener=function(o,c,h,f){Ta(this,o,c,h,f)};function be(o,c){var h,f=o.G;if(f)for(h=[];f;f=f.G)h.push(f);if(o=o.M,f=c.type||c,typeof c=="string")c=new w(c,o);else if(c instanceof w)c.target=c.target||o;else{var T=c;c=new w(f,o),Ea(c,T)}T=!0;let A,C;if(h)for(C=h.length-1;C>=0;C--)A=c.g=h[C],T=Mr(A,f,!0,c)&&T;if(A=c.g=o,T=Mr(A,f,!0,c)&&T,T=Mr(A,f,!1,c)&&T,h)for(C=0;C<h.length;C++)A=c.g=h[C],T=Mr(A,f,!1,c)&&T}ye.prototype.N=function(){if(ye.Z.N.call(this),this.i){var o=this.i;for(const c in o.g){const h=o.g[c];for(let f=0;f<h.length;f++)Nr(h[f]);delete o.g[c],o.h--}}this.G=null},ye.prototype.J=function(o,c,h,f){return this.i.add(String(o),c,!1,h,f)},ye.prototype.K=function(o,c,h,f){return this.i.add(String(o),c,!0,h,f)};function Mr(o,c,h,f){if(c=o.i.g[String(c)],!c)return!0;c=c.concat();let T=!0;for(let A=0;A<c.length;++A){const C=c[A];if(C&&!C.da&&C.capture==h){const B=C.listener,le=C.ha||C.src;C.fa&&li(o.i,C),T=B.call(le,f)!==!1&&T}}return T&&!f.defaultPrevented}function vf(o,c){if(typeof o!="function")if(o&&typeof o.handleEvent=="function")o=d(o.handleEvent,o);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(o,c||0)}function Sa(o){o.g=vf(()=>{o.g=null,o.i&&(o.i=!1,Sa(o))},o.l);const c=o.h;o.h=null,o.m.apply(null,c)}class wf extends I{constructor(c,h){super(),this.m=c,this.l=h,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Sa(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Ln(o){I.call(this),this.h=o,this.g={}}y(Ln,I);var Ra=[];function Pa(o){Or(o.g,function(c,h){this.g.hasOwnProperty(h)&&fi(c)},o),o.g={}}Ln.prototype.N=function(){Ln.Z.N.call(this),Pa(this)},Ln.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var gi=a.JSON.stringify,Ef=a.JSON.parse,If=class{stringify(o){return a.JSON.stringify(o,void 0)}parse(o){return a.JSON.parse(o,void 0)}};function Ca(){}function ka(){}var Mn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function yi(){w.call(this,"d")}y(yi,w);function _i(){w.call(this,"c")}y(_i,w);var Bt={},Da=null;function Fr(){return Da=Da||new ye}Bt.Ia="serverreachability";function Va(o){w.call(this,Bt.Ia,o)}y(Va,w);function Fn(o){const c=Fr();be(c,new Va(c))}Bt.STAT_EVENT="statevent";function xa(o,c){w.call(this,Bt.STAT_EVENT,o),this.stat=c}y(xa,w);function Ae(o){const c=Fr();be(c,new xa(c,o))}Bt.Ja="timingevent";function Na(o,c){w.call(this,Bt.Ja,o),this.size=c}y(Na,w);function Un(o,c){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){o()},c)}function Bn(){this.g=!0}Bn.prototype.ua=function(){this.g=!1};function Tf(o,c,h,f,T,A){o.info(function(){if(o.g)if(A){var C="",B=A.split("&");for(let Y=0;Y<B.length;Y++){var le=B[Y].split("=");if(le.length>1){const de=le[0];le=le[1];const je=de.split("_");C=je.length>=2&&je[1]=="type"?C+(de+"="+le+"&"):C+(de+"=redacted&")}}}else C=null;else C=A;return"XMLHTTP REQ ("+f+") [attempt "+T+"]: "+c+`
`+h+`
`+C})}function bf(o,c,h,f,T,A,C){o.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+T+"]: "+c+`
`+h+`
`+A+" "+C})}function sn(o,c,h,f){o.info(function(){return"XMLHTTP TEXT ("+c+"): "+Sf(o,h)+(f?" "+f:"")})}function Af(o,c){o.info(function(){return"TIMEOUT: "+c})}Bn.prototype.info=function(){};function Sf(o,c){if(!o.g)return c;if(!c)return null;try{const A=JSON.parse(c);if(A){for(o=0;o<A.length;o++)if(Array.isArray(A[o])){var h=A[o];if(!(h.length<2)){var f=h[1];if(Array.isArray(f)&&!(f.length<1)){var T=f[0];if(T!="noop"&&T!="stop"&&T!="close")for(let C=1;C<f.length;C++)f[C]=""}}}}return gi(A)}catch{return c}}var Ur={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Oa={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},La;function vi(){}y(vi,Ca),vi.prototype.g=function(){return new XMLHttpRequest},La=new vi;function $n(o){return encodeURIComponent(String(o))}function Rf(o){var c=1;o=o.split(":");const h=[];for(;c>0&&o.length;)h.push(o.shift()),c--;return o.length&&h.push(o.join(":")),h}function ht(o,c,h,f){this.j=o,this.i=c,this.l=h,this.S=f||1,this.V=new Ln(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Ma}function Ma(){this.i=null,this.g="",this.h=!1}var Fa={},wi={};function Ei(o,c,h){o.M=1,o.A=$r(qe(c)),o.u=h,o.R=!0,Ua(o,null)}function Ua(o,c){o.F=Date.now(),Br(o),o.B=qe(o.A);var h=o.B,f=o.S;Array.isArray(f)||(f=[String(f)]),Ja(h.i,"t",f),o.C=0,h=o.j.L,o.h=new Ma,o.g=gc(o.j,h?c:null,!o.u),o.P>0&&(o.O=new wf(d(o.Y,o,o.g),o.P)),c=o.V,h=o.g,f=o.ba;var T="readystatechange";Array.isArray(T)||(T&&(Ra[0]=T.toString()),T=Ra);for(let A=0;A<T.length;A++){const C=Ia(h,T[A],f||c.handleEvent,!1,c.h||c);if(!C)break;c.g[C.key]=C}c=o.J?va(o.J):{},o.u?(o.v||(o.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.B,o.v,o.u,c)):(o.v="GET",o.g.ea(o.B,o.v,null,c)),Fn(),Tf(o.i,o.v,o.B,o.l,o.S,o.u)}ht.prototype.ba=function(o){o=o.target;const c=this.O;c&&pt(o)==3?c.j():this.Y(o)},ht.prototype.Y=function(o){try{if(o==this.g)e:{const B=pt(this.g),le=this.g.ya(),Y=this.g.ca();if(!(B<3)&&(B!=3||this.g&&(this.h.h||this.g.la()||ic(this.g)))){this.K||B!=4||le==7||(le==8||Y<=0?Fn(3):Fn(2)),Ii(this);var c=this.g.ca();this.X=c;var h=Pf(this);if(this.o=c==200,bf(this.i,this.v,this.B,this.l,this.S,B,c),this.o){if(this.U&&!this.L){t:{if(this.g){var f,T=this.g;if((f=T.g?T.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(f)){var A=f;break t}}A=null}if(o=A)sn(this.i,this.l,o,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Ti(this,o);else{this.o=!1,this.m=3,Ae(12),$t(this),qn(this);break e}}if(this.R){o=!0;let de;for(;!this.K&&this.C<h.length;)if(de=Cf(this,h),de==wi){B==4&&(this.m=4,Ae(14),o=!1),sn(this.i,this.l,null,"[Incomplete Response]");break}else if(de==Fa){this.m=4,Ae(15),sn(this.i,this.l,h,"[Invalid Chunk]"),o=!1;break}else sn(this.i,this.l,de,null),Ti(this,de);if(Ba(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),B!=4||h.length!=0||this.h.h||(this.m=1,Ae(16),o=!1),this.o=this.o&&o,!o)sn(this.i,this.l,h,"[Invalid Chunked Response]"),$t(this),qn(this);else if(h.length>0&&!this.W){this.W=!0;var C=this.j;C.g==this&&C.aa&&!C.P&&(C.j.info("Great, no buffering proxy detected. Bytes received: "+h.length),Di(C),C.P=!0,Ae(11))}}else sn(this.i,this.l,h,null),Ti(this,h);B==4&&$t(this),this.o&&!this.K&&(B==4?dc(this.j,this):(this.o=!1,Br(this)))}else jf(this.g),c==400&&h.indexOf("Unknown SID")>0?(this.m=3,Ae(12)):(this.m=0,Ae(13)),$t(this),qn(this)}}}catch{}finally{}};function Pf(o){if(!Ba(o))return o.g.la();const c=ic(o.g);if(c==="")return"";let h="";const f=c.length,T=pt(o.g)==4;if(!o.h.i){if(typeof TextDecoder>"u")return $t(o),qn(o),"";o.h.i=new a.TextDecoder}for(let A=0;A<f;A++)o.h.h=!0,h+=o.h.i.decode(c[A],{stream:!(T&&A==f-1)});return c.length=0,o.h.g+=h,o.C=0,o.h.g}function Ba(o){return o.g?o.v=="GET"&&o.M!=2&&o.j.Aa:!1}function Cf(o,c){var h=o.C,f=c.indexOf(`
`,h);return f==-1?wi:(h=Number(c.substring(h,f)),isNaN(h)?Fa:(f+=1,f+h>c.length?wi:(c=c.slice(f,f+h),o.C=f+h,c)))}ht.prototype.cancel=function(){this.K=!0,$t(this)};function Br(o){o.T=Date.now()+o.H,$a(o,o.H)}function $a(o,c){if(o.D!=null)throw Error("WatchDog timer not null");o.D=Un(d(o.aa,o),c)}function Ii(o){o.D&&(a.clearTimeout(o.D),o.D=null)}ht.prototype.aa=function(){this.D=null;const o=Date.now();o-this.T>=0?(Af(this.i,this.B),this.M!=2&&(Fn(),Ae(17)),$t(this),this.m=2,qn(this)):$a(this,this.T-o)};function qn(o){o.j.I==0||o.K||dc(o.j,o)}function $t(o){Ii(o);var c=o.O;c&&typeof c.dispose=="function"&&c.dispose(),o.O=null,Pa(o.V),o.g&&(c=o.g,o.g=null,c.abort(),c.dispose())}function Ti(o,c){try{var h=o.j;if(h.I!=0&&(h.g==o||bi(h.h,o))){if(!o.L&&bi(h.h,o)&&h.I==3){try{var f=h.Ba.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var T=f;if(T[0]==0){e:if(!h.v){if(h.g)if(h.g.F+3e3<o.F)Hr(h),zr(h);else break e;ki(h),Ae(18)}}else h.xa=T[1],0<h.xa-h.K&&T[2]<37500&&h.F&&h.A==0&&!h.C&&(h.C=Un(d(h.Va,h),6e3));za(h.h)<=1&&h.ta&&(h.ta=void 0)}else jt(h,11)}else if((o.L||h.g==o)&&Hr(h),!g(c))for(T=h.Ba.g.parse(c),c=0;c<T.length;c++){let Y=T[c];const de=Y[0];if(!(de<=h.K))if(h.K=de,Y=Y[1],h.I==2)if(Y[0]=="c"){h.M=Y[1],h.ba=Y[2];const je=Y[3];je!=null&&(h.ka=je,h.j.info("VER="+h.ka));const zt=Y[4];zt!=null&&(h.za=zt,h.j.info("SVER="+h.za));const mt=Y[5];mt!=null&&typeof mt=="number"&&mt>0&&(f=1.5*mt,h.O=f,h.j.info("backChannelRequestTimeoutMs_="+f)),f=h;const gt=o.g;if(gt){const Kr=gt.g?gt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Kr){var A=f.h;A.g||Kr.indexOf("spdy")==-1&&Kr.indexOf("quic")==-1&&Kr.indexOf("h2")==-1||(A.j=A.l,A.g=new Set,A.h&&(Ai(A,A.h),A.h=null))}if(f.G){const Vi=gt.g?gt.g.getResponseHeader("X-HTTP-Session-Id"):null;Vi&&(f.wa=Vi,Z(f.J,f.G,Vi))}}h.I=3,h.l&&h.l.ra(),h.aa&&(h.T=Date.now()-o.F,h.j.info("Handshake RTT: "+h.T+"ms")),f=h;var C=o;if(f.na=mc(f,f.L?f.ba:null,f.W),C.L){Wa(f.h,C);var B=C,le=f.O;le&&(B.H=le),B.D&&(Ii(B),Br(B)),f.g=C}else uc(f);h.i.length>0&&Wr(h)}else Y[0]!="stop"&&Y[0]!="close"||jt(h,7);else h.I==3&&(Y[0]=="stop"||Y[0]=="close"?Y[0]=="stop"?jt(h,7):Ci(h):Y[0]!="noop"&&h.l&&h.l.qa(Y),h.A=0)}}Fn(4)}catch{}}var kf=class{constructor(o,c){this.g=o,this.map=c}};function qa(o){this.l=o||10,a.PerformanceNavigationTiming?(o=a.performance.getEntriesByType("navigation"),o=o.length>0&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ja(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function za(o){return o.h?1:o.g?o.g.size:0}function bi(o,c){return o.h?o.h==c:o.g?o.g.has(c):!1}function Ai(o,c){o.g?o.g.add(c):o.h=c}function Wa(o,c){o.h&&o.h==c?o.h=null:o.g&&o.g.has(c)&&o.g.delete(c)}qa.prototype.cancel=function(){if(this.i=Ha(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function Ha(o){if(o.h!=null)return o.i.concat(o.h.G);if(o.g!=null&&o.g.size!==0){let c=o.i;for(const h of o.g.values())c=c.concat(h.G);return c}return S(o.i)}var Ga=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Df(o,c){if(o){o=o.split("&");for(let h=0;h<o.length;h++){const f=o[h].indexOf("=");let T,A=null;f>=0?(T=o[h].substring(0,f),A=o[h].substring(f+1)):T=o[h],c(T,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function dt(o){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;o instanceof dt?(this.l=o.l,jn(this,o.j),this.o=o.o,this.g=o.g,zn(this,o.u),this.h=o.h,Si(this,Za(o.i)),this.m=o.m):o&&(c=String(o).match(Ga))?(this.l=!1,jn(this,c[1]||"",!0),this.o=Wn(c[2]||""),this.g=Wn(c[3]||"",!0),zn(this,c[4]),this.h=Wn(c[5]||"",!0),Si(this,c[6]||"",!0),this.m=Wn(c[7]||"")):(this.l=!1,this.i=new Gn(null,this.l))}dt.prototype.toString=function(){const o=[];var c=this.j;c&&o.push(Hn(c,Ka,!0),":");var h=this.g;return(h||c=="file")&&(o.push("//"),(c=this.o)&&o.push(Hn(c,Ka,!0),"@"),o.push($n(h).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.u,h!=null&&o.push(":",String(h))),(h=this.h)&&(this.g&&h.charAt(0)!="/"&&o.push("/"),o.push(Hn(h,h.charAt(0)=="/"?Nf:xf,!0))),(h=this.i.toString())&&o.push("?",h),(h=this.m)&&o.push("#",Hn(h,Lf)),o.join("")},dt.prototype.resolve=function(o){const c=qe(this);let h=!!o.j;h?jn(c,o.j):h=!!o.o,h?c.o=o.o:h=!!o.g,h?c.g=o.g:h=o.u!=null;var f=o.h;if(h)zn(c,o.u);else if(h=!!o.h){if(f.charAt(0)!="/")if(this.g&&!this.h)f="/"+f;else{var T=c.h.lastIndexOf("/");T!=-1&&(f=c.h.slice(0,T+1)+f)}if(T=f,T==".."||T==".")f="";else if(T.indexOf("./")!=-1||T.indexOf("/.")!=-1){f=T.lastIndexOf("/",0)==0,T=T.split("/");const A=[];for(let C=0;C<T.length;){const B=T[C++];B=="."?f&&C==T.length&&A.push(""):B==".."?((A.length>1||A.length==1&&A[0]!="")&&A.pop(),f&&C==T.length&&A.push("")):(A.push(B),f=!0)}f=A.join("/")}else f=T}return h?c.h=f:h=o.i.toString()!=="",h?Si(c,Za(o.i)):h=!!o.m,h&&(c.m=o.m),c};function qe(o){return new dt(o)}function jn(o,c,h){o.j=h?Wn(c,!0):c,o.j&&(o.j=o.j.replace(/:$/,""))}function zn(o,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);o.u=c}else o.u=null}function Si(o,c,h){c instanceof Gn?(o.i=c,Mf(o.i,o.l)):(h||(c=Hn(c,Of)),o.i=new Gn(c,o.l))}function Z(o,c,h){o.i.set(c,h)}function $r(o){return Z(o,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),o}function Wn(o,c){return o?c?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function Hn(o,c,h){return typeof o=="string"?(o=encodeURI(o).replace(c,Vf),h&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function Vf(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Ka=/[#\/\?@]/g,xf=/[#\?:]/g,Nf=/[#\?]/g,Of=/[#\?@]/g,Lf=/#/g;function Gn(o,c){this.h=this.g=null,this.i=o||null,this.j=!!c}function qt(o){o.g||(o.g=new Map,o.h=0,o.i&&Df(o.i,function(c,h){o.add(decodeURIComponent(c.replace(/\+/g," ")),h)}))}n=Gn.prototype,n.add=function(o,c){qt(this),this.i=null,o=on(this,o);let h=this.g.get(o);return h||this.g.set(o,h=[]),h.push(c),this.h+=1,this};function Qa(o,c){qt(o),c=on(o,c),o.g.has(c)&&(o.i=null,o.h-=o.g.get(c).length,o.g.delete(c))}function Ya(o,c){return qt(o),c=on(o,c),o.g.has(c)}n.forEach=function(o,c){qt(this),this.g.forEach(function(h,f){h.forEach(function(T){o.call(c,T,f,this)},this)},this)};function Xa(o,c){qt(o);let h=[];if(typeof c=="string")Ya(o,c)&&(h=h.concat(o.g.get(on(o,c))));else for(o=Array.from(o.g.values()),c=0;c<o.length;c++)h=h.concat(o[c]);return h}n.set=function(o,c){return qt(this),this.i=null,o=on(this,o),Ya(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[c]),this.h+=1,this},n.get=function(o,c){return o?(o=Xa(this,o),o.length>0?String(o[0]):c):c};function Ja(o,c,h){Qa(o,c),h.length>0&&(o.i=null,o.g.set(on(o,c),S(h)),o.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],c=Array.from(this.g.keys());for(let f=0;f<c.length;f++){var h=c[f];const T=$n(h);h=Xa(this,h);for(let A=0;A<h.length;A++){let C=T;h[A]!==""&&(C+="="+$n(h[A])),o.push(C)}}return this.i=o.join("&")};function Za(o){const c=new Gn;return c.i=o.i,o.g&&(c.g=new Map(o.g),c.h=o.h),c}function on(o,c){return c=String(c),o.j&&(c=c.toLowerCase()),c}function Mf(o,c){c&&!o.j&&(qt(o),o.i=null,o.g.forEach(function(h,f){const T=f.toLowerCase();f!=T&&(Qa(this,f),Ja(this,T,h))},o)),o.j=c}function Ff(o,c){const h=new Bn;if(a.Image){const f=new Image;f.onload=p(ft,h,"TestLoadImage: loaded",!0,c,f),f.onerror=p(ft,h,"TestLoadImage: error",!1,c,f),f.onabort=p(ft,h,"TestLoadImage: abort",!1,c,f),f.ontimeout=p(ft,h,"TestLoadImage: timeout",!1,c,f),a.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=o}else c(!1)}function Uf(o,c){const h=new Bn,f=new AbortController,T=setTimeout(()=>{f.abort(),ft(h,"TestPingServer: timeout",!1,c)},1e4);fetch(o,{signal:f.signal}).then(A=>{clearTimeout(T),A.ok?ft(h,"TestPingServer: ok",!0,c):ft(h,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(T),ft(h,"TestPingServer: error",!1,c)})}function ft(o,c,h,f,T){try{T&&(T.onload=null,T.onerror=null,T.onabort=null,T.ontimeout=null),f(h)}catch{}}function Bf(){this.g=new If}function Ri(o){this.i=o.Sb||null,this.h=o.ab||!1}y(Ri,Ca),Ri.prototype.g=function(){return new qr(this.i,this.h)};function qr(o,c){ye.call(this),this.H=o,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}y(qr,ye),n=qr.prototype,n.open=function(o,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=o,this.D=c,this.readyState=1,Qn(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};o&&(c.body=o),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Kn(this)),this.readyState=0},n.Pa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Qn(this)),this.g&&(this.readyState=3,Qn(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;ec(this)}else o.text().then(this.Oa.bind(this),this.ga.bind(this))};function ec(o){o.j.read().then(o.Ma.bind(o)).catch(o.ga.bind(o))}n.Ma=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var c=o.value?o.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!o.done}))&&(this.response=this.responseText+=c)}o.done?Kn(this):Qn(this),this.readyState==3&&ec(this)}},n.Oa=function(o){this.g&&(this.response=this.responseText=o,Kn(this))},n.Na=function(o){this.g&&(this.response=o,Kn(this))},n.ga=function(){this.g&&Kn(this)};function Kn(o){o.readyState=4,o.l=null,o.j=null,o.B=null,Qn(o)}n.setRequestHeader=function(o,c){this.A.append(o,c)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],c=this.h.entries();for(var h=c.next();!h.done;)h=h.value,o.push(h[0]+": "+h[1]),h=c.next();return o.join(`\r
`)};function Qn(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(qr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function tc(o){let c="";return Or(o,function(h,f){c+=f,c+=":",c+=h,c+=`\r
`}),c}function Pi(o,c,h){e:{for(f in h){var f=!1;break e}f=!0}f||(h=tc(h),typeof o=="string"?h!=null&&$n(h):Z(o,c,h))}function re(o){ye.call(this),this.headers=new Map,this.L=o||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}y(re,ye);var $f=/^https?$/i,qf=["POST","PUT"];n=re.prototype,n.Fa=function(o){this.H=o},n.ea=function(o,c,h,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);c=c?c.toUpperCase():"GET",this.D=o,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():La.g(),this.g.onreadystatechange=v(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(o),!0),this.B=!1}catch(A){nc(this,A);return}if(o=h||"",h=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var T in f)h.set(T,f[T]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const A of f.keys())h.set(A,f.get(A));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(h.keys()).find(A=>A.toLowerCase()=="content-type"),T=a.FormData&&o instanceof a.FormData,!(Array.prototype.indexOf.call(qf,c,void 0)>=0)||f||T||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[A,C]of h)this.g.setRequestHeader(A,C);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(o),this.v=!1}catch(A){nc(this,A)}};function nc(o,c){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=c,o.o=5,rc(o),jr(o)}function rc(o){o.A||(o.A=!0,be(o,"complete"),be(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=o||7,be(this,"complete"),be(this,"abort"),jr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),jr(this,!0)),re.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?sc(this):this.Xa())},n.Xa=function(){sc(this)};function sc(o){if(o.h&&typeof i<"u"){if(o.v&&pt(o)==4)setTimeout(o.Ca.bind(o),0);else if(be(o,"readystatechange"),pt(o)==4){o.h=!1;try{const A=o.ca();e:switch(A){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var h;if(!(h=c)){var f;if(f=A===0){let C=String(o.D).match(Ga)[1]||null;!C&&a.self&&a.self.location&&(C=a.self.location.protocol.slice(0,-1)),f=!$f.test(C?C.toLowerCase():"")}h=f}if(h)be(o,"complete"),be(o,"success");else{o.o=6;try{var T=pt(o)>2?o.g.statusText:""}catch{T=""}o.l=T+" ["+o.ca()+"]",rc(o)}}finally{jr(o)}}}}function jr(o,c){if(o.g){o.m&&(clearTimeout(o.m),o.m=null);const h=o.g;o.g=null,c||be(o,"ready");try{h.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function pt(o){return o.g?o.g.readyState:0}n.ca=function(){try{return pt(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(o){if(this.g){var c=this.g.responseText;return o&&c.indexOf(o)==0&&(c=c.substring(o.length)),Ef(c)}};function ic(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.F){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function jf(o){const c={};o=(o.g&&pt(o)>=2&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<o.length;f++){if(g(o[f]))continue;var h=Rf(o[f]);const T=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const A=c[T]||[];c[T]=A,A.push(h)}mf(c,function(f){return f.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Yn(o,c,h){return h&&h.internalChannelParams&&h.internalChannelParams[o]||c}function oc(o){this.za=0,this.i=[],this.j=new Bn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Yn("failFast",!1,o),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Yn("baseRetryDelayMs",5e3,o),this.Za=Yn("retryDelaySeedMs",1e4,o),this.Ta=Yn("forwardChannelMaxRetries",2,o),this.va=Yn("forwardChannelRequestTimeoutMs",2e4,o),this.ma=o&&o.xmlHttpFactory||void 0,this.Ua=o&&o.Rb||void 0,this.Aa=o&&o.useFetchStreams||!1,this.O=void 0,this.L=o&&o.supportsCrossDomainXhr||!1,this.M="",this.h=new qa(o&&o.concurrentRequestLimit),this.Ba=new Bf,this.S=o&&o.fastHandshake||!1,this.R=o&&o.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=o&&o.Pb||!1,o&&o.ua&&this.j.ua(),o&&o.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&o&&o.detectBufferingProxy||!1,this.ia=void 0,o&&o.longPollingTimeout&&o.longPollingTimeout>0&&(this.ia=o.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=oc.prototype,n.ka=8,n.I=1,n.connect=function(o,c,h,f){Ae(0),this.W=o,this.H=c||{},h&&f!==void 0&&(this.H.OSID=h,this.H.OAID=f),this.F=this.X,this.J=mc(this,null,this.W),Wr(this)};function Ci(o){if(ac(o),o.I==3){var c=o.V++,h=qe(o.J);if(Z(h,"SID",o.M),Z(h,"RID",c),Z(h,"TYPE","terminate"),Xn(o,h),c=new ht(o,o.j,c),c.M=2,c.A=$r(qe(h)),h=!1,a.navigator&&a.navigator.sendBeacon)try{h=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!h&&a.Image&&(new Image().src=c.A,h=!0),h||(c.g=gc(c.j,null),c.g.ea(c.A)),c.F=Date.now(),Br(c)}pc(o)}function zr(o){o.g&&(Di(o),o.g.cancel(),o.g=null)}function ac(o){zr(o),o.v&&(a.clearTimeout(o.v),o.v=null),Hr(o),o.h.cancel(),o.m&&(typeof o.m=="number"&&a.clearTimeout(o.m),o.m=null)}function Wr(o){if(!ja(o.h)&&!o.m){o.m=!0;var c=o.Ea;Re||m(),he||(Re(),he=!0),E.add(c,o),o.D=0}}function zf(o,c){return za(o.h)>=o.h.j-(o.m?1:0)?!1:o.m?(o.i=c.G.concat(o.i),!0):o.I==1||o.I==2||o.D>=(o.Sa?0:o.Ta)?!1:(o.m=Un(d(o.Ea,o,c),fc(o,o.D)),o.D++,!0)}n.Ea=function(o){if(this.m)if(this.m=null,this.I==1){if(!o){this.V=Math.floor(Math.random()*1e5),o=this.V++;const T=new ht(this,this.j,o);let A=this.o;if(this.U&&(A?(A=va(A),Ea(A,this.U)):A=this.U),this.u!==null||this.R||(T.J=A,A=null),this.S)e:{for(var c=0,h=0;h<this.i.length;h++){t:{var f=this.i[h];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break t}f=void 0}if(f===void 0)break;if(c+=f,c>4096){c=h;break e}if(c===4096||h===this.i.length-1){c=h+1;break e}}c=1e3}else c=1e3;c=lc(this,T,c),h=qe(this.J),Z(h,"RID",o),Z(h,"CVER",22),this.G&&Z(h,"X-HTTP-Session-Id",this.G),Xn(this,h),A&&(this.R?c="headers="+$n(tc(A))+"&"+c:this.u&&Pi(h,this.u,A)),Ai(this.h,T),this.Ra&&Z(h,"TYPE","init"),this.S?(Z(h,"$req",c),Z(h,"SID","null"),T.U=!0,Ei(T,h,null)):Ei(T,h,c),this.I=2}}else this.I==3&&(o?cc(this,o):this.i.length==0||ja(this.h)||cc(this))};function cc(o,c){var h;c?h=c.l:h=o.V++;const f=qe(o.J);Z(f,"SID",o.M),Z(f,"RID",h),Z(f,"AID",o.K),Xn(o,f),o.u&&o.o&&Pi(f,o.u,o.o),h=new ht(o,o.j,h,o.D+1),o.u===null&&(h.J=o.o),c&&(o.i=c.G.concat(o.i)),c=lc(o,h,1e3),h.H=Math.round(o.va*.5)+Math.round(o.va*.5*Math.random()),Ai(o.h,h),Ei(h,f,c)}function Xn(o,c){o.H&&Or(o.H,function(h,f){Z(c,f,h)}),o.l&&Or({},function(h,f){Z(c,f,h)})}function lc(o,c,h){h=Math.min(o.i.length,h);const f=o.l?d(o.l.Ka,o.l,o):null;e:{var T=o.i;let B=-1;for(;;){const le=["count="+h];B==-1?h>0?(B=T[0].g,le.push("ofs="+B)):B=0:le.push("ofs="+B);let Y=!0;for(let de=0;de<h;de++){var A=T[de].g;const je=T[de].map;if(A-=B,A<0)B=Math.max(0,T[de].g-100),Y=!1;else try{A="req"+A+"_"||"";try{var C=je instanceof Map?je:Object.entries(je);for(const[zt,mt]of C){let gt=mt;l(mt)&&(gt=gi(mt)),le.push(A+zt+"="+encodeURIComponent(gt))}}catch(zt){throw le.push(A+"type="+encodeURIComponent("_badmap")),zt}}catch{f&&f(je)}}if(Y){C=le.join("&");break e}}C=void 0}return o=o.i.splice(0,h),c.G=o,C}function uc(o){if(!o.g&&!o.v){o.Y=1;var c=o.Da;Re||m(),he||(Re(),he=!0),E.add(c,o),o.A=0}}function ki(o){return o.g||o.v||o.A>=3?!1:(o.Y++,o.v=Un(d(o.Da,o),fc(o,o.A)),o.A++,!0)}n.Da=function(){if(this.v=null,hc(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var o=4*this.T;this.j.info("BP detection timer enabled: "+o),this.B=Un(d(this.Wa,this),o)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Ae(10),zr(this),hc(this))};function Di(o){o.B!=null&&(a.clearTimeout(o.B),o.B=null)}function hc(o){o.g=new ht(o,o.j,"rpc",o.Y),o.u===null&&(o.g.J=o.o),o.g.P=0;var c=qe(o.na);Z(c,"RID","rpc"),Z(c,"SID",o.M),Z(c,"AID",o.K),Z(c,"CI",o.F?"0":"1"),!o.F&&o.ia&&Z(c,"TO",o.ia),Z(c,"TYPE","xmlhttp"),Xn(o,c),o.u&&o.o&&Pi(c,o.u,o.o),o.O&&(o.g.H=o.O);var h=o.g;o=o.ba,h.M=1,h.A=$r(qe(c)),h.u=null,h.R=!0,Ua(h,o)}n.Va=function(){this.C!=null&&(this.C=null,zr(this),ki(this),Ae(19))};function Hr(o){o.C!=null&&(a.clearTimeout(o.C),o.C=null)}function dc(o,c){var h=null;if(o.g==c){Hr(o),Di(o),o.g=null;var f=2}else if(bi(o.h,c))h=c.G,Wa(o.h,c),f=1;else return;if(o.I!=0){if(c.o)if(f==1){h=c.u?c.u.length:0,c=Date.now()-c.F;var T=o.D;f=Fr(),be(f,new Na(f,h)),Wr(o)}else uc(o);else if(T=c.m,T==3||T==0&&c.X>0||!(f==1&&zf(o,c)||f==2&&ki(o)))switch(h&&h.length>0&&(c=o.h,c.i=c.i.concat(h)),T){case 1:jt(o,5);break;case 4:jt(o,10);break;case 3:jt(o,6);break;default:jt(o,2)}}}function fc(o,c){let h=o.Qa+Math.floor(Math.random()*o.Za);return o.isActive()||(h*=2),h*c}function jt(o,c){if(o.j.info("Error code "+c),c==2){var h=d(o.bb,o),f=o.Ua;const T=!f;f=new dt(f||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||jn(f,"https"),$r(f),T?Ff(f.toString(),h):Uf(f.toString(),h)}else Ae(2);o.I=0,o.l&&o.l.pa(c),pc(o),ac(o)}n.bb=function(o){o?(this.j.info("Successfully pinged google.com"),Ae(2)):(this.j.info("Failed to ping google.com"),Ae(1))};function pc(o){if(o.I=0,o.ja=[],o.l){const c=Ha(o.h);(c.length!=0||o.i.length!=0)&&(k(o.ja,c),k(o.ja,o.i),o.h.i.length=0,S(o.i),o.i.length=0),o.l.oa()}}function mc(o,c,h){var f=h instanceof dt?qe(h):new dt(h);if(f.g!="")c&&(f.g=c+"."+f.g),zn(f,f.u);else{var T=a.location;f=T.protocol,c=c?c+"."+T.hostname:T.hostname,T=+T.port;const A=new dt(null);f&&jn(A,f),c&&(A.g=c),T&&zn(A,T),h&&(A.h=h),f=A}return h=o.G,c=o.wa,h&&c&&Z(f,h,c),Z(f,"VER",o.ka),Xn(o,f),f}function gc(o,c,h){if(c&&!o.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=o.Aa&&!o.ma?new re(new Ri({ab:h})):new re(o.ma),c.Fa(o.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function yc(){}n=yc.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Gr(){}Gr.prototype.g=function(o,c){return new De(o,c)};function De(o,c){ye.call(this),this.g=new oc(c),this.l=o,this.h=c&&c.messageUrlParams||null,o=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(o?o["X-WebChannel-Content-Type"]=c.messageContentType:o={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(o?o["X-WebChannel-Client-Profile"]=c.sa:o={"X-WebChannel-Client-Profile":c.sa}),this.g.U=o,(o=c&&c.Qb)&&!g(o)&&(this.g.u=o),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!g(c)&&(this.g.G=c,o=this.h,o!==null&&c in o&&(o=this.h,c in o&&delete o[c])),this.j=new an(this)}y(De,ye),De.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},De.prototype.close=function(){Ci(this.g)},De.prototype.o=function(o){var c=this.g;if(typeof o=="string"){var h={};h.__data__=o,o=h}else this.v&&(h={},h.__data__=gi(o),o=h);c.i.push(new kf(c.Ya++,o)),c.I==3&&Wr(c)},De.prototype.N=function(){this.g.l=null,delete this.j,Ci(this.g),delete this.g,De.Z.N.call(this)};function _c(o){yi.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var c=o.__sm__;if(c){e:{for(const h in c){o=h;break e}o=void 0}(this.i=o)&&(o=this.i,c=c!==null&&o in c?c[o]:void 0),this.data=c}else this.data=o}y(_c,yi);function vc(){_i.call(this),this.status=1}y(vc,_i);function an(o){this.g=o}y(an,yc),an.prototype.ra=function(){be(this.g,"a")},an.prototype.qa=function(o){be(this.g,new _c(o))},an.prototype.pa=function(o){be(this.g,new vc)},an.prototype.oa=function(){be(this.g,"b")},Gr.prototype.createWebChannel=Gr.prototype.g,De.prototype.send=De.prototype.o,De.prototype.open=De.prototype.m,De.prototype.close=De.prototype.close,ph=function(){return new Gr},fh=function(){return Fr()},dh=Bt,so={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Ur.NO_ERROR=0,Ur.TIMEOUT=8,Ur.HTTP_ERROR=6,is=Ur,Oa.COMPLETE="complete",hh=Oa,ka.EventType=Mn,Mn.OPEN="a",Mn.CLOSE="b",Mn.ERROR="c",Mn.MESSAGE="d",ye.prototype.listen=ye.prototype.J,er=ka,re.prototype.listenOnce=re.prototype.K,re.prototype.getLastError=re.prototype.Ha,re.prototype.getLastErrorCode=re.prototype.ya,re.prototype.getStatus=re.prototype.ca,re.prototype.getResponseJson=re.prototype.La,re.prototype.getResponseText=re.prototype.la,re.prototype.send=re.prototype.ea,re.prototype.setWithCredentials=re.prototype.Fa,uh=re}).apply(typeof Yr<"u"?Yr:typeof self<"u"?self:typeof window<"u"?window:{});const Xc="@firebase/firestore",Jc="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,mh(n,r,t)}function mh(n,e,t){let r=`FIRESTORE (${Cn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw ct(r),new Error(r)}function K(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||mh(e,s,r)}function U(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gh{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class yh{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(ve.UNAUTHENTICATED)))}shutdown(){}}class xy{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}}class Ny{constructor(e){this.t=e,this.currentUser=ve.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){K(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new st;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new st,e.enqueueRetryable((()=>s(this.currentUser)))};const a=()=>{const u=i;e.enqueueRetryable((async()=>{await u.promise,await s(this.currentUser)}))},l=u=>{x("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((u=>l(u))),setTimeout((()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(x("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new st)}}),0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((r=>this.i!==e?(x("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(K(typeof r.accessToken=="string",31837,{l:r}),new gh(r.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return K(e===null||typeof e=="string",2055,{h:e}),new ve(e)}}class Oy{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=ve.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const e=this.R();return e&&this.A.set("Authorization",e),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class Ly{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new Oy(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable((()=>t(ve.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class Zc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class My{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ve(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){K(this.o===void 0,3512);const r=i=>{i.error!=null&&x("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.m;return this.m=i.token,x("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable((()=>r(i)))};const s=i=>{x("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((i=>s(i))),setTimeout((()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):x("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new Zc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((t=>t?(K(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new Zc(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rl=-62135596800,sl=1e6;class J{static now(){return J.fromMillis(Date.now())}static fromDate(e){return J.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),r=Math.floor((e-1e3*t)*sl);return new J(t,r)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new V(R.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new V(R.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<rl)throw new V(R.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new V(R.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/sl}_compareTo(e){return this.seconds===e.seconds?q(this.nanoseconds,e.nanoseconds):q(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:J._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(br(e,J._jsonSchema))return new J(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-rl;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}J._jsonSchemaVersion="firestore/timestamp/1.0",J._jsonSchema={type:ae("string",J._jsonSchemaVersion),seconds:ae("number"),nanoseconds:ae("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dr=-1;function jy(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=F.fromTimestamp(r===1e9?new J(t+1,0):new J(t,r));return new Rt(s,O.empty(),e)}function zy(n){return new Rt(n.readTime,n.key,dr)}class Rt{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new Rt(F.min(),O.empty(),dr)}static max(){return new Rt(F.max(),O.empty(),dr)}}function Wy(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=O.comparator(n.documentKey,e.documentKey),t!==0?t:q(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hy="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class Gy{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach((e=>e()))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kn(n){if(n.code!==R.FAILED_PRECONDITION||n.message!==Hy)throw n;x("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mo=-1;function Bs(n){return n==null}function vs(n){return n===0&&1/n==-1/0}function Qy(n){return typeof n=="number"&&Number.isInteger(n)&&!vs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ol(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Lt(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Ih(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Th("Invalid base64 string: "+i):i}})(e);return new me(t)}static fromUint8Array(e){const t=(function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i})(e);return new me(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return q(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}me.EMPTY_BYTE_STRING=new me("");const Jy=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Pt(n){if(K(!!n,39018),typeof n=="string"){let e=0;const t=Jy.exec(n);if(K(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:se(n.seconds),nanos:se(n.nanos)}}function se(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Ct(n){return typeof n=="string"?me.fromBase64String(n):me.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bh="server_timestamp",Ah="__type__",Sh="__previous_value__",Rh="__local_write_time__";function Fo(n){return(n?.mapValue?.fields||{})[Ah]?.stringValue===bh}function $s(n){const e=n.mapValue.fields[Sh];return Fo(e)?$s(e):e}function fr(n){const e=Pt(n.mapValue.fields[Rh].timestampValue);return new J(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dh{}class oe extends Dh{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new i_(e,t,r):t==="array-contains"?new c_(e,r):t==="in"?new l_(e,r):t==="not-in"?new u_(e,r):t==="array-contains-any"?new h_(e,r):new oe(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new o_(e,r):new a_(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(En(t,this.value)):t!==null&&kt(this.value)===kt(t)&&this.matchesComparison(En(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return M(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class $e extends Dh{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new $e(e,t)}matches(e){return Vh(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Vh(n){return n.op==="and"}function xh(n){return s_(n)&&Vh(n)}function s_(n){for(const e of n.filters)if(e instanceof $e)return!1;return!0}function co(n){if(n instanceof oe)return n.field.canonicalString()+n.op.toString()+In(n.value);if(xh(n))return n.filters.map((e=>co(e))).join(",");{const e=n.filters.map((t=>co(t))).join(",");return`${n.op}(${e})`}}function Nh(n,e){return n instanceof oe?(function(r,s){return s instanceof oe&&r.op===s.op&&r.field.isEqual(s.field)&&Qe(r.value,s.value)})(n,e):n instanceof $e?(function(r,s){return s instanceof $e&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce(((i,a,l)=>i&&Nh(a,s.filters[l])),!0):!1})(n,e):void M(19439)}function Oh(n){return n instanceof oe?(function(t){return`${t.field.canonicalString()} ${t.op} ${In(t.value)}`})(n):n instanceof $e?(function(t){return t.op.toString()+" {"+t.getFilters().map(Oh).join(" ,")+"}"})(n):"Filter"}class i_ extends oe{constructor(e,t,r){super(e,t,r),this.key=O.fromName(r.referenceValue)}matches(e){const t=O.comparator(e.key,this.key);return this.matchesComparison(t)}}class o_ extends oe{constructor(e,t){super(e,"in",t),this.keys=Lh("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class a_ extends oe{constructor(e,t){super(e,"not-in",t),this.keys=Lh("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function Lh(n,e){return(e.arrayValue?.values||[]).map((t=>O.fromName(t.referenceValue)))}class c_ extends oe{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Uo(t)&&pr(t.arrayValue,this.value)}}class l_ extends oe{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&pr(this.value.arrayValue,t)}}class u_ extends oe{constructor(e,t){super(e,"not-in",t)}matches(e){if(pr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!pr(this.value.arrayValue,t)}}class h_ extends oe{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Uo(t)||!t.arrayValue.values)&&t.arrayValue.values.some((r=>pr(this.value.arrayValue,r)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d_{constructor(e,t=null,r=[],s=[],i=null,a=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=a,this.endAt=l,this.Te=null}}function ml(n,e=null,t=[],r=[],s=null,i=null,a=null){return new d_(n,e,t,r,s,i,a)}function Bo(n){const e=U(n);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((r=>co(r))).join(","),t+="|ob:",t+=e.orderBy.map((r=>(function(i){return i.field.canonicalString()+i.dir})(r))).join(","),Bs(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((r=>In(r))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((r=>In(r))).join(",")),e.Te=t}return e.Te}function $o(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!r_(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Nh(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!pl(n.startAt,e.startAt)&&pl(n.endAt,e.endAt)}function lo(n){return O.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y_=new ne(O.comparator);function lt(){return y_}const Bh=new ne(O.comparator);function tr(...n){let e=Bh;for(const t of n)e=e.insert(t.key,t);return e}function $h(n){let e=Bh;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Gt(){return ar()}function qh(){return ar()}function ar(){return new tn((n=>n.toString()),((n,e)=>n.isEqual(e)))}const __=new ne(O.comparator),v_=new ue(O.comparator);function j(...n){let e=v_;for(const t of n)e=e.add(t);return e}const w_=new ue(q);function E_(){return w_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vs(e)?"-0":e}}function jh(n){return{integerValue:""+n}}function I_(n,e){return Qy(e)?jh(e):qo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ws{constructor(){this._=void 0}}function T_(n,e,t){return n instanceof gr?(function(s,i){const a={fields:{[Ah]:{stringValue:bh},[Rh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Fo(i)&&(i=$s(i)),i&&(a.fields[Sh]=i),{mapValue:a}})(t,e):n instanceof Tn?Wh(n,e):n instanceof yr?Hh(n,e):(function(s,i){const a=zh(s,i),l=yl(a)+yl(s.Ae);return ao(a)&&ao(s.Ae)?jh(l):qo(s.serializer,l)})(n,e)}function b_(n,e,t){return n instanceof Tn?Wh(n,e):n instanceof yr?Hh(n,e):t}function zh(n,e){return n instanceof bs?(function(r){return ao(r)||(function(i){return!!i&&"doubleValue"in i})(r)})(e)?e:{integerValue:0}:null}class gr extends Ws{}class Tn extends Ws{constructor(e){super(),this.elements=e}}function Wh(n,e){const t=Gh(e);for(const r of n.elements)t.some((s=>Qe(s,r)))||t.push(r);return{arrayValue:{values:t}}}class yr extends Ws{constructor(e){super(),this.elements=e}}function Hh(n,e){let t=Gh(e);for(const r of n.elements)t=t.filter((s=>!Qe(s,r)));return{arrayValue:{values:t}}}class bs extends Ws{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function yl(n){return se(n.integerValue||n.doubleValue)}function Gh(n){return Uo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kh{constructor(e,t){this.field=e,this.transform=t}}function A_(n,e){return n.field.isEqual(e.field)&&(function(r,s){return r instanceof Tn&&s instanceof Tn||r instanceof yr&&s instanceof yr?vn(r.elements,s.elements,Qe):r instanceof bs&&s instanceof bs?Qe(r.Ae,s.Ae):r instanceof gr&&s instanceof gr})(n.transform,e.transform)}class S_{constructor(e,t){this.version=e,this.transformResults=t}}class Oe{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Oe}static exists(e){return new Oe(void 0,e)}static updateTime(e){return new Oe(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function cs(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Hs{}function Qh(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new jo(n.key,Oe.none()):new Ar(n.key,n.data,Oe.none());{const t=n.data,r=ke.empty();let s=new ue(pe.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new Mt(n.key,r,new Ne(s.toArray()),Oe.none())}}function R_(n,e,t){n instanceof Ar?(function(s,i,a){const l=s.value.clone(),u=vl(s.fieldTransforms,i,a.transformResults);l.setAll(u),i.convertToFoundDocument(a.version,l).setHasCommittedMutations()})(n,e,t):n instanceof Mt?(function(s,i,a){if(!cs(s.precondition,i))return void i.convertToUnknownDocument(a.version);const l=vl(s.fieldTransforms,i,a.transformResults),u=i.data;u.setAll(Yh(s)),u.setAll(l),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()})(n,e,t):(function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()})(0,e,t)}function cr(n,e,t,r){return n instanceof Ar?(function(i,a,l,u){if(!cs(i.precondition,a))return l;const d=i.value.clone(),p=wl(i.fieldTransforms,u,a);return d.setAll(p),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null})(n,e,t,r):n instanceof Mt?(function(i,a,l,u){if(!cs(i.precondition,a))return l;const d=wl(i.fieldTransforms,u,a),p=a.data;return p.setAll(Yh(i)),p.setAll(d),a.convertToFoundDocument(a.version,p).setHasLocalMutations(),l===null?null:l.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map((y=>y.field)))})(n,e,t,r):(function(i,a,l){return cs(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):l})(n,e,t)}function P_(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),i=zh(r.transform,s||null);i!=null&&(t===null&&(t=ke.empty()),t.set(r.field,i))}return t||null}function _l(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&vn(r,s,((i,a)=>A_(i,a)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Ar extends Hs{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Mt extends Hs{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Yh(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}})),e}function vl(n,e,t){const r=new Map;K(n.length===t.length,32656,{Re:t.length,Ve:n.length});for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,l=e.data.field(i.field);r.set(i.field,b_(a,l,t[s]))}return r}function wl(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,T_(i,a,e))}return r}class jo extends Hs{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class C_ extends Hs{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O_=new It([4294967295,4294967295],0);function El(n){const e=N_().encode(n),t=new lh;return t.update(e),new Uint8Array(t.digest())}function Il(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),s=e.getUint32(8,!0),i=e.getUint32(12,!0);return[new It([t,r],0),new It([s,i],0)]}class Wo{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new nr(`Invalid padding: ${t}`);if(r<0)throw new nr(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new nr(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new nr(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=It.fromNumber(this.ge)}ye(e,t,r){let s=e.add(t.multiply(It.fromNumber(r)));return s.compare(O_)===1&&(s=new It([s.getBits(0),s.getBits(1)],0)),s.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(this.ge===0)return!1;const t=El(e),[r,s]=Il(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(r,s,i);if(!this.we(a))return!1}return!0}static create(e,t,r){const s=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),a=new Wo(i,s,t);return r.forEach((l=>a.insert(l))),a}insert(e){if(this.ge===0)return;const t=El(e),[r,s]=Il(t);for(let i=0;i<this.hashCount;i++){const a=this.ye(r,s,i);this.Se(a)}}Se(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class nr extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Sr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Gs(F.min(),s,new ne(q),lt(),j())}}class Sr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Sr(r,t,j(),j(),j())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ls{constructor(e,t,r,s){this.be=e,this.removedTargetIds=t,this.key=r,this.De=s}}class Jh{constructor(e,t){this.targetId=e,this.Ce=t}}class Zh{constructor(e,t,r=me.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Tl{constructor(){this.ve=0,this.Fe=bl(),this.Me=me.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return this.ve!==0}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=j(),t=j(),r=j();return this.Fe.forEach(((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:M(38017,{changeType:i})}})),new Sr(this.Me,this.xe,e,t,r)}qe(){this.Oe=!1,this.Fe=bl()}Qe(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}$e(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}Ue(){this.ve+=1}Ke(){this.ve-=1,K(this.ve>=0,3241,{ve:this.ve})}We(){this.Oe=!0,this.xe=!0}}class L_{constructor(e){this.Ge=e,this.ze=new Map,this.je=lt(),this.Je=Zr(),this.He=Zr(),this.Ye=new ne(q)}Ze(e){for(const t of e.be)e.De&&e.De.isFoundDocument()?this.Xe(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,(t=>{const r=this.nt(t);switch(e.state){case 0:this.rt(t)&&r.Le(e.resumeToken);break;case 1:r.Ke(),r.Ne||r.qe(),r.Le(e.resumeToken);break;case 2:r.Ke(),r.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(r.We(),r.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),r.Le(e.resumeToken));break;default:M(56790,{state:e.state})}}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach(((r,s)=>{this.rt(s)&&t(s)}))}st(e){const t=e.targetId,r=e.Ce.count,s=this.ot(t);if(s){const i=s.target;if(lo(i))if(r===0){const a=new O(i.path);this.et(t,a,we.newNoDocument(a,F.min()))}else K(r===1,20013,{expectedCount:r});else{const a=this._t(t);if(a!==r){const l=this.ut(e),u=l?this.ct(l,e,a):1;if(u!==0){this.it(t);const d=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ye=this.Ye.insert(t,d)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let a,l;try{a=Ct(r).toUint8Array()}catch(u){if(u instanceof Th)return Xt("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{l=new Wo(a,s,i)}catch(u){return Xt(u instanceof nr?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return l.ge===0?null:l}ct(e,t,r){return t.Ce.count===r-this.Pt(e,t.targetId)?0:2}Pt(e,t){const r=this.Ge.getRemoteKeysForTarget(t);let s=0;return r.forEach((i=>{const a=this.Ge.ht(),l=`projects/${a.projectId}/databases/${a.database}/documents/${i.path.canonicalString()}`;e.mightContain(l)||(this.et(t,i,null),s++)})),s}Tt(e){const t=new Map;this.ze.forEach(((i,a)=>{const l=this.ot(a);if(l){if(i.current&&lo(l.target)){const u=new O(l.target.path);this.It(u).has(a)||this.Et(a,u)||this.et(a,u,we.newNoDocument(u,e))}i.Be&&(t.set(a,i.ke()),i.qe())}}));let r=j();this.He.forEach(((i,a)=>{let l=!0;a.forEachWhile((u=>{const d=this.ot(u);return!d||d.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)})),l&&(r=r.add(i))})),this.je.forEach(((i,a)=>a.setReadTime(e)));const s=new Gs(e,t,this.Ye,this.je,r);return this.je=lt(),this.Je=Zr(),this.He=Zr(),this.Ye=new ne(q),s}Xe(e,t){if(!this.rt(e))return;const r=this.Et(e,t.key)?2:0;this.nt(e).Qe(t.key,r),this.je=this.je.insert(t.key,t),this.Je=this.Je.insert(t.key,this.It(t.key).add(e)),this.He=this.He.insert(t.key,this.dt(t.key).add(e))}et(e,t,r){if(!this.rt(e))return;const s=this.nt(e);this.Et(e,t)?s.Qe(t,1):s.$e(t),this.He=this.He.insert(t,this.dt(t).delete(e)),this.He=this.He.insert(t,this.dt(t).add(e)),r&&(this.je=this.je.insert(t,r))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ue(e){this.nt(e).Ue()}nt(e){let t=this.ze.get(e);return t||(t=new Tl,this.ze.set(e,t)),t}dt(e){let t=this.He.get(e);return t||(t=new ue(q),this.He=this.He.insert(e,t)),t}It(e){let t=this.Je.get(e);return t||(t=new ue(q),this.Je=this.Je.insert(e,t)),t}rt(e){const t=this.ot(e)!==null;return t||x("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new Tl),this.Ge.getRemoteKeysForTarget(e).forEach((t=>{this.et(e,t,null)}))}Et(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function Zr(){return new ne(O.comparator)}function bl(){return new ne(O.comparator)}const M_={asc:"ASCENDING",desc:"DESCENDING"},F_={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},U_={and:"AND",or:"OR"};class B_{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function ho(n,e){return n.useProto3Json||Bs(e)?e:{value:e}}function As(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function ed(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function $_(n,e){return As(n,e.toTimestamp())}function Ke(n){return K(!!n,49232),F.fromTimestamp((function(t){const r=Pt(t);return new J(r.seconds,r.nanos)})(n))}function Ho(n,e){return fo(n,e).canonicalString()}function fo(n,e){const t=(function(s){return new X(["projects",s.projectId,"databases",s.database])})(n).child("documents");return e===void 0?t:t.child(e)}function td(n){const e=X.fromString(n);return K(od(e),10190,{key:e.toString()}),e}function po(n,e){return Ho(n.databaseId,e.path)}function qi(n,e){const t=td(e);if(t.get(1)!==n.databaseId.projectId)throw new V(R.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new V(R.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new O(rd(t))}function nd(n,e){return Ho(n.databaseId,e)}function q_(n){const e=td(n);return e.length===4?X.emptyPath():rd(e)}function mo(n){return new X(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function rd(n){return K(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function Al(n,e,t){return{name:po(n,e),fields:t.value.mapValue.fields}}function j_(n,e){let t;if("targetChange"in e){e.targetChange;const r=(function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:M(39313,{state:d})})(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=(function(d,p){return d.useProto3Json?(K(p===void 0||typeof p=="string",58123),me.fromBase64String(p||"")):(K(p===void 0||p instanceof Buffer||p instanceof Uint8Array,16193),me.fromUint8Array(p||new Uint8Array))})(n,e.targetChange.resumeToken),a=e.targetChange.cause,l=a&&(function(d){const p=d.code===void 0?R.UNKNOWN:Xh(d.code);return new V(p,d.message||"")})(a);t=new Zh(r,s,i,l||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=qi(n,r.document.name),i=Ke(r.document.updateTime),a=r.document.createTime?Ke(r.document.createTime):F.min(),l=new ke({mapValue:{fields:r.document.fields}}),u=we.newFoundDocument(s,i,a,l),d=r.targetIds||[],p=r.removedTargetIds||[];t=new ls(d,p,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=qi(n,r.document),i=r.readTime?Ke(r.readTime):F.min(),a=we.newNoDocument(s,i),l=r.removedTargetIds||[];t=new ls([],l,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=qi(n,r.document),i=r.removedTargetIds||[];t=new ls([],i,s,null)}else{if(!("filter"in e))return M(11601,{Rt:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,a=new V_(s,i),l=r.targetId;t=new Jh(l,a)}}return t}function z_(n,e){let t;if(e instanceof Ar)t={update:Al(n,e.key,e.value)};else if(e instanceof jo)t={delete:po(n,e.key)};else if(e instanceof Mt)t={update:Al(n,e.key,e.data),updateMask:Z_(e.fieldMask)};else{if(!(e instanceof C_))return M(16599,{Vt:e.type});t={verify:po(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map((r=>(function(i,a){const l=a.transform;if(l instanceof gr)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof Tn)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof yr)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof bs)return{fieldPath:a.field.canonicalString(),increment:l.Ae};throw M(20930,{transform:a.transform})})(0,r)))),e.precondition.isNone||(t.currentDocument=(function(s,i){return i.updateTime!==void 0?{updateTime:$_(s,i.updateTime)}:i.exists!==void 0?{exists:i.exists}:M(27497)})(n,e.precondition)),t}function W_(n,e){return n&&n.length>0?(K(e!==void 0,14353),n.map((t=>(function(s,i){let a=s.updateTime?Ke(s.updateTime):Ke(i);return a.isEqual(F.min())&&(a=Ke(i)),new S_(a,s.transformResults||[])})(t,e)))):[]}function H_(n,e){return{documents:[nd(n,e.path)]}}function G_(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=nd(n,s);const i=(function(d){if(d.length!==0)return id($e.create(d,"and"))})(e.filters);i&&(t.structuredQuery.where=i);const a=(function(d){if(d.length!==0)return d.map((p=>(function(v){return{field:un(v.field),direction:Y_(v.dir)}})(p)))})(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=ho(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=(function(d){return{before:d.inclusive,values:d.position}})(e.startAt)),e.endAt&&(t.structuredQuery.endAt=(function(d){return{before:!d.inclusive,values:d.position}})(e.endAt)),{ft:t,parent:s}}function K_(n){let e=q_(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){K(r===1,65062);const p=t.from[0];p.allDescendants?s=p.collectionId:e=e.child(p.collectionId)}let i=[];t.where&&(i=(function(y){const v=sd(y);return v instanceof $e&&xh(v)?v.getFilters():[v]})(t.where));let a=[];t.orderBy&&(a=(function(y){return y.map((v=>(function(k){return new mr(hn(k.field),(function(D){switch(D){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}})(k.direction))})(v)))})(t.orderBy));let l=null;t.limit&&(l=(function(y){let v;return v=typeof y=="object"?y.value:y,Bs(v)?null:v})(t.limit));let u=null;t.startAt&&(u=(function(y){const v=!!y.before,S=y.values||[];return new Is(S,v)})(t.startAt));let d=null;return t.endAt&&(d=(function(y){const v=!y.before,S=y.values||[];return new Is(S,v)})(t.endAt)),f_(e,s,a,i,l,"F",u,d)}function Q_(n,e){const t=(function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return M(28987,{purpose:s})}})(e.purpose);return t==null?null:{"goog-listen-tags":t}}function sd(n){return n.unaryFilter!==void 0?(function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=hn(t.unaryFilter.field);return oe.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=hn(t.unaryFilter.field);return oe.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=hn(t.unaryFilter.field);return oe.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=hn(t.unaryFilter.field);return oe.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return M(61313);default:return M(60726)}})(n):n.fieldFilter!==void 0?(function(t){return oe.create(hn(t.fieldFilter.field),(function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return M(58110);default:return M(50506)}})(t.fieldFilter.op),t.fieldFilter.value)})(n):n.compositeFilter!==void 0?(function(t){return $e.create(t.compositeFilter.filters.map((r=>sd(r))),(function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return M(1026)}})(t.compositeFilter.op))})(n):M(30097,{filter:n})}function Y_(n){return M_[n]}function X_(n){return F_[n]}function J_(n){return U_[n]}function un(n){return{fieldPath:n.canonicalString()}}function hn(n){return pe.fromServerFormat(n.fieldPath)}function id(n){return n instanceof oe?(function(t){if(t.op==="=="){if(dl(t.value))return{unaryFilter:{field:un(t.field),op:"IS_NAN"}};if(hl(t.value))return{unaryFilter:{field:un(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(dl(t.value))return{unaryFilter:{field:un(t.field),op:"IS_NOT_NAN"}};if(hl(t.value))return{unaryFilter:{field:un(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:un(t.field),op:X_(t.op),value:t.value}}})(n):n instanceof $e?(function(t){const r=t.getFilters().map((s=>id(s)));return r.length===1?r[0]:{compositeFilter:{op:J_(t.op),filters:r}}})(n):M(54877,{filter:n})}function Z_(n){const e=[];return n.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function od(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ev{constructor(e){this.yt=e}}function tv(n){const e=K_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Ts(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ev{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return dp()?8:Ky(Ie())>0?6:4})()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.ys(e,t).next((a=>{i.result=a})).next((()=>{if(!i.result)return this.ws(e,t,s,r).next((a=>{i.result=a}))})).next((()=>{if(i.result)return;const a=new wv;return this.Ss(e,t,a).next((l=>{if(i.result=l,this.Vs)return this.bs(e,t,a,l.size)}))})).next((()=>i.result))}bs(e,t,r,s){return r.documentReadCount<this.fs?(cn()<=$.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",ln(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),P.resolve()):(cn()<=$.DEBUG&&x("QueryEngine","Query:",ln(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(cn()<=$.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",ln(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Ge(t))):P.resolve())}ys(e,t){if(gl(t))return P.resolve(null);let r=Ge(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Ts(t,null,"F"),r=Ge(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const a=j(...i);return this.ps.getDocuments(e,a).next((l=>this.indexManager.getMinOffset(e,r).next((u=>{const d=this.Ds(t,l);return this.Cs(t,d,a,u.readTime)?this.ys(e,Ts(t,null,"F")):this.vs(e,d,t,u)}))))})))))}ws(e,t,r,s){return gl(t)||s.isEqual(F.min())?P.resolve(null):this.ps.getDocuments(e,r).next((i=>{const a=this.Ds(t,i);return this.Cs(t,a,r,s)?P.resolve(null):(cn()<=$.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),ln(t)),this.vs(e,a,t,jy(s,dr)).next((l=>l)))}))}Ds(e,t){let r=new ue(Uh(e));return t.forEach(((s,i)=>{zs(e,i)&&(r=r.add(i))})),r}Cs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ss(e,t,r){return cn()<=$.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",ln(t)),this.ps.getDocumentsMatchingQuery(e,t,Rt.min(),r)}vs(e,t,r,s){return this.ps.getDocumentsMatchingQuery(e,r,s).next((i=>(t.forEach((a=>{i=i.insert(a.key,a)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dl="ConnectivityMonitor";class Vl{constructor(){this.No=()=>this.Bo(),this.Lo=()=>this.ko(),this.qo=[],this.Qo()}Oo(e){this.qo.push(e)}shutdown(){window.removeEventListener("online",this.No),window.removeEventListener("offline",this.Lo)}Qo(){window.addEventListener("online",this.No),window.addEventListener("offline",this.Lo)}Bo(){x(Dl,"Network connectivity changed: AVAILABLE");for(const e of this.qo)e(0)}ko(){x(Dl,"Network connectivity changed: UNAVAILABLE");for(const e of this.qo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji="RestConnection",xv={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Nv{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${s}`,this.Wo=this.databaseId.database===ws?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Go(e,t,r,s,i){const a=yo(),l=this.zo(e,t.toUriEncodedString());x(ji,`Sending RPC '${e}' ${a}:`,l,r);const u={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(u,s,i);const{host:d}=new URL(l),p=Rn(d);return this.Jo(e,l,u,r,p).then((y=>(x(ji,`Received RPC '${e}' ${a}: `,y),y)),(y=>{throw Xt(ji,`RPC '${e}' ${a} failed with error: `,y,"url: ",l,"request:",r),y}))}Ho(e,t,r,s,i,a){return this.Go(e,t,r,s,i)}jo(e,t,r){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Cn})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,i)=>e[i]=s)),r&&r.headers.forEach(((s,i)=>e[i]=s))}zo(e,t){const r=xv[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection";class Lv extends Nv{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,s,i){const a=yo();return new Promise(((l,u)=>{const d=new uh;d.setWithCredentials(!0),d.listenOnce(hh.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case is.NO_ERROR:const y=d.getResponseJson();x(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),l(y);break;case is.TIMEOUT:x(_e,`RPC '${e}' ${a} timed out`),u(new V(R.DEADLINE_EXCEEDED,"Request time out"));break;case is.HTTP_ERROR:const v=d.getStatus();if(x(_e,`RPC '${e}' ${a} failed with status:`,v,"response text:",d.getResponseText()),v>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const k=S?.error;if(k&&k.status&&k.message){const N=(function(z){const H=z.toLowerCase().replace(/_/g,"-");return Object.values(R).indexOf(H)>=0?H:R.UNKNOWN})(k.status);u(new V(N,k.message))}else u(new V(R.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new V(R.UNAVAILABLE,"Connection failed."));break;default:M(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{x(_e,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);x(_e,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=yo(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ph(),l=fh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=i.join("");x(_e,`Creating RPC '${e}' stream ${s}: ${p}`,u);const y=a.createWebChannel(p,u);this.I_(y);let v=!1,S=!1;const k=new Ov({Yo:D=>{S?x(_e,`Not sending because RPC '${e}' stream ${s} is closed:`,D):(v||(x(_e,`Opening RPC '${e}' stream ${s} transport.`),y.open(),v=!0),x(_e,`RPC '${e}' stream ${s} sending:`,D),y.send(D))},Zo:()=>y.close()}),N=(D,z,H)=>{D.listen(z,(G=>{try{H(G)}catch(Te){setTimeout((()=>{throw Te}),0)}}))};return N(y,er.EventType.OPEN,(()=>{S||(x(_e,`RPC '${e}' stream ${s} transport opened.`),k.o_())})),N(y,er.EventType.CLOSE,(()=>{S||(S=!0,x(_e,`RPC '${e}' stream ${s} transport closed`),k.a_(),this.E_(y))})),N(y,er.EventType.ERROR,(D=>{S||(S=!0,Xt(_e,`RPC '${e}' stream ${s} transport errored. Name:`,D.name,"Message:",D.message),k.a_(new V(R.UNAVAILABLE,"The operation could not be completed")))})),N(y,er.EventType.MESSAGE,(D=>{if(!S){const z=D.data[0];K(!!z,16349);const H=z,G=H?.error||H[0]?.error;if(G){x(_e,`RPC '${e}' stream ${s} received error:`,G);const Te=G.status;let Re=(function(m){const _=ie[m];if(_!==void 0)return Xh(_)})(Te),he=G.message;Re===void 0&&(Re=R.INTERNAL,he="Unknown error status: "+Te+" with message "+G.message),S=!0,k.a_(new V(Re,he)),y.close()}else x(_e,`RPC '${e}' stream ${s} received:`,z),k.u_(z)}})),N(l,dh.STAT_EVENT,(D=>{D.stat===so.PROXY?x(_e,`RPC '${e}' stream ${s} detected buffering proxy`):D.stat===so.NOPROXY&&x(_e,`RPC '${e}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{k.__()}),0),k}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function zi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xl="PersistentStream";class dd{constructor(e,t,r,s,i,a,l,u){this.Mi=e,this.S_=r,this.b_=s,this.connection=i,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=l,this.listener=u,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new hd(e,t)}x_(){return this.state===1||this.state===5||this.O_()}O_(){return this.state===2||this.state===3}start(){this.F_=0,this.state!==4?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&this.C_===null&&(this.C_=this.Mi.enqueueAfterDelay(this.S_,6e4,(()=>this.k_())))}q_(e){this.Q_(),this.stream.send(e)}async k_(){if(this.O_())return this.close(0)}Q_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.Q_(),this.U_(),this.M_.cancel(),this.D_++,e!==4?this.M_.reset():t&&t.code===R.RESOURCE_EXHAUSTED?(ct(t.toString()),ct("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):t&&t.code===R.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.K_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.r_(t)}K_(){}auth(){this.state=1;const e=this.W_(this.D_),t=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([r,s])=>{this.D_===t&&this.G_(r,s)}),(r=>{e((()=>{const s=new V(R.UNKNOWN,"Fetching auth token failed: "+r.message);return this.z_(s)}))}))}G_(e,t){const r=this.W_(this.D_);this.stream=this.j_(e,t),this.stream.Xo((()=>{r((()=>this.listener.Xo()))})),this.stream.t_((()=>{r((()=>(this.state=2,this.v_=this.Mi.enqueueAfterDelay(this.b_,1e4,(()=>(this.O_()&&(this.state=3),Promise.resolve()))),this.listener.t_())))})),this.stream.r_((s=>{r((()=>this.z_(s)))})),this.stream.onMessage((s=>{r((()=>++this.F_==1?this.J_(s):this.onNext(s)))}))}N_(){this.state=5,this.M_.p_((async()=>{this.state=0,this.start()}))}z_(e){return x(xl,`close with error: ${e}`),this.stream=null,this.close(4,e)}W_(e){return t=>{this.Mi.enqueueAndForget((()=>this.D_===e?t():(x(xl,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Mv extends dd{constructor(e,t,r,s,i,a){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,s,a),this.serializer=i}j_(e,t){return this.connection.T_("Listen",e,t)}J_(e){return this.onNext(e)}onNext(e){this.M_.reset();const t=j_(this.serializer,e),r=(function(i){if(!("targetChange"in i))return F.min();const a=i.targetChange;return a.targetIds&&a.targetIds.length?F.min():a.readTime?Ke(a.readTime):F.min()})(e);return this.listener.H_(t,r)}Y_(e){const t={};t.database=mo(this.serializer),t.addTarget=(function(i,a){let l;const u=a.target;if(l=lo(u)?{documents:H_(i,u)}:{query:G_(i,u).ft},l.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){l.resumeToken=ed(i,a.resumeToken);const d=ho(i,a.expectedCount);d!==null&&(l.expectedCount=d)}else if(a.snapshotVersion.compareTo(F.min())>0){l.readTime=As(i,a.snapshotVersion.toTimestamp());const d=ho(i,a.expectedCount);d!==null&&(l.expectedCount=d)}return l})(this.serializer,e);const r=Q_(this.serializer,e);r&&(t.labels=r),this.q_(t)}Z_(e){const t={};t.database=mo(this.serializer),t.removeTarget=e,this.q_(t)}}class Fv extends dd{constructor(e,t,r,s,i,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,s,a),this.serializer=i}get X_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}K_(){this.X_&&this.ea([])}j_(e,t){return this.connection.T_("Write",e,t)}J_(e){return K(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,K(!e.writeResults||e.writeResults.length===0,55816),this.listener.ta()}onNext(e){K(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.M_.reset();const t=W_(e.writeResults,e.commitTime),r=Ke(e.commitTime);return this.listener.na(r,t)}ra(){const e={};e.database=mo(this.serializer),this.q_(e)}ea(e){const t={streamToken:this.lastStreamToken,writes:e.map((r=>z_(this.serializer,r)))};this.q_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="RemoteStore";class qv{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo((a=>{r.enqueueAndForget((async()=>{nn(this)&&(x(Jt,"Restarting streams for network reachability change."),await(async function(u){const d=U(u);d.Ea.add(4),await Rr(d),d.Ra.set("Unknown"),d.Ea.delete(4),await Qs(d)})(this))}))})),this.Ra=new $v(r,s)}}async function Qs(n){if(nn(n))for(const e of n.da)await e(!0)}async function Rr(n){for(const e of n.da)await e(!1)}function fd(n,e){const t=U(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),ea(t)?Zo(t):xn(t).O_()&&Jo(t,e))}function Xo(n,e){const t=U(n),r=xn(t);t.Ia.delete(e),r.O_()&&pd(t,e),t.Ia.size===0&&(r.O_()?r.L_():nn(t)&&t.Ra.set("Unknown"))}function Jo(n,e){if(n.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(F.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}xn(n).Y_(e)}function pd(n,e){n.Va.Ue(e),xn(n).Z_(e)}function Zo(n){n.Va=new L_({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),xn(n).start(),n.Ra.ua()}function ea(n){return nn(n)&&!xn(n).x_()&&n.Ia.size>0}function nn(n){return U(n).Ea.size===0}function md(n){n.Va=void 0}async function jv(n){n.Ra.set("Online")}async function zv(n){n.Ia.forEach(((e,t)=>{Jo(n,e)}))}async function Wv(n,e){md(n),ea(n)?(n.Ra.ha(e),Zo(n)):n.Ra.set("Unknown")}async function Hv(n,e,t){if(n.Ra.set("Online"),e instanceof Zh&&e.state===2&&e.cause)try{await(async function(s,i){const a=i.cause;for(const l of i.targetIds)s.Ia.has(l)&&(await s.remoteSyncer.rejectListen(l,a),s.Ia.delete(l),s.Va.removeTarget(l))})(n,e)}catch(r){x(Jt,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Rs(n,r)}else if(e instanceof ls?n.Va.Ze(e):e instanceof Jh?n.Va.st(e):n.Va.tt(e),!t.isEqual(F.min()))try{const r=await ud(n.localStore);t.compareTo(r)>=0&&await(function(i,a){const l=i.Va.Tt(a);return l.targetChanges.forEach(((u,d)=>{if(u.resumeToken.approximateByteSize()>0){const p=i.Ia.get(d);p&&i.Ia.set(d,p.withResumeToken(u.resumeToken,a))}})),l.targetMismatches.forEach(((u,d)=>{const p=i.Ia.get(u);if(!p)return;i.Ia.set(u,p.withResumeToken(me.EMPTY_BYTE_STRING,p.snapshotVersion)),pd(i,u);const y=new _t(p.target,u,d,p.sequenceNumber);Jo(i,y)})),i.remoteSyncer.applyRemoteEvent(l)})(n,t)}catch(r){x(Jt,"Failed to raise snapshot:",r),await Rs(n,r)}}async function Rs(n,e,t){if(!Dn(e))throw e;n.Ea.add(1),await Rr(n),n.Ra.set("Offline"),t||(t=()=>ud(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{x(Jt,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Qs(n)}))}function gd(n,e){return e().catch((t=>Rs(n,t,e)))}async function Ys(n){const e=U(n),t=Dt(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:Mo;for(;Gv(e);)try{const s=await Pv(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,Kv(e,s)}catch(s){await Rs(e,s)}yd(e)&&_d(e)}function Gv(n){return nn(n)&&n.Ta.length<10}function Kv(n,e){n.Ta.push(e);const t=Dt(n);t.O_()&&t.X_&&t.ea(e.mutations)}function yd(n){return nn(n)&&!Dt(n).x_()&&n.Ta.length>0}function _d(n){Dt(n).start()}async function Qv(n){Dt(n).ra()}async function Yv(n){const e=Dt(n);for(const t of n.Ta)e.ea(t.mutations)}async function Xv(n,e,t){const r=n.Ta.shift(),s=zo.from(r,e,t);await gd(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await Ys(n)}async function Jv(n,e){e&&Dt(n).X_&&await(async function(r,s){if((function(a){return x_(a)&&a!==R.ABORTED})(s.code)){const i=r.Ta.shift();Dt(r).B_(),await gd(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await Ys(r)}})(n,e),yd(n)&&_d(n)}async function Nl(n,e){const t=U(n);t.asyncQueue.verifyOperationInProgress(),x(Jt,"RemoteStore received new credentials");const r=nn(t);t.Ea.add(3),await Rr(t),r&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Qs(t)}async function Zv(n,e){const t=U(n);e?(t.Ea.delete(2),await Qs(t)):e||(t.Ea.add(2),await Rr(t),t.Ra.set("Unknown"))}function xn(n){return n.ma||(n.ma=(function(t,r,s){const i=U(t);return i.sa(),new Mv(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Xo:jv.bind(null,n),t_:zv.bind(null,n),r_:Wv.bind(null,n),H_:Hv.bind(null,n)}),n.da.push((async e=>{e?(n.ma.B_(),ea(n)?Zo(n):n.Ra.set("Unknown")):(await n.ma.stop(),md(n))}))),n.ma}function Dt(n){return n.fa||(n.fa=(function(t,r,s){const i=U(t);return i.sa(),new Fv(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:Qv.bind(null,n),r_:Jv.bind(null,n),ta:Yv.bind(null,n),na:Xv.bind(null,n)}),n.da.push((async e=>{e?(n.fa.B_(),await Ys(n)):(await n.fa.stop(),n.Ta.length>0&&(x(Jt,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vd{constructor(e){this.key=e}}class wd{constructor(e){this.key=e}}class sw{constructor(e,t){this.query=e,this.Ya=t,this.Za=null,this.hasCachedResults=!1,this.current=!1,this.Xa=j(),this.mutatedKeys=j(),this.eu=Uh(e),this.tu=new gn(this.eu)}get nu(){return this.Ya}ru(e,t){const r=t?t.iu:new Ol,s=t?t.tu:this.tu;let i=t?t.mutatedKeys:this.mutatedKeys,a=s,l=!1;const u=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,d=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal(((p,y)=>{const v=s.get(p),S=zs(this.query,y)?y:null,k=!!v&&this.mutatedKeys.has(v.key),N=!!S&&(S.hasLocalMutations||this.mutatedKeys.has(S.key)&&S.hasCommittedMutations);let D=!1;v&&S?v.data.isEqual(S.data)?k!==N&&(r.track({type:3,doc:S}),D=!0):this.su(v,S)||(r.track({type:2,doc:S}),D=!0,(u&&this.eu(S,u)>0||d&&this.eu(S,d)<0)&&(l=!0)):!v&&S?(r.track({type:0,doc:S}),D=!0):v&&!S&&(r.track({type:1,doc:v}),D=!0,(u||d)&&(l=!0)),D&&(S?(a=a.add(S),i=N?i.add(p):i.delete(p)):(a=a.delete(p),i=i.delete(p)))})),this.query.limit!==null)for(;a.size>this.query.limit;){const p=this.query.limitType==="F"?a.last():a.first();a=a.delete(p.key),i=i.delete(p.key),r.track({type:1,doc:p})}return{tu:a,iu:r,Cs:l,mutatedKeys:i}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const a=e.iu.ya();a.sort(((p,y)=>(function(S,k){const N=D=>{switch(D){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return M(20277,{Rt:D})}};return N(S)-N(k)})(p.type,y.type)||this.eu(p.doc,y.doc))),this.ou(r),s=s??!1;const l=t&&!s?this._u():[],u=this.Xa.size===0&&this.current&&!s?1:0,d=u!==this.Za;return this.Za=u,a.length!==0||d?{snapshot:new An(this.query,e.tu,i,a,e.mutatedKeys,u===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),au:l}:{au:l}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({tu:this.tu,iu:new Ol,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{au:[]}}uu(e){return!this.Ya.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach((t=>this.Ya=this.Ya.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Ya=this.Ya.delete(t))),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Xa;this.Xa=j(),this.tu.forEach((r=>{this.uu(r.key)&&(this.Xa=this.Xa.add(r.key))}));const t=[];return e.forEach((r=>{this.Xa.has(r)||t.push(new wd(r))})),this.Xa.forEach((r=>{e.has(r)||t.push(new vd(r))})),t}cu(e){this.Ya=e.Qs,this.Xa=j();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return An.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,this.Za===0,this.hasCachedResults)}}const aa="SyncEngine";class iw{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class ow{constructor(e){this.key=e,this.hu=!1}}class aw{constructor(e,t,r,s,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new tn((l=>Fh(l)),js),this.Iu=new Map,this.Eu=new Set,this.du=new ne(O.comparator),this.Au=new Map,this.Ru=new Go,this.Vu={},this.mu=new Map,this.fu=bn.cr(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return this.gu===!0}}async function cw(n,e,t=!0){const r=Sd(n);let s;const i=r.Tu.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.lu()):s=await Ed(r,e,t,!0),s}async function lw(n,e){const t=Sd(n);await Ed(t,e,!0,!1)}async function Ed(n,e,t,r){const s=await Cv(n.localStore,Ge(e)),i=s.targetId,a=n.sharedClientState.addLocalQueryTarget(i,t);let l;return r&&(l=await uw(n,e,i,a==="current",s.resumeToken)),n.isPrimaryClient&&t&&fd(n.remoteStore,s),l}async function uw(n,e,t,r,s){n.pu=(y,v,S)=>(async function(N,D,z,H){let G=D.view.ru(z);G.Cs&&(G=await Cl(N.localStore,D.query,!1).then((({documents:E})=>D.view.ru(E,G))));const Te=H&&H.targetChanges.get(D.targetId),Re=H&&H.targetMismatches.get(D.targetId)!=null,he=D.view.applyChanges(G,N.isPrimaryClient,Te,Re);return Ul(N,D.targetId,he.au),he.snapshot})(n,y,v,S);const i=await Cl(n.localStore,e,!0),a=new sw(e,i.Qs),l=a.ru(i.documents),u=Sr.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),d=a.applyChanges(l,n.isPrimaryClient,u);Ul(n,t,d.au);const p=new iw(e,t,a);return n.Tu.set(e,p),n.Iu.has(t)?n.Iu.get(t).push(e):n.Iu.set(t,[e]),d.snapshot}async function hw(n,e,t){const r=U(n),s=r.Tu.get(e),i=r.Iu.get(s.targetId);if(i.length>1)return r.Iu.set(s.targetId,i.filter((a=>!js(a,e)))),void r.Tu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await go(r.localStore,s.targetId,!1).then((()=>{r.sharedClientState.clearQueryState(s.targetId),t&&Xo(r.remoteStore,s.targetId),vo(r,s.targetId)})).catch(kn)):(vo(r,s.targetId),await go(r.localStore,s.targetId,!0))}async function dw(n,e){const t=U(n),r=t.Tu.get(e),s=t.Iu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Xo(t.remoteStore,r.targetId))}async function fw(n,e,t){const r=ww(n);try{const s=await(function(a,l){const u=U(a),d=J.now(),p=l.reduce(((S,k)=>S.add(k.key)),j());let y,v;return u.persistence.runTransaction("Locally write mutations","readwrite",(S=>{let k=lt(),N=j();return u.Ns.getEntries(S,p).next((D=>{k=D,k.forEach(((z,H)=>{H.isValidDocument()||(N=N.add(z))}))})).next((()=>u.localDocuments.getOverlayedDocuments(S,k))).next((D=>{y=D;const z=[];for(const H of l){const G=P_(H,y.get(H.key).overlayedDocument);G!=null&&z.push(new Mt(H.key,G,kh(G.value.mapValue),Oe.exists(!0)))}return u.mutationQueue.addMutationBatch(S,d,z,l)})).next((D=>{v=D;const z=D.applyToLocalDocumentSet(y,N);return u.documentOverlayCache.saveOverlays(S,D.batchId,z)}))})).then((()=>({batchId:v.batchId,changes:$h(y)})))})(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),(function(a,l,u){let d=a.Vu[a.currentUser.toKey()];d||(d=new ne(q)),d=d.insert(l,u),a.Vu[a.currentUser.toKey()]=d})(r,s.batchId,t),await Pr(r,s.changes),await Ys(r.remoteStore)}catch(s){const i=na(s,"Failed to persist write");t.reject(i)}}async function Id(n,e){const t=U(n);try{const r=await Sv(t.localStore,e);e.targetChanges.forEach(((s,i)=>{const a=t.Au.get(i);a&&(K(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?a.hu=!0:s.modifiedDocuments.size>0?K(a.hu,14607):s.removedDocuments.size>0&&(K(a.hu,42227),a.hu=!1))})),await Pr(t,r,e)}catch(r){await kn(r)}}function Fl(n,e,t){const r=U(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.Tu.forEach(((i,a)=>{const l=a.view.va(e);l.snapshot&&s.push(l.snapshot)})),(function(a,l){const u=U(a);u.onlineState=l;let d=!1;u.queries.forEach(((p,y)=>{for(const v of y.Sa)v.va(l)&&(d=!0)})),d&&ia(u)})(r.eventManager,e),s.length&&r.Pu.H_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function pw(n,e,t){const r=U(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Au.get(e),i=s&&s.key;if(i){let a=new ne(O.comparator);a=a.insert(i,we.newNoDocument(i,F.min()));const l=j().add(i),u=new Gs(F.min(),new Map,new ne(q),a,l);await Id(r,u),r.du=r.du.remove(i),r.Au.delete(e),ca(r)}else await go(r.localStore,e,!1).then((()=>vo(r,e,t))).catch(kn)}async function mw(n,e){const t=U(n),r=e.batch.batchId;try{const s=await Av(t.localStore,e);bd(t,r,null),Td(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Pr(t,s)}catch(s){await kn(s)}}async function gw(n,e,t){const r=U(n);try{const s=await(function(a,l){const u=U(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",(d=>{let p;return u.mutationQueue.lookupMutationBatch(d,l).next((y=>(K(y!==null,37113),p=y.keys(),u.mutationQueue.removeMutationBatch(d,y)))).next((()=>u.mutationQueue.performConsistencyCheck(d))).next((()=>u.documentOverlayCache.removeOverlaysForBatchId(d,p,l))).next((()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,p))).next((()=>u.localDocuments.getDocuments(d,p)))}))})(r.localStore,e);bd(r,e,t),Td(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Pr(r,s)}catch(s){await kn(s)}}function Td(n,e){(n.mu.get(e)||[]).forEach((t=>{t.resolve()})),n.mu.delete(e)}function bd(n,e,t){const r=U(n);let s=r.Vu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.Vu[r.currentUser.toKey()]=s}}function vo(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Iu.get(e))n.Tu.delete(r),t&&n.Pu.yu(r,t);n.Iu.delete(e),n.isPrimaryClient&&n.Ru.jr(e).forEach((r=>{n.Ru.containsKey(r)||Ad(n,r)}))}function Ad(n,e){n.Eu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(Xo(n.remoteStore,t),n.du=n.du.remove(e),n.Au.delete(t),ca(n))}function Ul(n,e,t){for(const r of t)r instanceof vd?(n.Ru.addReference(r.key,e),yw(n,r)):r instanceof wd?(x(aa,"Document no longer in limbo: "+r.key),n.Ru.removeReference(r.key,e),n.Ru.containsKey(r.key)||Ad(n,r.key)):M(19791,{wu:r})}function yw(n,e){const t=e.key,r=t.path.canonicalString();n.du.get(t)||n.Eu.has(r)||(x(aa,"New document in limbo: "+t),n.Eu.add(r),ca(n))}function ca(n){for(;n.Eu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Eu.values().next().value;n.Eu.delete(e);const t=new O(X.fromString(e)),r=n.fu.next();n.Au.set(r,new ow(t)),n.du=n.du.insert(t,r),fd(n.remoteStore,new _t(Ge(qs(t.path)),r,"TargetPurposeLimboResolution",Us.ce))}}async function Pr(n,e,t){const r=U(n),s=[],i=[],a=[];r.Tu.isEmpty()||(r.Tu.forEach(((l,u)=>{a.push(r.pu(u,e,t).then((d=>{if((d||t)&&r.isPrimaryClient){const p=d?!d.fromCache:t?.targetChanges.get(u.targetId)?.current;r.sharedClientState.updateQueryState(u.targetId,p?"current":"not-current")}if(d){s.push(d);const p=Qo.As(u.targetId,d);i.push(p)}})))})),await Promise.all(a),r.Pu.H_(s),await(async function(u,d){const p=U(u);try{await p.persistence.runTransaction("notifyLocalViewChanges","readwrite",(y=>P.forEach(d,(v=>P.forEach(v.Es,(S=>p.persistence.referenceDelegate.addReference(y,v.targetId,S))).next((()=>P.forEach(v.ds,(S=>p.persistence.referenceDelegate.removeReference(y,v.targetId,S)))))))))}catch(y){if(!Dn(y))throw y;x(Yo,"Failed to update sequence numbers: "+y)}for(const y of d){const v=y.targetId;if(!y.fromCache){const S=p.Ms.get(v),k=S.snapshotVersion,N=S.withLastLimboFreeSnapshotVersion(k);p.Ms=p.Ms.insert(v,N)}}})(r.localStore,i))}async function _w(n,e){const t=U(n);if(!t.currentUser.isEqual(e)){x(aa,"User change. New user:",e.toKey());const r=await ld(t.localStore,e);t.currentUser=e,(function(i,a){i.mu.forEach((l=>{l.forEach((u=>{u.reject(new V(R.CANCELLED,a))}))})),i.mu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Pr(t,r.Ls)}}function vw(n,e){const t=U(n),r=t.Au.get(e);if(r&&r.hu)return j().add(r.key);{let s=j();const i=t.Iu.get(e);if(!i)return s;for(const a of i){const l=t.Tu.get(a);s=s.unionWith(l.view.nu)}return s}}function Sd(n){const e=U(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=Id.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=vw.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=pw.bind(null,e),e.Pu.H_=nw.bind(null,e.eventManager),e.Pu.yu=rw.bind(null,e.eventManager),e}function ww(n){const e=U(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=mw.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=gw.bind(null,e),e}class Ps{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Ks(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return bv(this.persistence,new Ev,e.initialUser,this.serializer)}Cu(e){return new cd(Ko.mi,this.serializer)}Du(e){return new Dv}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Ps.provider={build:()=>new Ps};class Ew extends Ps{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){K(this.persistence.referenceDelegate instanceof Ss,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new ov(r,e.asyncQueue,t)}Cu(e){const t=this.cacheSizeBytes!==void 0?Ce.withCacheSize(this.cacheSizeBytes):Ce.DEFAULT;return new cd((r=>Ss.mi(r,t)),this.serializer)}}class wo{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Fl(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=_w.bind(null,this.syncEngine),await Zv(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new tw})()}createDatastore(e){const t=Ks(e.databaseInfo.databaseId),r=(function(i){return new Lv(i)})(e.databaseInfo);return(function(i,a,l,u){return new Bv(i,a,l,u)})(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return(function(r,s,i,a,l){return new qv(r,s,i,a,l)})(this.localStore,this.datastore,e.asyncQueue,(t=>Fl(this.syncEngine,t,0)),(function(){return Vl.v()?new Vl:new Vv})())}createSyncEngine(e,t){return(function(s,i,a,l,u,d,p){const y=new aw(s,i,a,l,u,d);return p&&(y.gu=!0),y})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){await(async function(t){const r=U(t);x(Jt,"RemoteStore shutting down."),r.Ea.add(5),await Rr(r),r.Aa.shutdown(),r.Ra.set("Unknown")})(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}wo.provider={build:()=>new wo};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vt="FirestoreClient";class Iw{constructor(e,t,r,s,i){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=r,this.databaseInfo=s,this.user=ve.UNAUTHENTICATED,this.clientId=Ms.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=i,this.authCredentials.start(r,(async a=>{x(Vt,"Received user=",a.uid),await this.authCredentialListener(a),this.user=a})),this.appCheckCredentials.start(r,(a=>(x(Vt,"Received new app check token=",a),this.appCheckCredentialListener(a,this.user))))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new st;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const r=na(t,"Failed to shutdown persistence");e.reject(r)}})),e.promise}}async function Wi(n,e){n.asyncQueue.verifyOperationInProgress(),x(Vt,"Initializing OfflineComponentProvider");const t=n.configuration;await e.initialize(t);let r=t.initialUser;n.setCredentialChangeListener((async s=>{r.isEqual(s)||(await ld(e.localStore,s),r=s)})),e.persistence.setDatabaseDeletedListener((()=>n.terminate())),n._offlineComponents=e}async function Bl(n,e){n.asyncQueue.verifyOperationInProgress();const t=await Tw(n);x(Vt,"Initializing OnlineComponentProvider"),await e.initialize(t,n.configuration),n.setCredentialChangeListener((r=>Nl(e.remoteStore,r))),n.setAppCheckTokenChangeListener(((r,s)=>Nl(e.remoteStore,s))),n._onlineComponents=e}async function Tw(n){if(!n._offlineComponents)if(n._uninitializedComponentsProvider){x(Vt,"Using user provided OfflineComponentProvider");try{await Wi(n,n._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!(function(s){return s.name==="FirebaseError"?s.code===R.FAILED_PRECONDITION||s.code===R.UNIMPLEMENTED:!(typeof DOMException<"u"&&s instanceof DOMException)||s.code===22||s.code===20||s.code===11})(t))throw t;Xt("Error using user provided cache. Falling back to memory cache: "+t),await Wi(n,new Ps)}}else x(Vt,"Using default OfflineComponentProvider"),await Wi(n,new Ew(void 0));return n._offlineComponents}async function Rd(n){return n._onlineComponents||(n._uninitializedComponentsProvider?(x(Vt,"Using user provided OnlineComponentProvider"),await Bl(n,n._uninitializedComponentsProvider._online)):(x(Vt,"Using default OnlineComponentProvider"),await Bl(n,new wo))),n._onlineComponents}function bw(n){return Rd(n).then((e=>e.syncEngine))}async function Cs(n){const e=await Rd(n),t=e.eventManager;return t.onListen=cw.bind(null,e.syncEngine),t.onUnlisten=hw.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=lw.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=dw.bind(null,e.syncEngine),t}function Aw(n,e,t={}){const r=new st;return n.asyncQueue.enqueueAndForget((async()=>(function(i,a,l,u,d){const p=new la({next:v=>{p.Nu(),a.enqueueAndForget((()=>sa(i,y)));const S=v.docs.has(l);!S&&v.fromCache?d.reject(new V(R.UNAVAILABLE,"Failed to get document because the client is offline.")):S&&v.fromCache&&u&&u.source==="server"?d.reject(new V(R.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):d.resolve(v)},error:v=>d.reject(v)}),y=new oa(qs(l.path),p,{includeMetadataChanges:!0,qa:!0});return ra(i,y)})(await Cs(n),n.asyncQueue,e,t,r))),r.promise}function Sw(n,e,t={}){const r=new st;return n.asyncQueue.enqueueAndForget((async()=>(function(i,a,l,u,d){const p=new la({next:v=>{p.Nu(),a.enqueueAndForget((()=>sa(i,y))),v.fromCache&&u.source==="server"?d.reject(new V(R.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):d.resolve(v)},error:v=>d.reject(v)}),y=new oa(l,p,{includeMetadataChanges:!0,qa:!0});return ra(i,y)})(await Cs(n),n.asyncQueue,e,t,r))),r.promise}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cd="firestore.googleapis.com",ql=!0;class jl{constructor(e){if(e.host===void 0){if(e.ssl!==void 0)throw new V(R.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host=Cd,this.ssl=ql}else this.host=e.host,this.ssl=e.ssl??ql;if(this.isUsingEmulator=e.emulatorOptions!==void 0,this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=ad;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<sv)throw new V(R.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}vh("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=Pd(e.experimentalLongPollingOptions??{}),(function(r){if(r.timeoutSeconds!==void 0){if(isNaN(r.timeoutSeconds))throw new V(R.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (must not be NaN)`);if(r.timeoutSeconds<5)throw new V(R.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (minimum allowed value is 5)`);if(r.timeoutSeconds>30)throw new V(R.INVALID_ARGUMENT,`invalid long polling timeout: ${r.timeoutSeconds} (maximum allowed value is 30)`)}})(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&(function(r,s){return r.timeoutSeconds===s.timeoutSeconds})(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Xs{constructor(e,t,r,s){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=r,this._app=s,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new jl({}),this._settingsFrozen=!1,this._emulatorOptions={},this._terminateTask="notTerminated"}get app(){if(!this._app)throw new V(R.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new V(R.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new jl(e),this._emulatorOptions=e.emulatorOptions||{},e.credentials!==void 0&&(this._authCredentials=(function(r){if(!r)return new yh;switch(r.type){case"firstParty":return new Ly(r.sessionIndex||"0",r.iamToken||null,r.authTokenFactory||null);case"provider":return r.client;default:throw new V(R.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}})(e.credentials))}_getSettings(){return this._settings}_getEmulatorOptions(){return this._emulatorOptions}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return(function(t){const r=$l.get(t);r&&(x("ComponentProvider","Removing Datastore"),$l.delete(t),r.terminate())})(this),Promise.resolve()}}function kd(n,e,t,r={}){n=Se(n,Xs);const s=Rn(e),i=n._getSettings(),a={...i,emulatorOptions:n._getEmulatorOptions()},l=`${e}:${t}`;s&&(ou(`https://${l}`),au("Firestore",!0)),i.host!==Cd&&i.host!==l&&Xt("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");const u={...i,host:l,ssl:s,emulatorOptions:r};if(!At(u,a)&&(n._setSettings(u),r.mockUserToken)){let d,p;if(typeof r.mockUserToken=="string")d=r.mockUserToken,p=ve.MOCK_USER;else{d=rp(r.mockUserToken,n._app?.options.projectId);const y=r.mockUserToken.sub||r.mockUserToken.user_id;if(!y)throw new V(R.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");p=new ve(y)}n._authCredentials=new xy(new gh(d,p))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl="AsyncQueue";class Wl{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new hd(this,"async_queue_retry"),this._c=()=>{const r=zi();r&&x(zl,"Visibility state changed to "+r.visibilityState),this.M_.w_()},this.ac=e;const t=zi();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const t=zi();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const t=new st;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!Dn(e))throw e;x(zl,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const t=this.ac.then((()=>(this.rc=!0,e().catch((r=>{throw this.nc=r,this.rc=!1,ct("INTERNAL UNHANDLED ERROR: ",Hl(r)),r})).then((r=>(this.rc=!1,r))))));return this.ac=t,t}enqueueAfterDelay(e,t,r){this.uc(),this.oc.indexOf(e)>-1&&(t=0);const s=ta.createAndSchedule(this,e,t,r,(i=>this.hc(i)));return this.tc.push(s),s}uc(){this.nc&&M(47125,{Pc:Hl(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const t of this.tc)if(t.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((t,r)=>t.targetTimeMs-r.targetTimeMs));for(const t of this.tc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const t=this.tc.indexOf(e);this.tc.splice(t,1)}}function Hl(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
`+n.stack),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gl(n){return(function(t,r){if(typeof t!="object"||t===null)return!1;const s=t;for(const i of r)if(i in s&&typeof s[i]=="function")return!0;return!1})(n,["next","error","complete"])}class Ye extends Xs{constructor(e,t,r,s){super(e,t,r,s),this.type="firestore",this._queue=new Wl,this._persistenceKey=s?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Wl(e),this._firestoreClient=void 0,await e}}}function Dd(n,e){const t=typeof n=="object"?n:hu(),r=typeof n=="string"?n:ws,s=So(t,"firestore").getImmediate({identifier:r});if(!s._initialized){const i=tp("firestore");i&&kd(s,...i)}return s}function Cr(n){if(n._terminated)throw new V(R.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||Rw(n),n._firestoreClient}function Rw(n){const e=n._freezeSettings(),t=(function(s,i,a,l){return new Zy(s,i,a,l.host,l.ssl,l.experimentalForceLongPolling,l.experimentalAutoDetectLongPolling,Pd(l.experimentalLongPollingOptions),l.useFetchStreams,l.isUsingEmulator)})(n._databaseId,n._app?.options.appId||"",n._persistenceKey,e);n._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(n._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),n._firestoreClient=new Iw(n._authCredentials,n._appCheckCredentials,n._queue,t,n._componentsProvider&&(function(s){const i=s?._online.build();return{_offline:s?._offline.build(i),_online:i}})(n._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(e){this._byteString=e}static fromBase64String(e){try{return new xe(me.fromBase64String(e))}catch(t){throw new V(R.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new xe(me.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:xe._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(br(e,xe._jsonSchema))return xe.fromBase64String(e.bytes)}}xe._jsonSchemaVersion="firestore/bytes/1.0",xe._jsonSchema={type:ae("string",xe._jsonSchemaVersion),bytes:ae("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pw=/^__.*__$/;class Cw{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Mt(e,this.data,this.fieldMask,t,this.fieldTransforms):new Ar(e,this.data,t,this.fieldTransforms)}}class Vd{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Mt(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function xd(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw M(40011,{Ac:n})}}class Js{constructor(e,t,r,s,i,a){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,i===void 0&&this.Rc(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new Js({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){const t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.gc(e),r}yc(e){const t=this.path?.child(e),r=this.Vc({path:t,fc:!1});return r.Rc(),r}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return ks(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(xd(this.Ac)&&Pw.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class kw{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Ks(e)}Cc(e,t,r,s=!1){return new Js({Ac:e,methodName:t,Dc:r,path:pe.emptyPath(),fc:!1,bc:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Zs(n){const e=n._freezeSettings(),t=Ks(n._databaseId);return new kw(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Nd(n,e,t,r,s,i={}){const a=n.Cc(i.merge||i.mergeFields?2:0,e,t,s);da("Data must be an object, but it was:",a,r);const l=Od(r,a);let u,d;if(i.merge)u=new Ne(a.fieldMask),d=a.fieldTransforms;else if(i.mergeFields){const p=[];for(const y of i.mergeFields){const v=Eo(e,y,t);if(!a.contains(v))throw new V(R.INVALID_ARGUMENT,`Field '${v}' is specified in your field mask but missing from your input data.`);Md(p,v)||p.push(v)}u=new Ne(p),d=a.fieldTransforms.filter((y=>u.covers(y.field)))}else u=null,d=a.fieldTransforms;return new Cw(new ke(l),u,d)}class ei extends Nn{_toFieldTransform(e){if(e.Ac!==2)throw e.Ac===1?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ei}}function Dw(n,e,t){return new Js({Ac:3,Dc:e.settings.Dc,methodName:n._methodName,fc:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class ua extends Nn{_toFieldTransform(e){return new Kh(e.path,new gr)}isEqual(e){return e instanceof ua}}class ha extends Nn{constructor(e,t){super(e),this.vc=t}_toFieldTransform(e){const t=Dw(this,e,!0),r=this.vc.map((i=>On(i,t))),s=new Tn(r);return new Kh(e.path,s)}isEqual(e){return e instanceof ha&&At(this.vc,e.vc)}}function Vw(n,e,t,r){const s=n.Cc(1,e,t);da("Data must be an object, but it was:",s,r);const i=[],a=ke.empty();Lt(r,((u,d)=>{const p=fa(e,u,t);d=ce(d);const y=s.yc(p);if(d instanceof ei)i.push(p);else{const v=On(d,y);v!=null&&(i.push(p),a.set(p,v))}}));const l=new Ne(i);return new Vd(a,l,s.fieldTransforms)}function xw(n,e,t,r,s,i){const a=n.Cc(1,e,t),l=[Eo(e,r,t)],u=[s];if(i.length%2!=0)throw new V(R.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let v=0;v<i.length;v+=2)l.push(Eo(e,i[v])),u.push(i[v+1]);const d=[],p=ke.empty();for(let v=l.length-1;v>=0;--v)if(!Md(d,l[v])){const S=l[v];let k=u[v];k=ce(k);const N=a.yc(S);if(k instanceof ei)d.push(S);else{const D=On(k,N);D!=null&&(d.push(S),p.set(S,D))}}const y=new Ne(d);return new Vd(p,y,a.fieldTransforms)}function Nw(n,e,t,r=!1){return On(t,n.Cc(r?4:3,e))}function On(n,e){if(Ld(n=ce(n)))return da("Unsupported field value:",e,n),Od(n,e);if(n instanceof Nn)return(function(r,s){if(!xd(s.Ac))throw s.Sc(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Sc(`${r._methodName}() is not currently supported inside arrays`);const i=r._toFieldTransform(s);i&&s.fieldTransforms.push(i)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return(function(r,s){const i=[];let a=0;for(const l of r){let u=On(l,s.wc(a));u==null&&(u={nullValue:"NULL_VALUE"}),i.push(u),a++}return{arrayValue:{values:i}}})(n,e)}return(function(r,s){if((r=ce(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return I_(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const i=J.fromDate(r);return{timestampValue:As(s.serializer,i)}}if(r instanceof J){const i=new J(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:As(s.serializer,i)}}if(r instanceof Ue)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof xe)return{bytesValue:ed(s.serializer,r._byteString)};if(r instanceof te){const i=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(i))throw s.Sc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:Ho(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof Be)return(function(a,l){return{mapValue:{fields:{[Ph]:{stringValue:Ch},[Es]:{arrayValue:{values:a.toArray().map((d=>{if(typeof d!="number")throw l.Sc("VectorValues must only contain numeric values.");return qo(l.serializer,d)}))}}}}}})(r,s);throw s.Sc(`Unsupported field value: ${Fs(r)}`)})(n,e)}function Od(n,e){const t={};return Ih(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Lt(n,((r,s)=>{const i=On(s,e.mc(r));i!=null&&(t[r]=i)})),{mapValue:{fields:t}}}function Ld(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof J||n instanceof Ue||n instanceof xe||n instanceof te||n instanceof Nn||n instanceof Be)}function da(n,e,t){if(!Ld(t)||!wh(t)){const r=Fs(t);throw r==="an object"?e.Sc(n+" a custom object"):e.Sc(n+" "+r)}}function Eo(n,e,t){if((e=ce(e))instanceof kr)return e._internalPath;if(typeof e=="string")return fa(n,e);throw ks("Field path arguments must be of type string or ",n,!1,void 0,t)}const Ow=new RegExp("[~\\*/\\[\\]]");function fa(n,e,t){if(e.search(Ow)>=0)throw ks(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new kr(...e.split("."))._internalPath}catch{throw ks(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function ks(n,e,t,r,s){const i=r&&!r.isEmpty(),a=s!==void 0;let l=`Function ${e}() called with invalid data`;t&&(l+=" (via `toFirestore()`)"),l+=". ";let u="";return(i||a)&&(u+=" (found",i&&(u+=` in field ${r}`),a&&(u+=` in document ${s}`),u+=")"),new V(R.INVALID_ARGUMENT,l+n+u)}function Md(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zt(n){n=Se(n,te);const e=Se(n.firestore,Ye);return Aw(Cr(e),n._key).then((t=>Wd(e,n,t)))}bt._jsonSchemaVersion="firestore/querySnapshot/1.0",bt._jsonSchema={type:ae("string",bt._jsonSchemaVersion),bundleSource:ae("string","QuerySnapshot"),bundleName:ae("string"),bundle:ae("string")};class ya extends $d{constructor(e){super(),this.firestore=e}convertBytes(e){return new xe(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new te(this.firestore,null,t)}}function oi(n){n=Se(n,Xe);const e=Se(n.firestore,Ye),t=Cr(e),r=new ya(e);return Ud(n._query),Sw(t,n._query).then((s=>new bt(e,r,n,s)))}function jd(n,e,t){n=Se(n,te);const r=Se(n.firestore,Ye),s=qd(n.converter,e);return xr(r,[Nd(Zs(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,Oe.none())])}function Sn(n,e,t,...r){n=Se(n,te);const s=Se(n.firestore,Ye),i=Zs(s);let a;return a=typeof(e=ce(e))=="string"||e instanceof kr?xw(i,"updateDoc",n._key,e,t,r):Vw(i,"updateDoc",n._key,e),xr(s,[a.toMutation(n._key,Oe.exists(!0))])}function _a(n){return xr(Se(n.firestore,Ye),[new jo(n._key,Oe.none())])}function ai(n,e){const t=Se(n.firestore,Ye),r=Ee(n),s=qd(n.converter,e);return xr(t,[Nd(Zs(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Oe.exists(!1))]).then((()=>r))}function zd(n,...e){n=ce(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||Gl(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(Gl(e[r])){const u=e[r];e[r]=u.next?.bind(u),e[r+1]=u.error?.bind(u),e[r+2]=u.complete?.bind(u)}let i,a,l;if(n instanceof te)a=Se(n.firestore,Ye),l=qs(n._key.path),i={next:u=>{e[r]&&e[r](Wd(a,n,u))},error:e[r+1],complete:e[r+2]};else{const u=Se(n,Xe);a=Se(u.firestore,Ye),l=u._query;const d=new ya(a);i={next:p=>{e[r]&&e[r](new bt(a,d,u,p))},error:e[r+1],complete:e[r+2]},Ud(n._query)}return(function(d,p,y,v){const S=new la(v),k=new oa(p,S,y);return d.asyncQueue.enqueueAndForget((async()=>ra(await Cs(d),k))),()=>{S.Nu(),d.asyncQueue.enqueueAndForget((async()=>sa(await Cs(d),k)))}})(Cr(a),l,s,i)}function xr(n,e){return(function(r,s){const i=new st;return r.asyncQueue.enqueueAndForget((async()=>fw(await bw(r),s,i))),i.promise})(Cr(n),e)}function Wd(n,e,t){const r=t.docs.get(e._key),s=new ya(n);return new Tt(n,s,e._key,r,new dn(t.hasPendingWrites,t.fromCache),e.converter)}function ci(){return new ua("serverTimestamp")}function To(...n){return new ha("arrayUnion",n)}(function(e,t=!0){(function(s){Cn=s})(Pn),yn(new Kt("firestore",((r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new Ye(new Ny(r.getProvider("auth-internal")),new My(a,r.getProvider("app-check-internal")),(function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new V(R.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new wn(d.options.projectId,p)})(a,s),a);return i={useFetchStreams:t,...i},l._setSettings(i),l}),"PUBLIC").setMultipleInstances(!0)),Et(Xc,Jc,e),Et(Xc,Jc,"esm2020")})();const Fw=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:$d,Bytes:xe,CollectionReference:it,DocumentReference:te,DocumentSnapshot:Tt,FieldPath:kr,FieldValue:Nn,Firestore:Ye,FirestoreError:V,GeoPoint:Ue,Query:Xe,QueryCompositeFilterConstraint:ri,QueryConstraint:ni,QueryDocumentSnapshot:lr,QueryFieldFilterConstraint:Vr,QueryLimitConstraint:ii,QueryOrderByConstraint:si,QuerySnapshot:bt,SnapshotMetadata:dn,Timestamp:J,VectorValue:Be,_AutoId:Ms,_ByteString:me,_DatabaseId:wn,_DocumentKey:O,_EmptyAuthCredentialsProvider:yh,_FieldPath:pe,_cast:Se,_logWarn:Xt,_validateIsNotUsedTogether:vh,addDoc:ai,arrayUnion:To,collection:Ft,connectFirestoreEmulator:kd,deleteDoc:_a,doc:Ee,ensureFirestoreConfigured:Cr,executeWrite:xr,getDoc:Zt,getDocs:oi,getFirestore:Dd,limit:ga,onSnapshot:zd,orderBy:ma,query:Dr,serverTimestamp:ci,setDoc:jd,updateDoc:Sn,where:Io},Symbol.toStringTag,{value:"Module"})),Hd={apiKey:"AIzaSyCVRU4DJfKrR7yG9D8lGNLkhf9jFF7PL9Y",authDomain:"fatty-casino-e99ed.firebaseapp.com",projectId:"fatty-casino-e99ed",storageBucket:"fatty-casino-e99ed.firebasestorage.app",messagingSenderId:"225232886894",appId:"1:225232886894:web:08bb8008a6e6bf89391a7f"},Q=Object.values(Hd).every(n=>n&&n!=="");let Hi,rn,ee,Gd;Q?(Hi=uu(Hd),rn=ch(Hi),ee=Dd(Hi),Gd=new We):console.warn("Firebase not configured. Please add your Firebase config to .env file.");const Kd=async()=>{if(!Q)throw new Error("Firebase not configured");try{return(await ih(rn,Gd)).user}catch(n){throw console.error("Error signing in:",n),n}},Qd=async(n,e)=>{if(!Q)throw new Error("Firebase not configured");try{return(await qu(rn,n,e)).user}catch(t){throw console.error("Error signing up:",t),t}},Yd=async(n,e)=>{if(!Q)throw new Error("Firebase not configured");try{return(await ju(rn,n,e)).user}catch(t){throw console.error("Error signing in:",t),t}},Xd=async()=>{if(Q)try{await Gu(rn)}catch(n){throw console.error("Error signing out:",n),n}},Jd=n=>Q?Hu(rn,n):(n(null),()=>{}),Zd=async n=>{if(!Q)return null;try{const e=await Zt(Ee(ee,"users",n));return e.exists()?e.data():null}catch(e){throw console.error("Error getting user data:",e),e}},ef=async(n,e)=>{if(Q)try{await jd(Ee(ee,"users",n),{...e,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()})}catch(t){throw console.error("Error creating user profile:",t),t}},tf=async(n,e)=>{if(Q)try{await Sn(Ee(ee,"users",n),{...e,updatedAt:new Date().toISOString()})}catch(t){throw console.error("Error updating user data:",t),t}},nf=async(n=10)=>{if(!Q)return[];try{const e=Dr(Ft(ee,"users"),ma("balance","desc"),ga(n));return(await oi(e)).docs.map(r=>({id:r.id,...r.data()}))}catch(e){return console.error("Error getting leaderboard:",e),[]}},rf=async(n,e,t,r,s)=>{if(Q)try{await ai(Ft(ee,"chat"),{userId:n,username:e,avatar:t,profileImage:r,message:s,timestamp:ci(),createdAt:new Date().toISOString()})}catch(i){throw console.error("Error sending message:",i),i}},sf=(n,e=50)=>{if(!Q)return n([]),()=>{};try{const t=Dr(Ft(ee,"chat"),ma("timestamp","desc"),ga(e));return zd(t,r=>{const s=r.docs.map(i=>({id:i.id,...i.data()})).reverse();n(s)})}catch(t){return console.error("Error subscribing to chat:",t),n([]),()=>{}}},of=async(n,e)=>{if(Q)try{await ai(Ft(ee,"friendRequests"),{from:n,to:e,status:"pending",timestamp:ci(),createdAt:new Date().toISOString()})}catch(t){throw console.error("Error sending friend request:",t),t}},af=async(n,e,t)=>{if(Q)try{await Sn(Ee(ee,"users",e),{friends:To(t)}),await Sn(Ee(ee,"users",t),{friends:To(e)}),await _a(Ee(ee,"friendRequests",n))}catch(r){throw console.error("Error accepting friend request:",r),r}},cf=async n=>{if(Q)try{await _a(Ee(ee,"friendRequests",n))}catch(e){throw console.error("Error declining friend request:",e),e}},lf=async n=>{if(!Q)return[];try{const e=Dr(Ft(ee,"friendRequests"),Io("to","==",n),Io("status","==","pending")),t=await oi(e),r=[];for(const s of t.docs){const i=s.data(),a=await Zt(Ee(ee,"users",i.from));a.exists()&&r.push({id:s.id,...i,fromUser:a.data()})}return r}catch(e){return console.error("Error getting friend requests:",e),[]}},uf=async n=>{if(!Q)return[];try{const e=await Zt(Ee(ee,"users",n));if(!e.exists())return[];const t=e.data().friends||[],r=[];for(const s of t){const i=await Zt(Ee(ee,"users",s));i.exists()&&r.push({id:s,...i.data()})}return r}catch(e){return console.error("Error getting friends:",e),[]}},hf=async(n,e,t)=>{if(Q)try{const r=await Zt(Ee(ee,"users",n)),s=await Zt(Ee(ee,"users",e));if(!r.exists()||!s.exists())throw new Error("User not found");const i=r.data().balance||0;if(i<t)throw new Error("Insufficient balance");await Sn(Ee(ee,"users",n),{balance:i-t});const a=s.data().balance||0;await Sn(Ee(ee,"users",e),{balance:a+t}),await ai(Ft(ee,"transactions"),{type:"gift",from:n,to:e,amount:t,timestamp:ci(),createdAt:new Date().toISOString()})}catch(r){throw console.error("Error sending gift:",r),r}},df=async n=>{if(!Q)return[];try{const e=Dr(Ft(ee,"users"));return(await oi(e)).docs.map(s=>({id:s.id,...s.data()})).filter(s=>s.username&&s.username.toLowerCase().includes(n.toLowerCase())).slice(0,10)}catch(e){return console.error("Error searching users:",e),[]}},Uw=Object.freeze(Object.defineProperty({__proto__:null,acceptFriendRequest:af,get auth(){return rn},createUserProfile:ef,get db(){return ee},declineFriendRequest:cf,getFriendRequests:lf,getFriends:uf,getLeaderboard:nf,getUserData:Zd,isConfigured:Q,onAuthChange:Jd,searchUsers:df,sendChatMessage:rf,sendFriendRequest:of,sendGift:hf,signInWithEmail:Yd,signInWithGoogle:Kd,signOutUser:Xd,signUpWithEmail:Qd,subscribeToChatMessages:sf,updateUserData:tf},Symbol.toStringTag,{value:"Module"})),Gi=[{id:"first_win",name:"First Winner",description:"Win your first game",icon:"🏆",reward:500,condition:n=>n.totalWon>0},{id:"high_roller",name:"High Roller",description:"Wager 50,000 FATTY BUCKS",icon:"💎",reward:2e3,condition:n=>n.totalWagered>=5e4},{id:"millionaire",name:"Millionaire",description:"Reach 1,000,000 FATTY BUCKS",icon:"💰",reward:1e4,condition:(n,e)=>e>=1e6},{id:"lucky_streak",name:"Lucky Streak",description:"Win 5 games in a row",icon:"🍀",reward:1e3,condition:n=>n.winStreak>=5},{id:"big_winner",name:"Big Winner",description:"Win 100,000 in a single game",icon:"🎰",reward:5e3,condition:n=>n.biggestWin>=1e5},{id:"grinder",name:"The Grinder",description:"Play 100 games",icon:"⚡",reward:3e3,condition:n=>n.gamesPlayed>=100},{id:"social_butterfly",name:"Social Butterfly",description:"Add 5 friends",icon:"👥",reward:1500,condition:(n,e,t)=>t.length>=5},{id:"generous",name:"Generous Soul",description:"Gift 10,000 FATTY BUCKS to friends",icon:"🎁",reward:2e3,condition:n=>n.totalGifted>=1e4}],Bw=[{id:"daily_games",name:"Play 10 games",description:"Play any 10 games",reward:1e3,target:10,type:"games"},{id:"daily_wager",name:"Wager 5,000",description:"Wager 5,000 FATTY BUCKS",reward:800,target:5e3,type:"wager"},{id:"daily_wins",name:"Win 5 games",description:"Win any 5 games",reward:1500,target:5,type:"wins"}],us=[{name:"Bronze",minXP:0,color:"#CD7F32",perks:["Basic rewards","Daily bonus"]},{name:"Silver",minXP:5e3,color:"#C0C0C0",perks:["5% bonus XP","10% better odds","Silver badge"]},{name:"Gold",minXP:15e3,color:"#FFD700",perks:["10% bonus XP","15% better odds","Gold badge","Exclusive games"]},{name:"Platinum",minXP:35e3,color:"#E5E4E2",perks:["15% bonus XP","20% better odds","Platinum badge","Priority support"]},{name:"Diamond",minXP:75e3,color:"#B9F2FF",perks:["25% bonus XP","25% better odds","Diamond badge","VIP lounge access"]}],Yl=[{id:"lucky_charm",name:"Lucky Charm",description:"+5% win chance for 24h",price:5e3,icon:"🍀",type:"boost",duration:864e5},{id:"double_xp",name:"Double XP",description:"2x XP for 1 hour",price:3e3,icon:"⚡",type:"boost",duration:36e5},{id:"coin_doubler",name:"Coin Doubler",description:"2x winnings for 30min",price:1e4,icon:"💰",type:"boost",duration:18e5},{id:"vip_pass",name:"VIP Day Pass",description:"Access VIP features for 24h",price:8e3,icon:"👑",type:"pass",duration:864e5},{id:"gold_frame",name:"Gold Profile Frame",description:"Permanent gold profile frame",price:15e3,icon:"🖼️",type:"cosmetic",duration:null},{id:"rainbow_frame",name:"Rainbow Profile Frame",description:"Permanent rainbow profile frame",price:25e3,icon:"🌈",type:"cosmetic",duration:null}];function Xl(n){return Math.floor(Math.sqrt(n/100))+1}function Jl(n){return Math.pow(n-1,2)*100}function $w(n){return Math.pow(n,2)*100}function Zl(n){for(let e=us.length-1;e>=0;e--)if(n>=us[e].minXP)return us[e].name;return"Bronze"}class qw{constructor(){this.currentView="home",this.user=null,this.balance=1e4,this.profile={username:"Player",avatar:"🎰",profileImage:null,theme:"gold"},this.stats={totalWagered:0,totalWon:0,totalLost:0,gamesPlayed:0,biggestWin:0,winStreak:0,currentStreak:0},this.lastDailyBonus=null,this.leaderboard=[],this.leaderboardInterval=null,this.leaderboardTimerInterval=null,this.leaderboardSecondsUntilRefresh=60,this.gamesDropdownOpen=!1,this.cropImageData=null,this.cropZoom=1,this.cropPosition={x:0,y:0},this.chatMessages=[],this.chatUnsubscribe=null,this.friends=[],this.friendRequests=[],this.xp=0,this.level=1,this.achievements=[],this.dailyQuests=[],this.vipTier="Bronze",this.inventory=[],this.init()}async init(){this.showLoading(),Jd(async e=>{this.user=e,e?(await this.loadUserData(e.uid),this.startLeaderboardPolling(),this.startChatSubscription(),await this.loadFriends(),await this.loadFriendRequests()):(this.leaderboard=[],this.stopLeaderboardPolling(),this.stopChatSubscription(),this.friends=[],this.friendRequests=[]),this.render(),this.updateWallet()})}startChatSubscription(){this.chatUnsubscribe&&this.chatUnsubscribe(),this.chatUnsubscribe=sf(e=>{this.chatMessages=e,this.currentView==="chat"&&this.render()})}stopChatSubscription(){this.chatUnsubscribe&&(this.chatUnsubscribe(),this.chatUnsubscribe=null)}async loadFriends(){if(this.user)try{this.friends=await uf(this.user.uid)}catch(e){console.error("Error loading friends:",e)}}async loadFriendRequests(){if(this.user)try{this.friendRequests=await lf(this.user.uid)}catch(e){console.error("Error loading friend requests:",e)}}showLoading(){document.querySelector("#app").innerHTML=`
